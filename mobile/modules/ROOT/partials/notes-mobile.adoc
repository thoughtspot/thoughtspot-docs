...
ThoughtSpot Mobile 4.6.0 is now available.
These release notes include information about new features and updates to existing features.

[#4-6-0-new]
== 4.6.0 New Features and Functionality
* ThoughtSpot introduces an improved layout for note tiles on Liveboards.

[#4-4-0-new]
== 4.4.0 New Features and Functionality
* ThoughtSpot introduces support for enterprise SSO.

[#4-2-0-new]
== 4.2.0 New Features and Functionality
* ThoughtSpot introduces a new pivot table format. Pivot tables are now displayed in a tabular view.
//* Upload sourcemap issue while build generation
//* Xcode 16 update for the build pipeline
* ThoughtSpot now includes image tag handling in table views.
* ThoughtSpot has removed sensitive information from logs.


[#4-1-0-new]
== 4.1.0 New Features and Functionality
...
[#4-0-0-new]
== 4.0.0 New Features and Functionality
...
* Check out the new Answer experience on ThoughtSpot Mobile. For more information on the new Answer experience, see link:https://docs.thoughtspot.com/cloud/latest/answer-experience-new[New Answer experience].
