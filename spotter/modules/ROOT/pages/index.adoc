...
{form-factor} is a simple, self-service, chat-based experience for getting answers from your data. {form-factor} enables you to talk to your data in a whole new way.
