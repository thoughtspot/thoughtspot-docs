...
- To use ThoughtSpot {form-factor}, you must have a user account. To sign up for a trial of ThoughtSpot {form-factor}, go to the https://www.thoughtspot.com/try-spotter[Spotter trial sign-up page^]. Once your user account is created, you will receive an email inviting you to join a trial of ThoughtSpot.
...
+
IMPORTANT: When you sign in to Spotter for the first time, you will have access to built-in datasets which you can use to try out Spotter. To connect Spotter to your own data, you must schedule a personalized concierge session to integrate your own data. For details, see xref:thoughtspot-datasource-setup[Next steps].
...
. Click *Book a call*.
. In the _Contact ThoughtSpot_ window, enter your business email address, select the reason you are contacting ThoughtSpot, and click *Submit*.
+
