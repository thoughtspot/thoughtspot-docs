...
a|
[#round]
`round` a| Returns the first number rounded to the second number (the default is 1). For example, to round to two digits, you would enter `round (measure, .01)`. | `round (35.65, 10) = 40` +
