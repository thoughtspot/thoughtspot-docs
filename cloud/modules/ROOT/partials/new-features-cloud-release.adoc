...
+
You can ask Spotter to suggest questions during the conversation. For more information, see xref:spotter-data-insights.adoc[Spotter data insights].
+
...
// Mary – jira: SCAL-230530. docs jira:?
...
// Mark – jira: SCAL-233271. docs jira:?
