...
Create your own charts with Muze Studio [.badge.badge-beta-relnotes]#Beta#:: You can now create your own charts in ThoughtSpot using Muze Studio. A developer can create new chart types by writing the code for them in the code builder. To enable this feature, contact {support-url}.
+
For more information, see
