...
Spotter in MS Teams [.badge.badge-beta-relnotes]#Beta#::: You can now use Spotter to conversationally search your data in MS Teams by chatting directly with the Spotter app in a direct message. Use the *Reset* command to start a new conversation. To enable this feature, contact your administrator.
+
--
NOTE: Spotter in MS Teams is not available for GCP and ThoughtSpot Embedded clusters yet.
--
+
...
// Naomi. jira: SCAL-214785. docs jira: SCAL-244489, SCAL-244634
