...
<div class="paragraph">
<p>Starting in February 2026, we are adopting a new release versioning format: <b><em>year.month.0.cl</em></b>. As a result, this release will be <b>26.2.0.cl</b>. This aligns our versioning approach with how other global companies do their releases. </p>
</tr>
</tbody></table>
</div>
++++
