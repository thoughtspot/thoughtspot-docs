...
In this release, you can now use any parameter from a chart component of an Answer in the title or description of that Answer. Any parameter used in the title or description always displays the value of the same parameter used in the chart itself.
[.bordered]
