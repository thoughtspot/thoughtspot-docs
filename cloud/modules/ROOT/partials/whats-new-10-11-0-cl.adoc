...
[#10-11-0-cl-ws]
[discrete]
=== Filtering a Liveboard containing multiple Worksheets or Models when the user has limited access to them [.badge.badge-early-access-whats-new]#Early Access#
endif::[]
In this release, we've made several enhancements to viewing and editing a Liveboard when you have limited access to the Worksheets or Models used in the Liveboard.

When viewing a Liveboard, you can now filter columns from the Worksheet or Model you have access to. When viewing a Liveboard with only one Worksheet or Model that you don't have access to, you can see parameters and filters, but they are read-only and you can't re-order them. When a Worksheet or Model has a hidden column as a filter, you can select it but it only shows the selected values and you can't change the values.
