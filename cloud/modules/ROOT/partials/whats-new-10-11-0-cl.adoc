...
Analyst Studio queries now appear within the Billable Query Stats Liveboard, allowing you to easily track your consumption of queries and data set refreshes.
...
You can now easily copy formulas, parameters, and sets in Search Data. The copied object opens a pop-up window so you can easily edit and save as a new object.
