...
+++
<div class="border">
<video id="myVideo" poster="https://docs.thoughtspot.com/cloud/10.10.0.cl/_images/poster-spotter-why-questions.jpg" preload="none" loop muted controls width="100%" controlsList="nodownload">
