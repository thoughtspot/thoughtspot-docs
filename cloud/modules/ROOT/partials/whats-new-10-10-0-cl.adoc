...
ThoughtSpot now provides support for Orgs across all major plug-ins. Orgs functionality is enabled by default in the Microsoft Excel add-in and Microsoft PowerPoint add-in. To enable Orgs in the Google Slides add-on, please contact {support-url}.
