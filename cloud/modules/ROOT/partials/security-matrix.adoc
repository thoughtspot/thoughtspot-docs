...
<table id="matrix" class="wide_table" style="font-size:10px;">
 <colgroup>
      <col style="width:28%;">  <!-- CHANGED from 32% to fit 18 data cols -->
      <col style="width:4%;">
      <col style="width:4%;">
      <col style="width:4%;">
      <col style="width:4%;">
...
<!-- NEW ROW: Can access AgentSpot -->
<tr>
  <td>Can access AgentSpot</td>
         <td>N</td>
         <td>N</td>
         <td>N</td>
         <td>N</td>
...
<!-- NEW ROW: Can manage AgentSpot -->
<tr>
  <td>Can manage AgentSpot</td>
         <td>N</td>
         <td>N</td>
         <td>N</td>
         <td>N</td>
      ...
      <tr><td colspan="19" id="widefootnote" style="font-size: 10px;"><p>Table notes:</p> <!-- CHANGED colspan from 16 to 19 -->
        <ol><li>Applies to non-owners only.</li>
              ...
              <li>Can manage AgentSpot implicitly includes Can access AgentSpot.</li></ol></td></tr></tbody></table> <!-- NEW footnote 6 -->
++++
