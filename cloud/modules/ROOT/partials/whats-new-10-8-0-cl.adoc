...
[#10-8-0-cl-support]
[discrete]
=== Chat support changes [.badge.badge-ga-relnotes]#GA#
...
[#10-7-0-cl-parameter]
[discrete]
=== Parameters in column names in charts and tables [.badge.badge-ga-relnotes]#GA#
...
[discrete]
=== Model knowledge cards [.badge.badge-ga-relnotes]#GA#
...
For more information, see
ifndef::pendo-links[]
xref:spotter-migrate-legacy.adoc[Migrate Spotter feedback using TML] and xref:tml-coaching.adoc[TML for Spotter feedback].
endif::[]
ifdef::pendo-links[]
xref:spotter-migrate-legacy.adoc[Migrate Spotter feedback using TML,window=_blank] and xref:tml-coaching.adoc[TML for Spotter feedback,window=_blank].
endif::[]
...
ifndef::pendo-links[]
xref:system-model.adoc[System Worksheets, tables, and views].
endif::[]
ifdef::pendo-links[]
xref:system-model.adoc[System Worksheets, tables, and views,window=_blank].
endif::[]


[#10-7-0-cl-oauth]
[discrete]
=== OAuth for Denodo using Proof Key for Code Exchange (PKCE) [.badge.badge-ga-relnotes]#GA#
