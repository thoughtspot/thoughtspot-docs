...
You can now create your own charts in ThoughtSpot using Muze. With the code builder, a developer can create new chart types by writing the code. Other users can then use these charts to visualize their data. To enable this feature, contact {support-url}.
