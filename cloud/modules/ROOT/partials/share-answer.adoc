...
. Save the Answer(s) by clicking the ellipsis icon image:icon-more-10px.png[more options menu icon], and selecting *Save*.
+
...
. Save the answer by clicking the ellipsis icon image:icon-more-10px.png[more options menu icon], and selecting *Save*.
+
image::sharing-save-answer.png[Save an answer]
