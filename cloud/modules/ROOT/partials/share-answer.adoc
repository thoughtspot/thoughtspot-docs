...
+
NOTE: When you save an Answer, ThoughtSpot makes your Answer discoverable by default. Members of the same user group who have access to the Answer's underlying data source can find your Answer when they search using *Search Answers*. Note that discoverable Answers and Liveboards viewed in *Search Answers* appear on the user's home page, but do not appear under the *Answers* or *Liveboards* tabs.
