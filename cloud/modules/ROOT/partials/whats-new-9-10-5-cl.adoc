...
For more information, see
ifndef::pendo-links[]
xref:query-sets.adoc[Custom sets].
endif::[]
ifdef::pendo-links[]
xref:query-sets.adoc[Custom sets,window=_blank].
endif::[]
...
[#9-11-0-cl-tscli]
[discrete]
=== Remove additional information when exporting a Liveboard as a CSV [.badge.badge-ga-relnotes]#GA#
...
[discrete]
=== Join enhancement for dbt connections [.badge.badge-ga-relnotes]#GA#
...
[#9-11-0-cl-pkce]
[discrete]
=== OAuth for Snowflake using Proof Key for Code Exchange (PKCE) [.badge.badge-ga-relnotes]#GA#
...
[#9-11-0-cl-dremio]
[discrete]
=== Dremio on-premises support for OAuth [.badge.badge-ga-relnotes]#GA#
...
[discrete]
=== Support for custom URLs in scheduled Liveboard emails [.badge.badge-ga-relnotes]#GA#
