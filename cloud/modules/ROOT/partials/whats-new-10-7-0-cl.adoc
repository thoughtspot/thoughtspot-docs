...
You can now create your own charts in ThoughtSpot using Muze Studio.  A developer can create new chart types by writing the code in the code builder. To enable this feature, contact your ThoughtSpot administrator.
...
// PM: Prayansh - Confirmed doc required.
...
[#10-7-0-cl-embrace]
[discrete]
=== Create a Connection [.badge.badge-early-access]#Early Access#
endif::[]
ifdef::pendo-links[]
[#10-7-0-cl-embrace]
[discrete]
=== Create a Connection [.badge.badge-early-access-whats-new]#Early Access#
endif::[]

// Naomi – jira: SCAL-212284. docs jira: SCAL-?
// PM: Prayansh. waiting on info.

We redesigned and streamlined the process to create a Connection. Set up your Connection in four easy steps by selecting a data source, configuring the Connection, selecting databases, and selecting tables.
...
[#10-7-0-cl-bridge]
[discrete]
=== Bridge support for SAP HANA, SQL Server, and Oracle

// Naomi. jira: SCAL-206474. docs jira: SCAL-?
// PM: Prayansh

We now support Bridge connections for SAP HANA, SQL Server, and Oracle.
...
// PM: Himanshu/Reshma - GA - still waiting for doc JIRA.
...
ThoughtSpot introduces a feature to override displayed {Null} & {Empty} values with a customizable value. This allows you to define how null data values appear to better meet your organization's specific needs.
