...
You can now add parameters to the table header, column names and axis names of a chart. A parameter in a chart functions as a variable which automatically updates to show its current value in any Liveboards or Answers which include the chart.
