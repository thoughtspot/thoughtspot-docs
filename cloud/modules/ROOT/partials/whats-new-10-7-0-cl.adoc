...
[discrete]
=== Typeahead token & full query completions in conversations [.badge.badge-beta]#Beta#
endif::[]
ifdef::pendo-links[]
[#10-7-0-cl-typehead-token]
[discrete]
=== Typeahead token & full query completions in conversations#Beta#
endif::[]

To enable this feature, contact {support-url}.

// Mary – jira: SCAL-233271. docs jira:?
// PM: Sam Weick - Awaiting confirmation about "no doc needed & internal"
