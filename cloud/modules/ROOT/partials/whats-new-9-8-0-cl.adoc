...
[#9-8-0-cl-sage-coach]
[discrete]
=== Give feedback to AI-generated Answers [.badge.badge-ga-relnotes]#GA#
...
[#9-8-0-cl-insight]
[discrete]
===  Change analysis: More insights [.badge.badge-ga-relnotes]#GA#
...
[#9-8-0-cl-watchlist]
[discrete]
=== KPI scheduled watchlist alert [.badge.badge-ga-relnotes]#GA#

// Naomi -- SCAL-177812. add image/gif. find out if there's an opt-out option. is there an admin control over the feature?

When you add a KPI to your home page watchlist, ThoughtSpot automatically creates a scheduled alert. You receive emails with updates to the KPI on a periodic basis. You can edit all scheduled alerts from the *Monitor* tab. For more information, see
ifndef::pendo-links[]
...
[#9-8-0-cl-atlan]
[discrete]
=== Atlan [.badge.badge-ga-relnotes]#GA#
...
[#9-8-0-cl-sync]
[discrete]
=== Database as a destination for Answer Sync [.badge.badge-ga-relnotes]#GA#
...
[discrete]
=== Atlan catalog integration [.badge.badge-ga-relnotes]#GA#
...
[#9-8-0-cl-embrace]
[discrete]
=== OAuth connection improvements [.badge.badge-ga-relnotes]#GA#
