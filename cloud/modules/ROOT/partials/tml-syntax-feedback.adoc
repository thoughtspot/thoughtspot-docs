== Syntax of the TML file for legacy memory sources

The `TML` file for legacy memory sources has a specific syntax.

See the <<feedback-parameters,TML parameters for legacy memory sources>> for details about the keywords used in this example.
