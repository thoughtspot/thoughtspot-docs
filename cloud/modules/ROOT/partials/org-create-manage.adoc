...
. Make sure you are in the Primary Org.
. Navigate to *Admin settings* > *All orgs*.
...
. To create a new Org, select *+ Add org* in the upper-right corner of the screen.
. The *Add org* modal appears. Add a unique name and an optional description, and select *Save*. The Org name *_must_* be unique throughout the cluster.
