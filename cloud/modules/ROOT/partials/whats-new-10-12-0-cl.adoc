...
[#10-12-0-cl-nav]
[discrete]
=== New persona-based navigation and favorites
ThoughtSpot introduces navigation organized by persona. The new left panel navigation allows business users, analysts, data engineers, administrators, and developers to work in separate contextual sections designed specifically for their needs. In addition, favorites have been added to the left panel navigation *Insights* tab.

//image::app-switcher.png[Persona-based navigation]

// Mary. Jira: SCAL-251909. docs jira: SCAL-264648
// PM: Arpit. Is this V3 EA or Beta? Replace image with V3 (left nav) once confirmed how that will look w/o Home Page enabled with Arpit.
...
// PM: Rudram Piplad confirmed no doc needed. Lists V3 moved to 10.13.0.cl.
////
