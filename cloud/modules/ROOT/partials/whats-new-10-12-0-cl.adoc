ifndef::pendo-links[]
September 2025 [label label-dep]#10.12.0.cl#
endif::[]
ifdef::pendo-links[]
...
ifdef::pendo-links[]
xref:spotter-reference-questions.adoc[Reference questions,window=_blank].
endif::[]
...
You can now use data model instructions to provide global feedback to Spotter that carries over to any query on the underlying data model. To provide data model instructions, select the instructions icon in Spotter and type a directive about how Spotter is to interpret the question. For example, you can instruct Spotter to specify the date filter as the last 30 days if the user does not provide a date keyword. To enable this feature, contact {support-url}.
...
[#10-12-0-cl-email]
[discrete]
=== KPI alert emails [.badge.badge-ga-relnotes]#GA#
...
[discrete]
=== Query_groups optional grouping columns [.badge.badge-ga-relnotes]#GA#
...
[#10-12-0-cl-multiple]
[discrete]
=== Multiple configurations per connection [.badge.badge-ga-relnotes]#GA#
