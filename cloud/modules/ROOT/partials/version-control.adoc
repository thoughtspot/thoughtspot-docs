...
If you're a ThoughtSpot administrator, see xref:git-version-control.adoc[Version control for Liveboards and Answers] for details on how to enable version control.
