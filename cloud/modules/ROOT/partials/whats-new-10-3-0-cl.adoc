...
[discrete]
=== Natural language search and object search [.badge.badge-ga-relnotes]#GA#
...
ifndef::pendo-links[]
xref:thoughtspot-one-homepage.adoc[Home page] and xref:monitor.adoc[Monitor Key Performance Indicators in your data].
endif::[]
ifdef::pendo-links[]
xref:thoughtspot-one-homepage.adoc[Home page,window=_blank] and xref:monitor.adoc[Monitor Key Performance Indicators in your data,window=_blank].
endif::[]
...
ifdef::pendo-links[]
xref:analyst-studio-getting-started.adoc[Analyst Studio,window=_blank] and xref:rbac.adoc[Understand RBAC and privileges,window=_blank].
endif::[]
