...
NOTE: Too many incorrect login attempts will cause the account to be locked. No notification emails are sent to the user in this case. If that occurs, you can request that your administrator unlock the account, or try again after one hour. The *Forgot password?* function cannot be used when the users account is locked out.
...
+
image::password-reset-email-new.png[Password reset email]
