...
[discrete]
=== Connection parametrisation for publishing

// Mary. jira: SCAL-220278. docs jira: SCAL-?
// PM: Aashica - Awaiting confirmation from PM to determine if this requires doc (marked as needs evaluation - need clarification on what is being implemented in 10.6.0.cl) - PRD seems to discuss only TSE.
////
