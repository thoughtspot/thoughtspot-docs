...
[#10-6-0-cl-object]
[discrete]
=== Enhancements to discoverability in new homepage
In this release, we've introduced a number of enhancements to improve discoverability in the Insights app of the new navigation and homepage experience, including:

- Sorting Answer and Liveboard lists by "last modified" on the homepage
