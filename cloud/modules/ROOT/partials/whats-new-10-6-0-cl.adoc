...
This release brings the following changes to Spotter on a Liveboard:

- If a Liveboard uses at least one AI-enabled data source, the *Spotter* button appears.
- If none of the data sources used on a Liveboard have AI enabled, the *Explore* button appears and a notification indicating Spotter is not available.
