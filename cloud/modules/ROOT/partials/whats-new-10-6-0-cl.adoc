...
// PM: Dilip - approved by PM. Naomi is creating a .gif for this one.
...
// PM: Manan - updated description per Manan: "We should highlight that its a completely new chart." & updated bullets per PM.
// Enabled in Early Access page.
...
// Awaiting confirmation from PM about how this is enabled - Early Access > Add configurations to your connection?
