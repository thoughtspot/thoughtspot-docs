...
ifndef::pendo-links[]
xref:spotter-optimize.adoc[Optimize for Spotter].
endif::[]
ifdef::pendo-links[]
xref:spotter-optimize.adoc[Optimize for Spotter,window=_blank].
endif::[]
...
For more information, see xref:chart-pivot-table.adoc[Pivot table charts].
