...
[#10-6-0-cl-object]
[discrete]
=== Improved sorting, filtering, and export of Answers and Liveboards in the new navigation and homepage experience [.badge.badge-ga-relnotes]#GA#
...
[#10-6-0-cl-gradient]
[discrete]
=== Gradient-based conditional formatting [.badge.badge-ga-relnotes]#GA#
...
[discrete]
=== Custom comparison point for KPI charts [.badge.badge-ga-relnotes]#GA#
...
[#10-6-0-cl-group]
[discrete]
=== Group aggregates in change analysis [.badge.badge-ga-relnotes]#GA#
...
[discrete]
=== ThoughtSpot Connected Slides new features [.badge.badge-ga-relnotes]#GA#
The ThoughtSpot Connected Slides add-on for Google Slides has the following new features:
...
ifndef::pendo-links[]
xref:spotter-model.adoc#optimize-spotter[Optimize for Spotter].
endif::[]
ifdef::pendo-links[]
xref:spotter-model.adoc#optimize-spotter[Optimize for Spotter,window=_blank].
endif::[]
...
For more information, see
ifndef::pendo-links[]
xref:tml.adoc#object-id[User-defined ID in TML].
endif::[]
ifdef::pendo-links[]
xref:tml.adoc#object-defined-id[User-defined ID in TML,window=_blank].
endif::[]
