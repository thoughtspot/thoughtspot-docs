...
[#preview-sage]
Can preview ThoughtSpot Sage:: Users with this privilege can use ThoughtSpot Sage features. These features include xref:ai-answers.adoc[], or xref:search-ai-suggested.adoc[]. You do not need this privilege for the xref:data-modeling-visibility.adoc#automatic-synonyms[AI-generated Model synonyms] feature.
