...
Can manage data:: Can create connections. You can modify and add tables to other people's connections if the connection and table are shared with you. You can only view or edit tables, not the connection properties.
+
