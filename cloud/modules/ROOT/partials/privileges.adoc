...
[#manage-spotter]
Can manage Spotter:: Users with this privilege can manage how Spotter behaves across the organization — global coaching, memory, Spotter instructions, and Spotter Analysts. Implies Can use Spotter. Does not allow editing data models.
//For more information, see xref:spotter-privilege.adoc[].
