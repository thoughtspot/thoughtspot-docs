...
[#chart-kpi-sparkline]
[discrete]
=== Sparkline visualization for KPI charts [.badge.badge-ga-relnotes]#GA#
...
[discrete]
=== Reset saved Answers [.badge.badge-ga-relnotes]#GA#

Have you ever tried different chart types and filtering conditions on an Answer, and then decided you wanted to set your Answer back to its original state? Now you can easily do that by using the new *reset* button, next to the *undo* and *redo* buttons. This is only available for saved Answers in the
ifndef::pendo-links[]
...
[#aws-region-japan]
[discrete]
=== New cloud region in Japan [.badge.badge-ga-relnotes]#GA#
...
[#connections-oauth]
[discrete]
=== OAuth for Connections [.badge.badge-ga-relnotes]#GA#
