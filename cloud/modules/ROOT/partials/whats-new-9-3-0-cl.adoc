...
[#9-3-0-cl-gcp]
[discrete]
=== ThoughtSpot Cloud on Google Cloud [.badge.badge-ga-relnotes]#GA#
...
[discrete]
=== Attributes in pivot table cells [.badge.badge-ga-relnotes]#GA#
...
[discrete]
=== Change the filter order for Answer filters [.badge.badge-ga-relnotes]#GA#
...
[#9-3-0-cl-csv]
[discrete]
=== Free Trial CSV upload limit increase [.badge.badge-ga-relnotes]#GA#

We increased the CSV upload limit to ten files per user, and the file size limit to 50 MB. For more information, see
We increased the CSV upload limit in Free Trial to ten files per user.
endif::free-trial-feature[]

[#9-3-0-cl-legend]
[discrete]
=== Ability to change legend position [.badge.badge-ga-relnotes]#GA#
...
[#9-3-0-cl-rds]
[discrete]
=== Amazon Aurora PostgreSQL connection and Amazon Relational Database Service (RDS) PostgreSQL connection [.badge.badge-ga-relnotes]#GA#
...
[discrete]
=== Specify default connection for CSV uploads [.badge.badge-ga-relnotes]#GA#
...
[#9-3-0-cl-billing]
[discrete]
=== In-app billing reporting [.badge.badge-ga-relnotes]#GA#
...
ifndef::pendo-links[]
xref:query-stats.adoc[Billable Query Stats Liveboard], while time-based pricing customers see the xref:consumption-pricing-time-based.adoc#credit-usage-pinboard[Credit Usage Liveboard].
endif::[]
ifdef::pendo-links[]
xref:query-stats.adoc[Billable Query Stats Liveboard,window=_blank], while time-based pricing customers see the xref:consumption-pricing-time-based.adoc#credit-usage-pinboard[Credit Usage Liveboard,window=_blank].
endif::[]
