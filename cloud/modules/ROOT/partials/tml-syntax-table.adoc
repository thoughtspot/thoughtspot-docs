...
<<table,table>> :
  ...
  - <<id,id>>: <id>
    ...
    <<properties,properties>>:
      ...
      <<aggregation,aggregation>>: [ SUM | COUNT | AVERAGE | MAX | MIN | COUNT_DISTINCT | NONE | STD_DEVIATION | VARIANCE ]
      <<default_date_bucket,default_date_bucket>>: [ DAILY | WEEKLY | MONTHLY | QUARTERLY | YEARLY | HOURLY | AUTO ]
      <<index_type,index_type>>: [ DONT_INDEX | DEFAULT | PREFIX_ONLY | PREFIX_AND_SUBSTRING | PREFIX_AND_WORD_SUBSTRING ]
  ...
  <<properties,properties>>:
    <<spotter_config,spotter_config>>:
      <<is_spotter_enabled,is_spotter_enabled>>: [ true | false ]
