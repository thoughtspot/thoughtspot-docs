...
You can now choose to ask Spotter Agent complex questions, which Spotter breaks down into smaller, more manageable sub-queries. This feature is particularly useful for analyzing KPIs and their trends, allowing you to uncover actionable insights and make faster, more informed decisions.
