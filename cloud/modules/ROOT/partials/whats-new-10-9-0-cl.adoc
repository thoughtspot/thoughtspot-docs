...
<source src="https://docs.thoughtspot.com/cloud/10.8.0.cl/_images/spotter-agent.mp4" type="video/mp4">
</video>
+++
...
Date phrase keywords allow you to search for combinations of date buckets, rather than simply `yesterday` or `monthly`. For example, you can now search for sales in the last week for each month in the following languages:
