...
[#10-9-0-cl-agent]
[discrete]
=== Spotter agent design [.badge.badge-early-access-whats-new]#Early Access#
endif::[]
...
We have added date phrase keywords for the following languages. For example, you can now search for sales in the last week for each month in the following languages:
...
When clicking the ThoughtSpot link in an attribute alert email, you now land directly on the corresponding KPI, with conditional formatting included. To enable this feature, contact your administrator.
...
We have added support for `last_value_in_period` and `first_value_in_period` functions. These functions are useful for semi-additive measures, measures that typically return a single value per time period rather than being additive across time. For example, if you want to find out the last value for inventory levels of certain products over a period of months or quarters, you can use the `last_value_in_period` function. To enable this feature, contact your administrator.
