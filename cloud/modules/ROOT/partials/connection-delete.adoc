...
. Depending on whether you are in tile or list view, either check the box next to the connection you want to delete, or click the *more* image:icon-more-10px.png[more menu] menu for the connection.
