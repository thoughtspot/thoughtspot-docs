...
| Heatmap a| Uses a color range based on Primary 2.

NOTE: If you have the Configuring color gradients on charts feature enabled, you can set a gradient between two different colors. | Default | N/A
| Treemap a| Uses a color range based on Primary 1.
...
| Geo Heatmap a| Uses a specific lilac.

NOTE: If you have the Configuring color gradients on charts feature enabled, you can set a gradient between two different colors. | Default | No overrides are available currently.
| Geo Area a| Uses a specific yellow-to-red gradient. You can select an individual color to use, and ThoughtSpot builds a gradient around that color.

NOTE: If you have the Configuring color gradients on charts feature enabled, you can set a gradient between two different colors.| N/A | N/A
