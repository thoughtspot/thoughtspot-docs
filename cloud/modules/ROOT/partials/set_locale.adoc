...
== Changing your system language (locale)

You can updated your system language by doing the following:

. Select your user icon next to the *Help* button in the upper-right portion of the ThoughtSpot UI.
. Select *Profile*.
. Next to *Preferences*, select *Edit*.
. To change your system language, click the *System language* dropdown menu and select a new language (locale).
. Select *Save*.
