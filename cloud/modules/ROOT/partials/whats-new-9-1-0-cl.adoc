...
[discrete]
=== Free Trial - Show row limits [.badge.badge-ga-relnotes]#GA#
...
ifndef::pendo-links[]
xref:tml-tables.adoc#syntax-tables[Syntax of the table TML file].
endif::[]
ifdef::pendo-links[]
xref:tml-tables.adoc#syntax-tables[Syntax of the table TML file,window=_blank].
endif::[]
