...
ifndef::pendo-links[]
xref:connections-snowflake-add.adoc#client-credentials[Add a Snowflake connection].
endif::[]
ifdef::pendo-links[]
xref:connections-snowflake-add.adoc#client-credentials[Add a Snowflake connection,window=_blank].
endif::[]
