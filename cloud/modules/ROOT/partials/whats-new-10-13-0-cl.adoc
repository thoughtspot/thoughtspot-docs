...
Groups can now be added as subscribers to alerts. When a user is added as part of a group, they will not be able to unsubscribe from the alert individually; their subscription is managed through their group membership. If they are removed from the group, they will no longer receive the alert, but as long as they remain in the group, they cannot opt out on their own.
