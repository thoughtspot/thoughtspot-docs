...
ifndef::pendo-links[]
see xref:monitor-alert-threshold.adoc[Create a threshold-based alert].
endif::[]
ifdef::pendo-links[]
see xref:monitor-alert-threshold.adoc[Create a threshold-based alert,window=_blank].
endif::[]
...
[discrete]
=== Delete objects from home page [.badge.badge-ga-relnotes]#GA#
...
ifndef::pendo-links[]
see xref:tags.adoc#data-workspace-create[Use tags to organize].
endif::[]
ifdef::pendo-links[]
see xref:tags.adoc#data-workspace-create[Use tags to organize,window=_blank].
endif::[]

image::edit-tags-data-workspace.gif[Data workspace edit tags gif]
...
[discrete]
=== dbt integration enhancements [.badge.badge-ga-relnotes]#GA#
...
[discrete]
=== PrivateLink support [.badge.badge-ga-relnotes]#GA#
