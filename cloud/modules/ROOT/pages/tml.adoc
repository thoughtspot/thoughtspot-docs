...
To work with TML files for <<syntax-worksheets,Worksheets>>, <<syntax-views,views>>, <<syntax-sql-views,SQL views>>, <<syntax-tables,tables>>, <<syntax-answers,Answers>>, <<syntax-liveboards,Liveboards>>, and <<syntax-alerts,Monitor alerts>> in ThoughtSpot, you can download these objects to a flat file in `.TML` format, modify it, and subsequently upload this file either to the same cluster, or to a different cluster.
