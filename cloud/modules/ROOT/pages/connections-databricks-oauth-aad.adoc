...
:jira: SCAL-199788, SCAL-201978, SCAL-203358, SCAL-230240, SCAL-270983
...
For OAuth, we recommend checking the {connection} link:https://docs.databricks.com/en/administration-guide/users-groups/single-sign-on/index.html[documentation^] to confirm any IDP support and their details. This article documents only the most frequently set-up IDP.
