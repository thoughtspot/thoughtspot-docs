...
. Select the *Create Group* button on the upper-left side of the list of groups.
...
>
> * We highly recommend that you register for the free User & Group Management course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/user-group-management/2499231[Group and Role Management^] lesson.
