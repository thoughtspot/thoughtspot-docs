...
== Rerun your search query [.badge.badge-early-access-whats-new]#Early Access#
You can also rerun the same query without any modifications for testing data model changes, formula updates, or database reloads. Once you click *Go*, a confirmation pop-up will appear, and the query will be rerun with the latest data once you click *Confirm*. To enable this feature, contact your administrator.
[.bordered]
