= Search data
:page-last_updated: 6th Aug 2025
:linkattrs:
:experimental:
...
NOTE: If the classic Answer data panel experience is enabled, the process of choosing a data source is different. For more information, see xref:search-choose-data-source.adoc#search-choose-data-source-data-fluency[Choosing a data source with classic Answer data panel experience].
