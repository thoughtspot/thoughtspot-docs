...
ifndef::spotter[]
image::manage-data-page-new_v2.png[Data workspace home page]
endif::[]
...
ifndef::spotter[]
image::data-workspace-connections_v2.png[Connections tab]
endif::[]
...
image::data-workspace-usage-statistics_v2.png[Data workspace usage statistics page]

== Utilities

The *Utilities* section of the Data workspace contains many of your additional workflows as a data engineer.

image::data-workspace-utilities_v2.png[Data workspace utilities page]
