...
. Click *Connections*.
. Click *Create connection*, and select the *Startburst* tile. Alternatively, select *+ Create new* in the left navigation bar, select *Connection*, and select the {connection} tile.
+
...
> * xref:connections-starburst-deactivate.adoc[]
