...
Ask in conversation: *"What do you know about me?"* Spotter summarises all saved personal memory for that user.
+
To understand a specific personalisation: *"Why did you filter to EMEA?"* Spotter explains which saved context it applied.
