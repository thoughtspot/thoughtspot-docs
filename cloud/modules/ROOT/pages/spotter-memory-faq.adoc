...
What is the difference between Add to Coaching, Add to memory, and Remember this, in a conversation?::
Add to memory is the new button to add a reference question to memory, which was previously termed Add to Coaching. Remember this replaces Add to memory in Spotter 3 environments, and adds what Spotter learns from a specific answer to its conversational memory.
