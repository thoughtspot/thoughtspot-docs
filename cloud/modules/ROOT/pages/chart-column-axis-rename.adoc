...
To rename columns in an underlying model, so that these names persist for any user searching on a model, see xref:worksheets.adoc[create and use Worksheets].
