...
:jira: SCAL-206047, SCAL-189076, SCAL-277671, SCAL-286659
...
For Models, the *SUGGEST VALUES IN SEARCH* section for a column determines whether ThoughtSpot suggests these indexed column values.
...
At the Model level, you can choose whether the indexed values are shown or not for a particular column. This is controlled via the *SUGGEST VALUES IN SEARCH* toggle.
