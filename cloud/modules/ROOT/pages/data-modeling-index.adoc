...
To configure certain the schedule for ThoughtSpot's indexing behavior, refer to xref:search-spotiq-settings.adoc[Managing search and SpotIQ settings].
...
Refer to xref:search-spotiq-settings.adoc[Managing search and SpotIQ settings].
...
>
> * We highly recommend that you register for the free Indexing course in ThoughtSpot University that covers the information in this article, and watch the following lessons:
> ** https://training.thoughtspot.com/admin-indexing/2499302[What is Indexing?^]
> ** https://training.thoughtspot.com/admin-indexing/2499303[Managing Indexing for Tables^]
> ** https://training.thoughtspot.com/admin-indexing/2499304[Adjusting Model Indexing^]
