...
. Open a Model or table from the *Data workspace* tab.
...
//It also affects which columns ThoughtSpot prioritizes when generating xref:ai-answers.adoc[AI Answers].
