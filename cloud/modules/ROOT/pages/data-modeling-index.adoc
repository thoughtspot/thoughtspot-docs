...
CAUTION: Indexing only works at the table level. If the underlying table column's INDEX TYPE is set to 'DONT INDEX', the respective Worksheet column wont be indexed and be able to 'suggest values'.
