...
With the new *Add to Coaching* feature, you can turn those follow-up prompts into lasting knowledge. Add reference questions and business terms directly from your chat, so Spotter remembers them next time, and you don’t have to repeat yourself. To enable this feature, contact your administrator.
