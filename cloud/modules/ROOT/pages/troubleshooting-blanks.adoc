...
If you find that the charts and tables built on a Model contain a large number of null values (which display as \{blank} in the web browser), you can fix this by changing the xref:worksheet-inclusion.adoc#[inclusion rule] for the Model.
...
So if you encounter this problem, you can xref:worksheet-inclusion.adoc#[edit the Model, and change the inclusion rule] to *Exclude Empty Rows (Inner Join)*.
