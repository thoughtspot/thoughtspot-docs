...
:jira: SCAL-182038, SCAL-159515, SCAL-201031, SCAL-200797, SCAL-206393, SCAL-213189 (unsupported on TSE), SCAL-221304 (added by Mark per request by Arpit), SCAL-222127 (remove Cord), SCAL-229028 (note about storing of comments), SCAL-268198 (deprecate)
