...
NOTE: To enable CSV upload for Snowflake for your cluster, contact your administrator. Once this feature is enabled, your administrator can configure CSV upload for each Snowflake connection.
