...
. xref:share-models.adoc#[Share the Worksheet with groups or users].
...
. xref:share-models.adoc#[Share your Worksheet], if you want other people to be able to use it.
