...
:jira: SCAL-136661, SCAL-203358, SCAL-214983, SCAL-230240, SCAL-248988
...
. Enter the connection details for your {connection} data source using *Service Account*, *OAuth*, *OAuth with Service Principal*, or *OAuth with PKCE*.
+
[.bordered]
