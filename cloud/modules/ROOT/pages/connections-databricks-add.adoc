...
+
If you need to use OAuth with {connection}, you must configure OAuth in Microsoft Azure. For details, see xref:connections-databricks-oauth-aad.adoc[OAuth with AAD for a {connection} connection] and xref:connections-databricks-oauth.adoc[OAuth for a {connection} connection].
--
