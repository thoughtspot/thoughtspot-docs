...
* Check *Schedule Liveboards* if you want to user this connection so that scheduled Liveboard queries can use a separate warehouse, credentials, or non-OAuth authentication method instead of the parent connection's defaults.
. Click *Continue*.
+
