...
****
If there are multiple Snowflake connections in your cluster that have CSV Upload enabled, you will see *Do you want this table to be collocated with other tables/models?* at the bottom of the Upload Data window.
...
If you choose *Yes* and select a table or Model, your table will be imported into the same Snowflake database as that table or Model, making it easy to set up a join later.
****
+
...
. Choose whether you want to import your into the same Snowflake database as an existing table or Model:
+
