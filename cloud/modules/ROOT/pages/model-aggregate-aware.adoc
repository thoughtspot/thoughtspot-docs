...
*** Formula correctness: Formulas must be defined at the correct grain for the aggregate. A `AVG` that is additive at the line-item level may need to be treated differently at a pre-aggregated level.
