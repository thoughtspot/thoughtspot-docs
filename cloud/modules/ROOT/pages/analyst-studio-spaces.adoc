= Collections in Analyst Studio
:categories: ["Navigate and organize content"]
:categories_weight: 3
:date: 2021-12-17
:description: A Collection in Analyst Studio is a group of Reports organized around a team or project.
...
>
> * We highly recommend that you register for the free Getting Oriented to Analyst Studio course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/getting-oriented-to-analyst-studio/2122673[Collections in Analyst Studio^] lesson.
