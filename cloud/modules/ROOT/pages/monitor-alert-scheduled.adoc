...
:linkattrs:
:experimental:
:jira: SCAL-255514, SCAL-260152, SCAL-272806


Using scheduled alerts, you can define a time period to receive notifications on your KPI. For all alert types, when the frequency is set to hourly, then it means we send alerts at 30- or 60-minute mark.
