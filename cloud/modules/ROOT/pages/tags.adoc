...
. Select *Answers* or *Liveboards* from the Insights tab.
. Select the checkboxes next to the object(s) you want to create a new tag for.
+
[.bordered]
...
* <<data-workspace,Tables, Models, views, or SQL views>>
...
=== Apply tags to tables, Models, views, or SQL views

To apply a tag to a table, Model, view, or SQL view, follow these steps:
...
ifdef::spotter[]
[#data-workspace-apply]
=== Apply tags to tables and Models
To apply a tag to a table or Model, follow these steps:
...
ifndef::spotter[]
for Answers and Liveboards, or the Data workspace page, for tables, Models, views, and SQL views.
endif::[]
ifdef::spotter[]
for the Data workspace page, for tables and Models.
endif::[]
