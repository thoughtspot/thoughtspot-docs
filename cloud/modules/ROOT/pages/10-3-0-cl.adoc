...
[#portuguese-keywords]
Portuguese (Brazil) keywords [.badge.badge-ga-relnotes]#GA#::
...
[#manage-tags]
Manage tags for Answers and Liveboards [.badge.badge-ga-relnotes]#GA#::
...
[#sage-coach]
Sage Coach enhancements [.badge.badge-ga-relnotes]#GA#::
Filters improvement:::
...
[#monitor-rls]
Monitor the application of row-level security [.badge.badge-ga-relnotes]#GA#::
...
[#allow-only]
Allow only ThoughtSpot users and groups to be added to schedules [.badge.badge-ga-relnotes]#GA#::
...
[#option-set-nav]
Option to set new navigation and home page experience as default [.badge.badge-early-access-relnotes]#Early Access#::
// Mark. jira: SCAL-223658. docs jira: SCAL-226711
// PM: Mohil
Administrators now have the ability to set the new navigation and home page experience as the default UI for all users of the cluster, if it is enabled for the cluster. To enable this feature, go to the *Admin > Early access features* page and enable _New Experience (Default UI)_. For more information, see
