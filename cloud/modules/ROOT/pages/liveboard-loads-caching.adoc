...
NOTE: Scheduled Liveboards and downloaded Liveboards always show live data and are not affected by caching.
...
****
IMPORTANT: Will enabling caching change how much I'm billed?

No. ThoughtSpot still queries the data warehouse in the background on every Liveboard load to refresh the cache for the next visit. Caching improves the user experience without reducing underlying query volume. Cost optimization based on caching is being explored for a future release.
****
