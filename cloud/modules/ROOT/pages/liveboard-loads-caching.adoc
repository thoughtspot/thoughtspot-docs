...
IMPORTANT: When caching is enabled for a Liveboard, ThoughtSpot is authorized to extract data from the CDW and store it in the user's browser cache on their machine. This is only accessible to the user opening the Liveboard in their browser.
