...
A cluster administrator within an org has the same capabilities as the Org's administrator. Connections created by the cluster administrator are not visible to Org administrator. All other entities, including tables, Models, and any other dependent objects are visible to the Org administrator.
+
