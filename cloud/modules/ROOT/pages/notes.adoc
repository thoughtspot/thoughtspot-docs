...
+
For more information, see xref:natural-language-instructions.adoc[].
...
Rerun queries in Search data [.badge.badge-early-access-relnotes]#Early Access#::
...
With this feature, users can simply click *Go* to rerun the query, which is useful for testing data model changes, formula updates, or database reloads. To enable this feature, contact your administrator.
