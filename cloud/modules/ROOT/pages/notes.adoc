...
=== For the Analyst
Search Assist Coach::
Search Assist Coach enables Analysts, or anyone who has *edit* access to a Worksheet, to create Search Assist sample queries based on their company data.
...
You can now use TML to import, export, and update Worksheets with Search Assist Coach lessons.
