...
ThoughtSpot Cloud 10.1.0.cl is now available.
...
IMPORTANT: Beginning in the 10.1.0.cl release, you will no longer be able to use the "classic experience" for Liveboards, Answers, and SpotIQ. The "new experience" from the previous release is now the only option and is on by default.
