...
Snowflake CSV upload [.badge.badge-update-whats-new-beta]#Beta#:: Now you have a quick and easy way to complete one-time data loads of small files that are not present in your cloud data warehouse. You can now upload a CSV file to the database of your Snowflake connection that can be joined to other tables or worksheets in your connection. Once your administrator enables this feature, go to *Data* > *Utilities*, and click *Upload CSV*.
ifndef::pendo-links[]
...
[#okta]
Identity and Access Management V2 [.badge.badge-update-whats-new-beta]#Beta#::
...
Threshold-based alerts for KPI charts [.badge.badge-update-whats-new-beta]#Beta#::
...
Make content discoverable [.badge.badge-update-whats-new-beta]#Beta#::
...
[#spotapps]
ServiceNow and Snowflake SpotApps [.badge.badge-update-whats-new-beta]#Beta#::
...
SQL-based views [.badge.badge-update-whats-new-beta]#Beta#::
...
[#data-tab]
Data tab redesign [.badge.badge-update-whats-new-beta]#Beta#::
...
[#monitor-kpi]
Monitor Key Performance Indicators (KPI) [.badge.badge-update-whats-new-beta]#Beta#::
...
[#chart-kpi]
KPI chart type [.badge.badge-update-whats-new-beta]#Beta#::
...
[#eureka-japanese]
Support for searching answers in Japanese [.badge.badge-update-whats-new-beta]#Beta#::
...
+
This feature is only available if you have the xref:answer-experience-new.adoc[new answer experience] (off by default in September cloud) on in your environment.
...
[#search-suggestions]
Search suggestions [.badge.badge-update-whats-new-beta]#Beta#::
When you xref:search-answers.adoc[search across existing answers and Liveboards], ThoughtSpot now offers search suggestions in the search bar, based on your past searches and popular searches in your environment, in addition to object suggestions.
...
+
To perform conditional formatting on measures in pivot tables, you must have the xref:answer-experience-new.adoc[New Answer experience] (off by default in June Cloud) enabled on your cluster.
...
[#admin-privileges]
New admin privileges [.badge.badge-update-whats-new-beta]#Beta#::
...
=== For the Business User
[#new-answer-experience]
New Answer experience [.badge.badge-update-whats-new-beta]#Beta#::
...
In this release, ThoughtSpot introduces the Visual Embed SDK package to help developers embed the ThoughtSpot search functionality, Liveboards, visualizations, or the full application in their web page, portal, or business solution.  For more information on embedding ThoughtSpot, see xref:intro-embed.adoc[ThoughtSpot embedding solution].
[#spotdev-portal]
SpotDev portal [.badge.badge-update-whats-new-beta]#Beta#::
...
Embrace now supports Oracle Autonomous Database [.badge.badge-update-whats-new-beta]#Beta#.
This feature is in beta and disabled by default.
To enable this feature, contact https://community.thoughtspot.com/customers/s/contactsupport[ThoughtSpot Support].
