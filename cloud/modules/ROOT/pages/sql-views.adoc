...
. Got to the *Data workspace* tab and select *+* create new *SQL view*.
...
Table names in SQL must follow the standard notation, either `<database name>.<schema name>.<table name>` or `<database name>.<table name>`.
====
...
* xref:models.adoc[Create a Model that includes a SQL view]
