...
. Click the *+ Add Group* button on the upper left-hand side of the screen.
...
. You can also use use the search bar above the list of users to find users by name.
...
. Click the *Add users to groups* button above the list of users.
