...
:jira: SCAL-300551, SCAL-303800, SCAL-306618, SCAL-307520, SCAL-304168, SCAL-320863, SCAL-326332
...
For clusters using Spotter 3, with memory enabled, we have added a *Remember this* button below each answer. This button replaces the previous *Add to Coaching* button, which prompted Spotter to create a reference question.

When you click *Remember this*, Spotter automatically enters a prompt in the conversation: "Remember how you answered this, so you can reuse it when I ask this again." It then surfaces a card outlining the memory it created from your request. Memories created by pressing *Remember this* are added to the personal memory for your account.
...
>
> * We highly recommend that you register for the free Spotter Administration course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/spotter-administration/2381995[Adding Memory to Spotter^] lesson.
