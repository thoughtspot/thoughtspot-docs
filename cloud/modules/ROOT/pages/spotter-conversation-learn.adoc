...
Learning from conversations is off by default and is enabled by the same flag as xref:spotter-liveboard-learn.adoc[learning from Liveboards].
...
* Corrective statements after an incorrect answer -- for example, "No, Sets usage = cohort-save event."
* "Correct. Save this."
...
* Rules only — Recipes cannot be generated from conversation.
