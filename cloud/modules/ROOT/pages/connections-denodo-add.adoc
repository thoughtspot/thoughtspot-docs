...
* Enter Host, Port, OAuth Client ID, OAuth Client Secret (optional), Scope, Auth URL, Access token URL, and Database.

+
[.bordered]
image::denodo-fields.png[Fill out the fields for Denodo]
