...
ThoughtSpot Sync lets you push ThoughtSpot insights directly into the business apps your teams already use — operationalizing analytics by delivering data where decisions actually happen, rather than requiring users to log into ThoughtSpot.

You can sync data directly from an Answer or a custom SQL view, to an external business app. Using ThoughtSpot Sync, you can push insights directly to your app, notify your teams, and view data in context. ThoughtSpot automatically establishes a secure pipeline to the destination app and thus eliminates the need for building custom connectors to external apps. You can quickly get started and push data to your workspace with a few simple steps.
...
>
> * We highly recommend that you register for the free ThoughtSpot Sync course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/thoughtspot-sync/1519027[ThoughtSpot Sync^] lesson.
