...
* The model will not be created if the alias table is linked to multiple fact tables in the same model. Such a model creation may lead to ambiguous join paths or invalid queries.
