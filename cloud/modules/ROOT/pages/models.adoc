= Create Models
:page-last_updated: 28th Aug 2025
:linkattrs:
:experimental:
:page-layout: default-cloud
:page-aliases: worksheet-create.adoc
...
:model: Model
:jira: SCAL-158357, SCAL-194041 (9.10.5 -drag to create joins), SCAL-194038 (9.10.5 - bulk edit column properties). SCAL-189664 (remove spotapps - removed from image in step 3 of creating a model. SCAL-202208 (sort and filter in columns grid - 9.12.0.cl), SCAL-203404 (model filters limit - 9.12.0.cl), SCAL-221549 (knowledge cards - 10.4.0.cl), SCAL-225747 (models GA), SCAL-250091, SCAL-268921 (Table Alias in model guidelines)
