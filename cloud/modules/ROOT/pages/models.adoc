...
+
.[.badge.badge-early-access]#Early Access# Knowledge Cards
****
This is an Early Access feature and disabled by default. To enable it, contact your ThoughtSpot administrator.
****
