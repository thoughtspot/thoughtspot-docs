...
:page-last_updated: 10/25/2023
:author: Naomi
:linkattrs:
:page-aliases:
:experimental:
:connection: Google Cloud SQL for PostgreSQL
:description: To delete a table with dependencies from a Google Cloud SQL for PostgreSQL connection, first delete the dependent objects.
:jira: SCAL-166159
...
See xref:connections-google-cloud-sql-postgresql-delete-table.adoc[Delete a table from a {connection} connection].
