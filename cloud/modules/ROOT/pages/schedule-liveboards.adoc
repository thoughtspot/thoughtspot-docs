...
=== Scheduled CSV and XLSX Liveboard file format
Liveboard schedules specifically, CSV and XLSX attachment filenames previously included a *:* character as part of the timestamp. For example, *SampleLB (2026-01-09 03:20:00)*. Since *:* is a reserved system character on Windows, this caused file usability issues on some platforms if the filename was not manually modified.

To ensure better cross-platform compatibility, filenames now use *_* instead of *:*. For example, *SampleLB (2026-01-09 03_20_00)*. This convention is now consistently applied to ZIP, CSV and XLSX exports.
