...
[.bordered]
image::onboarding-select-analyst-1.png[Business user or analyst screen]
...
As an _analyst_, you primarily use ThoughtSpot in the following ways:

* Setting up data connections.
See xref:connect-data.adoc[Connect data].


* Defining relationships and creating Models that help your team search and analyze data.
See xref:models.adoc[Create a Model].

* To search data to create visualizations and analyze the results.
...
In the *Model data and create a model* page, you can select *Go to setup checklist* to learn about your next task.

[.bordered]
image::setup-checklist.png[Setup Checklist]

When you've completed setup, you can go see the Answers you created, by clicking *View answers*.

[.bordered]
image::analyst-onboarding-final-step.png[]
