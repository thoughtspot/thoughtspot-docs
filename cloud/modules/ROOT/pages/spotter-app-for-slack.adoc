...
:last_updated: 1/23/26
:author: Naomi
:experimental:
:page-layout: default-cloud-early-access
:linkattrs:
:description: You can now ask ThoughtSpot questions using Slack.
:jira: SCAL-159819, SCAL-201314, SCAL-239972, SCAL-244742, SCAL-247056, SCAL-252253, SCAL-254387, SCAL-262864, SCAL-264258, SCAL-247056, SCAL-205488

You can now ask questions to Spotter right within Slack. Install the ThoughtSpot app in Slack, add it to a Slack channel, and you will be able to ask questions on your data sources in natural language. ThoughtSpot answers in chart format. To enable the ThoughtSpot Slack app, contact {support-url}.
