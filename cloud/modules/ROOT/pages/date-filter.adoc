...
[#this-period]
.Last period and this period [.badge.badge-early-access]#Early Access#
****
You can now include the current period within a date filter chip, when selecting a rolling date filter. This allows you to define a date range such as "last four months, including this month." This rolling date filters enhancement applies to both Liveboard and Answer filters.
