...
// SCAL-158474
[#database-as]
Database as a destination for Answer sync [.badge.badge-ga-relnotes]#GA#:: Using ThoughtSpot Sync you can now sync data directly from an Answer or a custom SQL view, to your Snowflake or Redshift cloud data warehouse.

//  SCAL-158473
[#enhancements-for]
Enhancements for TS Sync [.badge.badge-ga-relnotes]#GA#::
...
//SCAL-154204
[#sage-coach]
Sage Coach feedback review [.badge.badge-ga-relnotes]#GA#::
...
// SCAL-172513
[#change-analysis]
Change analysis: More insights [.badge.badge-ga-relnotes]#GA#:: Change analysis _More insights_ are now available to all customers and are enabled by default. For example, ThoughtSpot finds values that underwent the highest percentage change between the two data points defined in your analysis, and values whose share of the total changed the most. The insights appear below the main analysis in the change analysis pop-up window. Note that insights do not appear for measures of type `count` and `ratios`. For more information, see xref:spotiq-change.adoc#additional[Change analysis].
...
//SCAL-163617
[#personlized-views]
Personalized views [.badge.badge-ga-relnotes]#GA#::
...
//SCAL-138688
[#custom-calendar]
Custom calendar enabled by default [.badge.badge-ga-relnotes]#GA#::
...
[#connections]
Connections [.badge.badge-ga-relnotes]#GA#::
...
// SCAL-192459
[#redshift-managed]
Redshift-managed PrivateLink [.badge.badge-ga-relnotes]#GA#:: You can now create Redshift Connections using Redshift-managed PrivateLink, as well as AWS PrivateLink. For more information, see xref:connections-redshift-managed-private-link.adoc[].


// SCAL-169279
[#atlan-catalog]
Atlan catalog integration [.badge.badge-ga-relnotes]#GA#:: You can now import metadata information related to your tables and columns from Atlan into ThoughtSpot. From the Data tab, you can set up a connection to Atlan to import column descriptions, column verification status, table descriptions, and table verification status. For more information, see xref:catalog-integration-atlan.adoc[Atlan catalog integration].

// SCAL-132886
[#dbt-public]
dbt public API [.badge.badge-ga-relnotes]#GA#::
...
// SCAL-160062
[#oauth-connection]
OAuth connection improvements [.badge.badge-ga-relnotes]#GA#:: If you do not have a valid OAuth access token, you can now directly navigate to the OAuth authorization screen when performing one of the following actions on a connection shared with you:
...
// Naomi-- scal-187049
[#snowflake-account]
Snowflake account name restrictions [.badge.badge-ga-relnotes]#GA#::
...
// scal-187722
[#org-name]
Org name limitations [.badge.badge-ga-relnotes]#GA#:: When an Org name is created, it becomes a subdomain of the cluster URL. As a DNS subdomain, an Org name cannot contain a space (' ') as a character. When used as a subdomain, any spaces in the Org name will be replaced with hyphens ('-').



// scal-164805
[#disable-sql]
Disable SQL passthrough functions [.badge.badge-ga-relnotes]#GA#::
