...
:experimental:
:connection: Falcon
:description: To delete a table with dependencies from a Falcon connection, first delete the dependent objects.
:jira: SCAL-201648
...
See xref:connections-falcon-delete-table.adoc[Delete a table from a {connection} connection].
