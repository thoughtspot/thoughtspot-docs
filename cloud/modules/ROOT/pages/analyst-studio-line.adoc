...
>
> * We highly recommend that you register for the free Creating Various Quick Charts course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/creating-various-quick-charts/2100845[Creating a Line Chart in Quick Charts^] lesson.
