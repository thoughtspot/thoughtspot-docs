...
:jira: SCAL-136661, SCAL-203358, SCAL-214983, SCAL-230240
...
Personal Access Token::: Specify your Databricks link:https://docs.databricks.com/en/integrations/jdbc/authentication.html#databricks-personal-access-token[personal access token].
...
Service Principal UUID::: Specify the Service Principal UUID.
Service Principal OAuth Secret::: Specify the Service Principal OAuth Secret.
Service account::
