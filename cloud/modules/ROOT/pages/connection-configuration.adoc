...
. Navigate to the Data workspace, click *+*, and select *Connection* from the drop-down.
...
* xref:connections-clickhouse-reference.adoc[Connection reference for ClickHouse]
* xref:connections-databricks-reference.adoc[]
* xref:connections-denodo-reference.adoc[]
* xref:connections-dremio-reference.adoc[Connection reference for Dremio]
...
* xref:connections-iomete-reference.adoc[]
...
* xref:connections-hana-reference.adoc[Connection reference for SAP HANA]
...
* xref:connections-teradata-reference.adoc[Connection reference for Teradata]
