= ThoughtSpot Status
:experimental:
:page-last_updated: 7/18/2025
:linkattrs:
:page-layout: default-cloud-no-index-deprecated
...
To access the status page, go to *Admin settings* > *Status Portal*, and select *Click here to visit Status Page*. The status page opens in a new browser tab.
