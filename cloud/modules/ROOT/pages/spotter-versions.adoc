...
Note that if a new instance is created, the default Spotter experience is Spotter 3. Administrators on existing instances can enable Spotter 3 for their users.
