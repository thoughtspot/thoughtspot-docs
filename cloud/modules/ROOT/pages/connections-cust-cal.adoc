...
:jira: SCAL-172330, SCAL-201842 (doc enhancement), SCAL-176032, SCAL-229340, SCAL-230176, SCAL-235033, SCAL-240707, SCAL-261112, SCAL-274760, SCAL-274862, SCAL-198739
...
* Rolling date filters (example: `last N months`) are not supported.
* Date filters don’t behave as expected.
...
== Custom calendar query performance enhancements
