...
:jira: SCAL-172330, SCAL-201842 (doc enhancement), SCAL-176032, SCAL-229340, SCAL-230176
...
* Using date formulas with the `fiscal` option specified. (See xref:10.3.0.cl@cloud:ROOT:formulas-date.adoc#fiscal-and-gregorian-calendars[Fiscal and Gregorian calendars]).
...
> **Related information**
>
> * xref:10.3.0.cl@cloud:ROOT:connections-cust-cal-create.adoc[Create a custom calendar] +
> * xref:10.3.0.cl@cloud:ROOT:connections-cust-cal-update.adoc[Update a custom calendar] +
> * xref:10.3.0.cl@cloud:ROOT:connections-cust-cal-delete.adoc[Delete a custom calendar]
