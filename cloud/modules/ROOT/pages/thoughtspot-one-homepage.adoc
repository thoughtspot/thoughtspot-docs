...
You can also select these KPIs to access the Liveboard they come from, either in the same tab or in a new tab.
...
. Select a KPI chart or multiple KPI charts, and click *Add KPIs*.

Note that you can have any number of KPIs on your watchlist at a time.

image::kpi-watchlist.gif[KPI watchlist gif]
...
NOTE: If you can no longer access a KPI on your watchlist (because the headline or Liveboard was deleted, or your access permissions changed), the system displays a note saying you cannot view that KPI.
