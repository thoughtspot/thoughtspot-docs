...
To bulk mark objects as favorites, select the empty checkboxes next to the object names, and select *Mark as favorite* near the top of the page, under the metric watchlist.
You can also favorite each object on the page, by selecting the empty checkbox next to the word *Name* at the upper left of the screen, under the filter bar.
...
. Select the empty checkboxes next to the names of the objects you would like to share.
Alternatively, you can select each object on the page, by selecting the empty checkbox next to the word *Name* at the upper left of the screen, under the filter bar.
+
Note that you cannot select multiple objects across pages.
...
. Select the empty checkbox next to the name of the object you would like to delete.
+
Note that you cannot select multiple objects across pages.
