...
To make changes to the chart configuration, select the *layout* icon in the upper-right corner of the visualization, the second from the top.
...
This opens the *Layout* menu for the chart.
Using this menu, you can drag and drop measure and attribute chips to or from an axis.
Select any measure or attribute chip that has a vertical six-dot icon to customize it.
In the following image, all columns are customizable.
...
>
> * We highly recommend that you register for the free Customizing Charts and Visualizations course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/customizing-charts-and-visualizations/1980332[Customizing Charts and Visualizations - Advanced^] lesson.
