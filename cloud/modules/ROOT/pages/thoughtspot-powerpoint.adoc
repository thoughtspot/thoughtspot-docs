...
NOTE: This ThoughtSpot plugin for Microsoft PowerPoint is currently only available for PowerPoint in browsers. It is not supported in the installed Microsoft Office applications, including the desktop version of PowerPoint.
