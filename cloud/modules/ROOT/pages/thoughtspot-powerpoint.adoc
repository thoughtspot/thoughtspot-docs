...
:jira: SCAL-245106, SCAL-258586, SCAL-278385, SCAL-313160, SCAL-320900
...
- Available both for Windows devices and macOS desktop application.
...
ThoughtSpot automatically optimizes the resolution and scaling of chart PNG exports in the Microsoft PowerPoint add-in, improving their legibility.
...
[.bordered]
image::enhanced-viz-plugin2.png[Enhanced visualizations]
...
presentation are updated to the new defaults the next time you refresh the
visualizations.


== Limitations

Note that the PowerPoint plug-in can only be accessed in the browser version, not in the desktop version.