...
To fine-tune Spotter’s understanding of your data, you will want to coach it to recognize your organization’s business terms and common use cases before users begin searching. This article documents the steps you should take after coaching reference questions and business terms.
...
. Run various sample questions (a set of test queries defined during xref:spotter-deploy.adoc#step-2[collecting real questions] and xref:spotter-deploy.adoc#step-4[testing Spotter] to check if Spotter applies the logic correctly.
+
[.bordered]
