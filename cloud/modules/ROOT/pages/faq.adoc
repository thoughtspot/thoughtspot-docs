...
== I'm not seeing certain columns/values in the dropdown menu, why?
...
To learn more about modeling data see the xref:data-modeling-settings.adoc#[modeling data] in this documentation.
