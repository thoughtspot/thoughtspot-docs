...
[NOTE]
====
The *Provisioned users* KPI will not reflect the Org specific data by only using the Org filter available on the Liveboard. To be able to see the number of *Provisioned users* for a specific Org, use the *Provisioned Users* data model.
====
