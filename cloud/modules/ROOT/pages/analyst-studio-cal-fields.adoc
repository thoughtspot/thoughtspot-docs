...
. Navigate to the Data workspace and select *{product}*, then sign in to your Workspace.
 ...
 ** You can also create offsets based on the first or last rows in the expression, using `FIRST()+n` and `LAST()-n`.
...
>
> * We highly recommend that you register for the free Spreadsheets in Analyst Studio course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/spreadsheets-in-analyst-studio/2529351[Creating Columns in a Spreadsheet with Formulas^] lesson.
