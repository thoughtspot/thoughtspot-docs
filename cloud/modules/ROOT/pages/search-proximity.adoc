...
To search on two (or more) different tables, xref:worksheets.adoc[create a Model] that contains data from those tables and use the Model as your data source.
