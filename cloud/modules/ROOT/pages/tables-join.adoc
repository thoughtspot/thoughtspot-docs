...
As part of creating a Model, you create joins between your tables. This improves the accuracy of your Search.

With joins, a single search retrieve rich data and dimensional information across multiple tables of your database.
