...
You can create and manage non-equi joins in the ThoughtSpot UI. This streamlines modeling because you don't have to use TML or technical workarounds to do it. You can also choose multiple conditions to use for creating the join. The join will be created only if the condition(s) are met. To enable this feature, contact {support-url}.
