...
You can create and manage non-equi joins in the ThoughtSpot UI. This streamlines modeling because you don't have to use TML or technical workarounds to do it.

You can use the following non-equi joins in ThoughtSpot:
