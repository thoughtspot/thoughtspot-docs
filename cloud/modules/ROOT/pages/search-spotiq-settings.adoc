...
The options are 8 hours, 16 hours, 24 hours, or 7 days. The new default indexing frequency is 7 days. To further customize your indexing frequency and the index start time, contact {support-url}.
