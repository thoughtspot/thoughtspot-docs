...
There are two different toggles in this section. The first toggle, *New Liveboard experience*, turns on the ability to opt into the new experience for any user. The second toggle, *Make new Liveboard experience default*, turns the new experience on by default.
