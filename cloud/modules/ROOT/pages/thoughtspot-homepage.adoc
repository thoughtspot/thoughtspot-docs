...
The new global navigation organizes ThoughtSpot into different contextual sections. Each one is designed for a common type of ThoughtSpot user.
//You navigate to each option using the tabs in the left hand menu.
////
.*Insights*
