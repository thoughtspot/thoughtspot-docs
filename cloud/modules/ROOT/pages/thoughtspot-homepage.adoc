...
Administrators can manage the homepage version for all Orgs, or individual Orgs when this feature is enabled. To enable this feature, contact your administrator.


.*Enabling focussed homepage for administrators*

To enable focussed hompage:

. Go to *Admin settings*.
//. Select *All Orgs*.
. Select *App Experience*.
. Toggle on the new homepage experience.
