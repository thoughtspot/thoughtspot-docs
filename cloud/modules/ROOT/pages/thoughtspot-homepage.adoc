...
Your ThoughtSpot administrator can enable the new navigation and homepage for the cluster, in the xref:early-access-enable.adoc[Early access features] section of the Admin page.

IMPORTANT: In the 10.15.0.cl release, the new navigation and homepage experience will be enabled by default for all users. At that point, the classic experience will no longer be available to any ThoughtSpot user.
...
With the new left-hand navigation, you can go directly to your Liveboards, Answers, SpotIQ Analysis, and Monitor Subscriptions. You can also access tutorials, and ThoughtSpot documentation and support directly from the homepage.

image::scroll_homepage.gif[Homepage redesign]

.Persona-based navigation [.badge.badge-early-access]#Early Access#
****
The new global navigation organizes ThoughtSpot into different contextual sections. Each one is designed for a common type of ThoughtSpot user. You navigate to each option using the tabs in the left-hand navigation.
