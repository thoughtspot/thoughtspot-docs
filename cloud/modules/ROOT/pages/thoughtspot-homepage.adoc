...
The homepage and navigation of the ThoughtSpot app have been entirely redesigned.
...
image::admin-settings.png[Navigate to Admin settings.]
...
Here's a quick reference which compares where things were in the previous navigation to where they are in the new navigation:
