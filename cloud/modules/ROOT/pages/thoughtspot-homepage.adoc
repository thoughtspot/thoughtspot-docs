...
****
ThoughtSpot has a new focused home page experience option. The focused home page delivers a streamlined, contemporary experience for users that highlights the Spotter experience.
...
Administrators can manage the home page version for all Orgs when this feature is enabled. To enable this feature, contact your administrator.


*Enabling the focused home page for administrators*

To enable the focused home page:

. Go to *Admin settings*.
. Select *All Orgs*.
. Select *Home Page & App Experience*.
. Go to *Homepage experience* and clck *Edit*.
. Select *Focused* and click *Save*.
****
