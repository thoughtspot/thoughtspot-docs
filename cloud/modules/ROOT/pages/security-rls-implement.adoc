...
WARNING: For column indexing to work, the RLS rule must contain either the `ts_groups` or `ts_username` keywords. An RLS rule that does not contain either of these keywords will fail to index.
