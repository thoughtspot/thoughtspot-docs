...
== Limitations
The UUID data type is supported in a PostgreSQL connection, however ThoughtSpot casts this UUID data type to a String type. Since this is a casted data type, ThoughtSpot does not support string functions on the casted String (previously UUID) columns.
...
> * xref:connections-postgresql-deactivate.adoc[]
