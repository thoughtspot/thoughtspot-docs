...
:experimental:
:linkattrs:
:description: Geo bubble charts display the value of the measure through the relative size of the bubble on a map.
...
image::geo_bubble_chart_example.png[Geo bubble chart example]
