...
. Enter your prompt in the chat interface. For example, you could say: `I want an Analyst that can help me understand sales performance`. Click the blue arrow or press Enter to start your conversation.

. The Spotter Analyst Builder searches for Models that fit your prompt, and begins to draft instructions for your Analyst. It enters its draft into the interface on the right side, where you can edit it as needed.

. If you want to authorize connectors like Slack or Web search for your Analyst, select the *+* symbol in the Connectors section on the right-side interface, and select the checkbox next to the desired Connectors.
