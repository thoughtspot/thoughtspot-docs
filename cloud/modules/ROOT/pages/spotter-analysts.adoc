...
>
> * We highly recommend that you register for the free ThoughtSpot University course that covers the information in this article, https://training.thoughtspot.com/spotter-analysts/2554906[Introduction to Spotter Analysts^].
