...
TS: Login Activity Tracking:: Administrators will now have clearer visibility into how their users access the system. Contains username and ID, Org name and ID, login timestamp, whether the login was successful or not, https response code, and the login success rate. 
