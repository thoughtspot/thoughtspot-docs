...
====
// SOURCE: Demo transcript — AgentQL demo video
AgentQL was progressively rolled out starting from ThoughtSpot Cloud 26.8.0.cl. If you do not see AgentQL on your instance, contact your ThoughtSpot administrator.
