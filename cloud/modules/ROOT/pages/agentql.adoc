...
[TIP]
====
You can explicitly invoke AgentQL by mentioning Semantic Query in your Spotter prompt. For example: "Use Semantic Query to find the top 10 customers by revenue last quarter." You can also add instructions to use Semantic Query in your Spotter instructions.
====
...
====
// SOURCE: Demo transcript — AgentQL demo video
AgentQL will be progressively rolled out starting from ThoughtSpot Cloud 26.8.0.cl. If you do not see AgentQL on your instance, contact your ThoughtSpot administrator.
