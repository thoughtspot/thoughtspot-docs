...
For OAuth, we recommend checking the {connection} link:https://docs.snowflake.com/en/user-guide/oauth-ext-overview[documentation^] to confirm any IDP support and their details. This article documents only the most frequently set-up IDP.
