...
SpotIQ helps you find insights in your data.
Insights are trends, correlations, explanations of increases, explanations of decreases, and outliers (values unique from what is typical in your data). It automatically analyzes your data and surfaces insights you might not have thought to look for — without you having to ask a specific question.
...
If you can see the *SpotIQ analysis* on the *Insights* tab, you have access to SpotIQ.
...
. Select *SpotIQ analysis* from the *Insights* tab. If you don't see that option, you don't have SpotIQ privileges; contact your administrator.
...
>
> * We highly recommend that you register for the free Introduction to SpotIQ course in ThoughtSpot University that covers the information in this article, and watch the following lessons:
> ** https://training.thoughtspot.com/introduction-to-spotiq/1754340[Introduction to SpotIQ^]
> ** https://training.thoughtspot.com/introduction-to-spotiq/2006569[Trend Analysis using SpotIQ^]
> ** https://training.thoughtspot.com/introduction-to-spotiq/2006568[Outlier Analysis using SpotIQ^]
> ** https://training.thoughtspot.com/introduction-to-spotiq/2006570[Cross Correlation Analysis using SpotIQ^]
