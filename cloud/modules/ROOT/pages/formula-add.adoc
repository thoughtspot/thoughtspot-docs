...
IMPORTANT: Runtime filters don't work in a formula of an Answer.
...
+
NOTE: Formulas variables are now supported as an early access feature.
...
You can now copy a formula directly from the Search Data side menu, edit it instantly, and save it as a new formula.


To copy a formula, follow these steps:


. Hover over the formula in the side menu until the More menu image:icon-more-10px.png[More menu icon] appears. Click the menu and select *Copy*.


. The formula editor appears with the copied formula. Update the title, make any desired changes, and click *Save*.

[#formula-experience-comparison]
== Formula Editor experience

As part of the xref:answer-experience-new.adoc[Answer experience], has the following features:
...
>
> * We highly recommend that you register for the free Introduction to Formulas course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/introduction-to-formulas/1111294[Using Formulas in Search^] lesson.
