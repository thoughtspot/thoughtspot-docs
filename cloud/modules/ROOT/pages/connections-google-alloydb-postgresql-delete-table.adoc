...
:description: Learn how to delete a table from a Google AlloyDB for PostgreSQL connection.
:jira: SCAL-166161
...
See xref:connections-google-alloydb-postgresql-delete-table-dependencies.adoc[Delete a table with dependent objects].
