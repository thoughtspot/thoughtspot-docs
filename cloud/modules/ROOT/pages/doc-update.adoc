...
You can now open the search menu instantly with a single keyboard shortcut (kbd:[`Cmd`] + kbd:[`K`] on Mac / kbd:[`Ctrl`] + kbd:[`K`] on Windows and Linux).

Once the search menu is open, use the Up and Down arrow keys to move through results, then press kbd:[`Enter`] to jump straight to what you need. No clicks required. You can also close the search menu by pressing kbd:[`Esc`].
