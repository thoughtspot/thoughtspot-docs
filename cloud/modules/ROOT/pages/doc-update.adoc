...
=== Release notes
A dedicated section for release notes across ThoughtSpot Cloud versions, including what's new, resolved issues, and deprecation notices.

=== Getting started
Introductory topics to help new users and administrators set up and begin using ThoughtSpot.

=== Spotter Agents
Documentation for Spotter, ThoughtSpot's AI-powered analytics agents. This is a top-level section because Spotter is one of the most commonly used features by business users.
...
=== Reference
A dedicated section for reference information including keyword reference, formula reference, API reference, and other technical specifications.

=== Help and support
A dedicated section for information on the various ways to get help with ThoughtSpot including contacting ThoughtSpot support experts. It also covers how administrators can customize the help menu with company-specific links and documentation.
