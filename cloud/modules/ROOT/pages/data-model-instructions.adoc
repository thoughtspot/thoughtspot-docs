...
:page-aliases: spotter-instructions.adoc, natural-language-instructions.adoc
:linkattrs:
:experimental:
...
The data model instructions feature allows you to provide the Spotter system with global rules that it should follow across all relevant queries. Unlike xref:spotter-context.adoc[Spotter context], which is tied to a specific reference question, a data model instruction is a standalone directive designed to teach the system a core concept, a default behavior, or a specific data nuance.
