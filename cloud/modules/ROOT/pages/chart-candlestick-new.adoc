...
[NOTE]
====
Candlestick charts are available as part of the new charts library 2 charts Early Access rollout. Contact {support-url} to enable this chart type on your instance.
====
