...
:experimental:
:page-aliases: /analyst-studio/connecting-analyst-studio-to-your-database.adoc
:path: /articles/connecting-mode-to-your-database
:product: Analyst Studio
:jira: SCAL-219400, SCAL-238113, SCAL-280584
...
All connections from {product} will come from one of these seventeen IP addresses:
...
. Navigate to the Data workspace and select *{product}*. Navigate to the Workspace to which you'd like to add the connection, and click on your name in the top left corner.
...
[.bordered]
image::transport_off.png[Transport encryption]
...
To install and configure Bridge, ensure the following:

* Your workspace must be on a paid plan to use Bridge.

* You have sufficient (typically local administrative) privileges on the host computer.

* You must also have access within {product} to connect data sources for your Workspace.

* Bridge connects to {product} by making an outbound TCP connection to the Bridge server on port 443 or 8444.

* You can run {product}'s Bridge connector as a container on any Linux host running Docker engine.

* The system meets the supported operating system requirements listed below.



=== Supported Operating Systems

The table below lists current distributions and their end-of-life timelines:

[options="header"]
|===
| Operating system / distribution | EOL reached | End of standard support | Final EOL (extended support)

| Ubuntu 14.04 (Trusty)
| Yes
| April 2019
| April 2024 (Ubuntu Pro / ESM)

| Ubuntu 16.04 (Xenial)
| Yes
| April 2021
| April 2026 (Ubuntu Pro / ESM)

| Ubuntu 18.04 (Bionic)
| Yes
| May 2023
| April 2028 (Ubuntu Pro / ESM)

| Ubuntu 20.04 (Focal)
| Yes
| May 2025
| April 2030 (Ubuntu Pro / ESM)

| Ubuntu 22.04 (Jammy)
| No
| April 2027
| April 2032 (Ubuntu Pro / ESM)

| Ubuntu 24.04 (Noble)
| No
| April 2029
| April 2034 (Ubuntu Pro / ESM)

| Debian 8 (Jessie)
| Yes
| June 2018
| June 2020 (Debian LTS) / June 2025 (ELTS)

| Debian 9 (Stretch)
| Yes
| July 2020
| July 2022 (Debian LTS) / June 2027 (ELTS)

| Debian 12 (Bookworm)
| No
| June 2026
| June 2028 (Debian LTS) / June 2033 (ELTS)
...
| No
| May 2027
| May 2032 (RHEL Maintenance Support)

| Oracle Linux 6
| Yes
| March 2021
| December 2024 (Extended Support)

| Oracle Linux 7
| Yes
| December 2024
| June 2028 (Extended Support)

| Oracle Linux 9
| No
| June 2032
| June 2035 (Extended Support)
...
NOTE: Older operating system versions that have reached end-of-life may continue to run Bridge, but they are no longer actively supported.
...
These instructions assume that you meet <<bridge-requirements,the requirements>> and would like to install {product}'s Bridge connector on a host computer you administer.
...
These instructions assume you meet <<bridge-requirements,the requirements>> and would like to run {product}'s Bridge connector in a Docker container.
...
If you don't see commands listed for your system below, please contact {support-url}.
...
>
> * We highly recommend that you register for the free Connecting Databases to Analyst Studio course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/connecting-databases-ts/2074412[How to Connect a Database^] lesson.
