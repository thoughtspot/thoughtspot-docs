ifndef::spotter[]
= Connections in ThoughtSpot Cloud
endif::[]
:page-last_updated: 12/13/2022
:linkattrs:
:experimental:
...
* *xref:connections-clickhouse-add.adoc[Add a ClickHouse connection]* +
Create the connection between ThoughtSpot and tables in an external ClickHouse database.
...
//* *xref:connections-falcon-add.adoc[Add a Falcon connection]* +
//Create the connection between ThoughtSpot and tables in an external Falcon database.
...
////
* *xref:connections-iomete-add.adoc[Add an Iomete connection]* +
Create the connection between ThoughtSpot and tables in an external Iomete database.
* *xref:connections-looker-add.adoc[Add a Looker connection]* +
Create the connection between ThoughtSpot and tables in an external Looker database.
