...
|#Secure sampling#|SECURE_SAMPLING|System samples values for columns set to Secure suggestions
|#Secure match values#|SECURE_MATCH_VALUES|System fetches exact match values for columns set to Secure suggestions
