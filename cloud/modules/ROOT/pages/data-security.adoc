...
| Worksheets | A Worksheet created using a web browser. | Only the creator of the Worksheet (and any user with administrator privileges) has access to it by default. They can share a Worksheet with other users or groups. See xref:share-models.adoc[Share Worksheets].
