...
ThoughtSpot includes robust row-level security (RLS), which allows you to filter all objects users see based on conditions you set at the level of row values in base data tables.
