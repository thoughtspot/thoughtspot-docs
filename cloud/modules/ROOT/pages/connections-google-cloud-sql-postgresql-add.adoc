...
:description: Learn how to add a Google Cloud SQL for PostgreSQL connection.
:jira: SCAL-166159
...
+
[.bordered]
image::google-cloud-sql-postgresql-connectiontype.png[Add a {connection} connection]
+
Refer to the xref:connections-google-cloud-sql-postgresql-reference.adoc[{connection} connection reference] for more information on each of the specific attributes you must enter for your connection.
...
You can also xref:connections-google-cloud-sql-postgresql-delete.adoc[Delete a {connection} connection].
...
> * xref:connections-google-cloud-sql-postgresql-deactivate.adoc[]
