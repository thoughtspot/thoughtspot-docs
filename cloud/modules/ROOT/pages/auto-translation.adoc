...
* List pages such as Liveboard names, Answer names, and Liveboard names in schedules
//* Favorites
...
>
> * We highly recommend that you register for the free Localization & Language Settings course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/localization-language-settings/2534525[Auto-Translation for Liveboards and Answers^] lesson.
