...
https://docs.databricks.com/api/account/networks/create[Create a new network configuration using Account API^], with further references in the https://docs.databricks.com/administration-guide/cloud-configurations/aws/privatelink.html[Databricks AWS PrivateLink documentation^].

[#create-workspace]
=== Step 4: Create or update the Databricks workspace

. https://docs.databricks.com/api/account/workspaces/update[Create or update a workspace with PrivateLink configurations using the Account API^], with further references in the https://docs.databricks.com/administration-guide/cloud-configurations/aws/privatelink.html[Databricks AWS PrivateLink documentation^].
