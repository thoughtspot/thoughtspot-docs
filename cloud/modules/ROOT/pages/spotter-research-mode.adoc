...
>
> * We highly recommend that you register for the free ThoughtSpot University course that covers the information in this article, https://training.thoughtspot.com/using-spotter-the-ai-analyst/2419808[Spotter Research Mode^].
