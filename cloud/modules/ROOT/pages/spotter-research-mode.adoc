...
:description: In Spotter 3, we are introducing Search and Research Mode, which are complementary co-existing modes that share the same underlying toolset while scaling in intensity.
:jira: SCAL-287506
