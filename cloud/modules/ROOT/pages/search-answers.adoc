...
== Why search your library?

With Search your library, you can search existing content in Answers and Liveboards to get the information you need.
This feature complements Search Data, where users create new Answers and Liveboards.

Search your library supports new users who are not yet familiar with the data in their organization.
...
Search your library eliminates redundant construction of new Answers and Liveboards by finding what is already in the system, the result of your co-workers' earlier queries.
...
. To search, select *Search your library* from the top navigation.
+
image::search-library.png[Search your library]
. Enter your search terms in the *Search* to search objects or navigate anywhere in ThoughtSpot.
+
As you enter terms in the search bar, ThoughtSpot suggests relevant and recently viewed Answers, Liveboards, and locations in the user interface.
+
image::search-lib-results.png[]
+
The results indicate the type of object, author, and location for each entry.
+
. Select one of the suggested items to go to that page.
+
The following example shows the results page for an object search:
+
image::search-lib-results2.png[]



NOTE: ThoughtSpot supports Search your library for multiple languages. Search your library for English is GA. Search Answers for all other xref:locale.adoc[supported languages] is in Beta.
...
. You can select a specific Model from the **Sources** dropdown menu to the left of the search bar. By default, you search across all Models for which you have access.
