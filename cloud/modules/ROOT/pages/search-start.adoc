...
:jira: SCAL-152804, SCAL-201885 (more menu in data panel v2 - 9.12.0.cl), SCAL-264258
...
. Select *Search data* on the *Insights* tab.
+
...
. Select *Search data* from the *Insights* tab.
+
The *Search data* page appears.
