...
Permissions to see and edit tables, Models, and Liveboards are set when you share them with users and groups, as described in the topic xref:data-security.adoc#[Data security].
