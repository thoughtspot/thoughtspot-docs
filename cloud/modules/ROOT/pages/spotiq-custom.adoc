...
You access it using the lightbulb button image:icon-lightbulb.png[more options menu icon] or the ellipses menu image:icon-more-10px.png[SpotIQ analyze icon].
