...
:page-aliases: /analyst-studio/ai-assist
...
* When you're ready, generate new SQL on the right by clicking the Generate button (kbd:[`Shift`] + kbd:[`Opt`]/kbd:[`Alt`] + kbd:[`N`]).
+
...
* Once the generated code returns, you can compare it with your original code, insert the SQL in place of your original edits (kbd:[`Shift`] + kbd:[`Opt`]/kbd:[`Alt`] + kbd:[`I`]), or copy and paste manually as needed.
