...
. xref:business-user-datasource-confirm.adoc[Recommended data source]: get insights into this data source through Search
. xref:business-user-liveboard-select.adoc[Select a Liveboard]: choose a Liveboard to follow or explore
. xref:business-user-view-select.adoc[View your insights]: explore valuable insights through Liveboards
