...
To repeat user onboarding or change your persona, simply select *Profile* from the user icon at the upper right of the page, and under *Experience*, click *Revisit onboarding experience*.
