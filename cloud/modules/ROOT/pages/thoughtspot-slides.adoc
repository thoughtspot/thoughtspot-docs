...
- For RBAC enabled clusters, it required the *Can Download Visuals* and *Can Download Detailed Data* privileges.
...
ThoughtSpot automatically optimizes the resolution and scaling of chart PNG exports in the
Google Slides add-in. Thus improving their legibility.
