...
. Check the cluster health by running health checks and logging into the application. Refer to the xref:aws-configuration-options.adoc[Amazon Web Services (AWS) EC2 deployment guide] for the detailed steps to install ThoughtSpot.
