...
:description: Learn the specific information needed to establish a secure connection to Amazon RDS MySQL.
...
> * xref:connections-amazon-rds-mysql-delete.adoc[Delete a {connection} connection]
