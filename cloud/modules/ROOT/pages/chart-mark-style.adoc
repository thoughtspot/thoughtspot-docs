...
This lets you distinguish data series visually through shape treatment rather than color alone.
...
When a color encoding is active, the outline automatically inherits the same color as the mark fill, darkened for contrast.
