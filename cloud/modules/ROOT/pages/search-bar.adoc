...
== Canceling a search
You can stop in-progress queries on your cloud data warehouse (CDW) when you want to change or abandon a search. This reduces unnecessary CDW costs and lets you iterate faster.
