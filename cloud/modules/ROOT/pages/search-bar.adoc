...
The search help appears when you type a term that isn't understood by ThoughtSpot and then press the Enter key. Click *Try sample searches* to use xref:search-assist.adoc[Search Assist] to learn how to search data.
