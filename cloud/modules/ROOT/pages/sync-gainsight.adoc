...
Before you create a sync to {connection}, sign in to Gainsight to generate an *API key*. You need this information to set up your connection. You can generate the API key using the following steps:
...
. Select the desired Answer from the *Answers* page or the ThoughtSpot home page. You must have *Can manage sync* permissions and *view* access to an Answer to create a sync.
