...
<<html_parsed_string, html_parsed_string>>
...
[#date_filter]
date_filter::
Populated only if the filter column is of the date type.
...
[#html_parsed_string]
html_parsed_string::
HTML parsed string of the note tile.
...
[#is_mandatory]
is_mandatory::
Indicates if a filter is marked as mandatory.

[#is_public]
is_public::
Indicates if a view is public or not.

[#is_single_value]
is_single_value::
Indicates if a filter is marked as single value.
...
[#views]
views::
List of personalised views for the user.

[#view_filters]
view_filters::
List of personalised view filters.

[#view_parameters]
view_parameters::
List of personalised view parameters.
