...
You can see all of the dependencies for any data source (Model or table) on the *Data* page.
...
. Select *Dependents*.
+
You will see a list of the names of the dependent objects (Models and Liveboards), and the columns they use from that data source.
...
ThoughtSpot checks for dependencies whenever you try to delete a table or Model.
