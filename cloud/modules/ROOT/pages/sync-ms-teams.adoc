...
. Select the desired Liveboard from the *Liveboards* page or the ThoughtSpot homepage. You must have *can manage sync* permissions and *view* access to a Liveboard to create a sync.
