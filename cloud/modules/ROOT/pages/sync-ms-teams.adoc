...
. In the upper right corner, click the *more options* menu icon image:icon-more-10px.png[] and select *Sync to other apps*. Select *Microsoft Teams* and click *Next*.
