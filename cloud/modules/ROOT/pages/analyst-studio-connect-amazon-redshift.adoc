...
Please click on your VPC Security Group name and follow xref:analyst-studio-connect-amazon-web-services.adoc#rds[this section of our Amazon RDS guide], starting with step 2.
