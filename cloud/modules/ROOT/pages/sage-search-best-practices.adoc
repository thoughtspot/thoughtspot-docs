...
:jira: SCAL-187163, SCAL-207854, SCAL-211072, SCAL-214359, SCAL-264258
...
ThoughtSpot’s natural language capability in general works well with a well-structured Model that has properly named and non-ambiguous columns. The underlying data doesn't have restrictions on the number of columns or any join restrictions. However, we do specify some best practices when creating Models to get the best natural language search accuracy:
...
** Add synonyms by enabling the xref:data-modeling-visibility.adoc#automatic-synonyms[AI-generated Model synonyms] feature, or you can xref:data-modeling-visibility.adoc#create-synonyms[create your own synonyms].
* Column Values
...
* If you are unsuccessful in getting an AI-generated Answer, try making the question more specific. It is advisable to use actual column names or synonyms as entered in the Models, if you know them.
+
image:prompt-unspecific.png[Avoid general prompts]
+
image:prompt-specificity.png[Use actual terms from your Model]
...
* Our system is not equipped to answer descriptive questions about the data sources. For example, don't ask "How many date columns does the Model have?"
