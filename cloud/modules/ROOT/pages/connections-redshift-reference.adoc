...
(OAuth only) Scope:: Scope maps to a role in your {connection} database.
+
...
(AWS IDC OAuth only) AWS Identity Namespace:: The identity namespace to be used while authenticating using the IdpTokenAuthPlugin.
