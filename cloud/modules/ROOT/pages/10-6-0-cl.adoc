...
Advanced conditional formatting [.badge.badge-ga-relnotes]#GA#::
...
Group aggregates in change analysis [.badge.badge-ga-relnotes]#GA#:: You can now run change analysis on queries that contain group aggregate expressions.
[#suggest-indexing-of-columns-for-spotter]
Suggest indexing of columns for Spotter [.badge.badge-ga-relnotes]#GA#::
In this release, we introduce *Optimize for Spotter*. It is an easier way of indexing the Worksheet and Model attribute columns required for accurate searches on specific column values in Spotter. After enabling Sage on a Worksheet or Model and clicking the *Optimize for Spotter* button, ThoughtSpot detects which columns are not indexed and allows you to index the ones you need for Spotter. For more information, see xref:spotter-model.adoc#optimize-spotter[Optimize for Spotter].
...
Improved error messaging in Data model editor [.badge.badge-ga-relnotes]#GA#::
...
New security log events for data modeling [.badge.badge-ga-relnotes]#GA#::
...
[#custom-charts]
Custom charts [.badge.badge-ga-relnotes]#GA#::
...
Gradient-based conditional formatting [.badge.badge-ga-relnotes]#GA#:: Gradient-based conditional formatting is now available to all users and on by default. You can now choose multiple colors to define a gradient in charts that support gradients -- geo heatmap, geo area, heatmap, and treemap charts. You can control the low, mid, and high values, and numerical value points to customize the gradient.
+
...
Improved sorting, filtering, and export of Answers and Liveboards in the new navigation and home page experience [.badge.badge-ga-relnotes]#GA#::
...
Spotter Conversations Liveboard [.badge.badge-ga-relnotes]#GA#::
...
ThoughtSpot Enterprise Org enablement [.badge.badge-ga-relnotes]#GA#::
...
Org context for sharing links [.badge.badge-ga-relnotes]#GA#::
