...
>
> * We highly recommend that you register for the free Multi-Tenancy with Orgs course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/admin-logical-multi-tenancy-with-orgs/2499358[Managing Users & Groups with Orgs^] lesson.
