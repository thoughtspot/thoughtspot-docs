...
Cloud data platforms:: xref:connections-redshift.adoc[Amazon Redshift], xref:connections-synapse.adoc[Azure Synapse], xref:connections-databricks.adoc[Databricks], xref:connections-gbq.adoc[Google BigQuery], xref:connections-iomete.adoc[Iomete], and xref:connections-snowflake.adoc[Snowflake].
