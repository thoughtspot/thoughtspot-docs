...
Cloud data platforms:: xref:connections-redshift.adoc[Amazon Redshift], xref:connections-synapse.adoc[Azure Synapse], xref:connections-clickhouse.adoc[ClickHouse], xref:connections-databricks.adoc[Databricks], xref:connections-gbq.adoc[Google BigQuery], and xref:connections-snowflake.adoc[Snowflake].
