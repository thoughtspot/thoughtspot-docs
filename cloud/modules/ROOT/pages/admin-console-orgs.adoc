...
Navigate to the Admin Console by selecting *Admin settings* from your user profile icon.
...
* xref:search-spotiq-settings.adoc[Manage search and SpotIQ settings:] Enable, disable, and configure the following features: SpotIQ, column indexing, summaries, the Answer, SpotIQ, and Liveboard experiences, and the footer for downloaded answers and Liveboards.
