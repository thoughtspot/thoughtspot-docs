...
:jira: SCAL-229515, SCAL-247875, SCAL-279451
...
You can now define filters as progressive at the Model level. This ensures these filters only apply when the relevant table is referenced in the search. This can come in handy when you're searching for sales by product, and want a filter for date to only apply on the Product table. For more information, see xref:tml-models.adoc[].
...
>
> * We highly recommend that you register for the free Working with Filters course in ThoughtSpot University that covers the information in this article, and watch the following lessons:
> ** https://training.thoughtspot.com/working-with-filters/891351[Applying Filters^]
> ** https://training.thoughtspot.com/working-with-filters/896526[Measure Filters and Operator Keywords^]
> ** https://training.thoughtspot.com/working-with-filters/896527[Using Time and Date Filters^]
