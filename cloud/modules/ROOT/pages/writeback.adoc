...
. Click *more* next to the input table name in the data panel.
. Select *Edit*.
+
The same *Input Table* modal opens.
...
| Create an Input Table | Edit permission on the object + write access to CDW schema.
