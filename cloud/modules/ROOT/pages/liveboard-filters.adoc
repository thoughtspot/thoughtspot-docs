...
With this centralized modal window, you can edit the values to include or exclude for multiple filters together and then apply all the changes to the Liveboard at once.
