...
*Centralized filter modal* [.badge.badge-early-access-relnotes]#Early Access#

With this centralized modal window, you can edit the values for multiple filters and parameters together and then apply all the changes to the Liveboard at once.
