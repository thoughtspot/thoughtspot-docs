...
* If a Liveboard includes a visualization that does not populate because it uses one or more inaccessible columns, the user cannot interact with the filter chips (even though all the chips are accessible):
