...
:page-last_updated: 12/2/2025
:author: Naomi
:page-layout: default-cloud-no-index-early-access
:jira: SCAL-166121, SCAL-197922, SCAL-201034, SCAL-201830, SCAL-206380
...
When you drill down or modify Answers through explore mode, the customized tooltips are not retained since the new Answers are essentially new data queries too.
