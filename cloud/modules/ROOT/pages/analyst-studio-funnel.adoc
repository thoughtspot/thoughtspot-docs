...
>
> * We highly recommend that you register for the free Using Visual Explorer to Create Dynamic Visualizations course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/using-visual-explorer-to-create-dynamic-visualizations-ts/2074898[Funnel Charts in Visual Explorer^] lesson.
