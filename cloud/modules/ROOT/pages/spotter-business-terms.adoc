...
Reference questions and business terms now respect column aliases built in the underlying Model. For example, if you create column aliases in Spanish for a data model with English column titles, the business term in the Memory sources page would display the alias for users with Spanish locales.
...
+
This will lead you directly into the creating flow, where you can begin refining responses and improving Spotter's accuracy. You can use the data source tab next to the Search bar to select the data source for which you want to define a business term.
+
[.bordered]
