...
This is your final, most specific coaching tool. It should be used as a "last resort" to create a specific, reusable TML (ThoughtSpot Modeling Language) mapping for a term.
