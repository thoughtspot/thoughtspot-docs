...
:page-aliases: intro-embed.adoc, integration-overview.adoc, spotdev-portal.adoc, auth-overview.adoc, visual-embed-sdk.adoc, custom-actions.adoc, customization-rebranding.adoc, rest-api.adoc, runtime-filters.adoc, rest-api-get-started.adoc
...
[IMPORTANT]
====
* When a Model has a column alias defined, the runtime filter column must be defined as the underlying base column name.
...
https://developers.thoughtspot.com/docs/runtime-filters#_maximum_filter_count[Runtime filter limit, window=_blank] for details.
====
