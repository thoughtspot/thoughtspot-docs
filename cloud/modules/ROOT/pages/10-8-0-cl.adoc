...
Help and support features [.badge.badge-ga-relnotes]#GA#:: In this release we introduce a unified help and support experience in ThoughtSpot.
+
...
[#parameters-in]
Parameters in column names in charts and tables [.badge.badge-ga-relnotes]#GA#:: You can now add a parameter as a variable to the table header, column names, and axis names of a chart. Any references to the parameter in a Liveboard or Answer automatically update to show the current value of the parameter.
+
For more information, see xref:charts.adoc#parameters[Parameters in axis and column names of charts and tables].

[#blended-axes]
Blended axes in pivot table charts [.badge.badge-ga-relnotes]#GA#::
...
[#kpi-change]
KPI change analysis [.badge.badge-ga-relnotes]#GA#::
...
[#new-languages]
New languages support [.badge.badge-ga-relnotes]#GA#::
...
[#bilingual-keywords]
Bilingual keywords for Japanese [.badge.badge-ga-relnotes]#GA#::
...
+
For more information, see xref:liveboard-download.adoc[Download a Liveboard as a PDF].
...
[#iterative-change]
Iterative change analysis enhancements [.badge.badge-ga-relnotes]#GA#::
...
[#migrate-spotter]
Migrate Spotter feedback using TML [.badge.badge-ga-relnotes]#GA#::
...
+
For more information, see xref:spotter-migrate-legacy.adoc[Migrate Spotter feedback using TML] and xref:tml-coaching.adoc[TML for feedback].
...
// PM: Samridh
[#model-knowledge]
Model knowledge cards [.badge.badge-ga-relnotes]#GA#:: Model knowledge cards are now available to all users and on by default. With knowledge cards, you can now see more detail about tables and columns before you add them to a Model. To view the knowledge card, click the knowledge card button, and then click the table or column. For more information, see xref:models.adoc#knowledge-cards[Knowledge cards].


// Mary. jira: SCAL-224198. docs jira: SCAL-225298
[#join-cardinality]
Join cardinality change for global joins [.badge.badge-ga-relnotes]#GA#::
...
[#natural-language]
Natural Language Search queries in Query Stats Worksheet [.badge.badge-ga-relnotes]#GA#::
ThoughtSpot now distinguishes between regular query consumption and Spotter queries within the Query Stats Worksheet.
+
For more information, see xref:system-model.adoc[System Worksheets, tables, and views].

// Naomi. jira: SCAL-226981. docs jira: SCAL-243429
[#oauth-for]
OAuth for Denodo using Proof Key for Code Exchange (PKCE) [.badge.badge-ga-relnotes]#GA#:: We now support OAuth with PKCE for Denodo. For more information, see
...
[#chart-type]
Chart type displayed in SQL [.badge.badge-ga-relnotes]#GA#::
...
[#bridge-support]
Bridge support for Oracle, SAP HANA, and SQL Server [.badge.badge-ga-relnotes]#GA#::
...
[#support-cookieless]
Support cookieless authentication flow for OAuth [.badge.badge-ga-relnotes]#GA#::
...
[#org-administrator]
Org administrator capabilities [.badge.badge-ga-relnotes]#GA#::
...
[#security-update]
Security update to end-user license agreement [.badge.badge-ga-relnotes]#GA#::
...
Multifactor authentication for customers using local authentication [.badge.badge-ga-relnotes]#GA#::
...
[#updated-early]
Updated Early Access features page for administrators [.badge.badge-ga-relnotes]#GA#::
