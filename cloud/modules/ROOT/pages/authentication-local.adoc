...
Navigate to the Admin Console by selecting the *Admin settings* from the user icon in the right corner.
...
Choose *Enable* or *Disable*, and select *Save*.
...
>
> * We highly recommend that you register for the free Authentication course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/admin-authentication/2499270[Local Authentication^] lesson.
