...
:jira: SCAL-174136, SCAL-201297, SCAL-205044, SCAL-213222, SCAL-228182, SCAL-280829
...
. Sign in to Collibra and navigate to the *Admin* section.
. Click *API tokens*.
...
. Navigate to *Data workspace* > *Data catalog*.
...
If the connection to Collibra or the scheduled sync fails for any reason, a *View logs* field appears next to the *Last sync* status on the Collibra tile in *Data catalog*. You can view and download the log file to better understand why the connection failed.
...
ThoughtSpot does not support catalog integration on Analyst Studio datasets.
