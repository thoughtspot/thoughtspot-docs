...
:jira: SCAL-170548, SCAL-251099, SCAL-262244, SCAL-234771, SCAL-304709
...
For OAuth authentication, do the following:
 ...
 .. Enter Billing Project id, Additional Projects (optional), OAuth Client ID, and OAuth Client Secret.
+
[.bordered]
 ...
 ** Enter Billing Project id, Additional Projects (optional), and Service account.
+
[.bordered]
...
Once the connection is added, you can search your BigQuery database right away by selecting *Search now*.
