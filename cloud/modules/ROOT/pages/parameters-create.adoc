...
+
Note that you may not be able to edit all fields, if the Parameter is in use in a formula in the Answer. For Parameters that are in use, you can only edit the following fields: *Name*, *Description*, and *Default value*. To edit other fields, you must first remove the formula from the search.
