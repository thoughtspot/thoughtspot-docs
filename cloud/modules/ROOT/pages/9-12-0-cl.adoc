...
[#error-message]
Error message improvements [.badge.badge-ga-relnotes]#GA#:: We have improved the error messages for CSV upload and custom calendar.
[#filters-available]
Filters available for Liveboards with hidden columns included in a visualization [.badge.badge-ga-relnotes]#GA#::
...
[#redshift-aws]
Redshift AWS IDC OAuth [.badge.badge-ga-relnotes]#GA#:: We now support Redshift connections using AWS IDC OAuth. For more information, see
