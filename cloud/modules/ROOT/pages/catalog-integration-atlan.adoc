...
:jira: SCAL-158463, SCAL-169279, SCAL-205044, SCAL-213222, SCAL-280829
...
. Sign in to Atlan and navigate to the *Admin* section.
. Click *API tokens*.
...
. Navigate to *Data workspace* > *Data catalog* under *Governance*.
