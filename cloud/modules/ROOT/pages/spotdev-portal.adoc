...
+
NOTE: If the **REST API Playground and SDK** [.badge.badge-beta]#Beta# feature is enabled on your instance, the *Guide* menu will appear as a sub-menu option under *REST API* and **Visual Embed SDK**.
Playground::
...
+
NOTE: If the **REST API Playground and SDK** [.badge.badge-beta]#Beta# feature is enabled on your instance, the **Develop** tab displays the *REST Playground v1* and *REST Playground v2* menu options. For more information about these menu options, see link:https://developers.thoughtspot.com/docs/?pageid=rest-apis[ThoughtSpot REST APIs, window=_blank].
