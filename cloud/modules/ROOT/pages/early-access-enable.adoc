...
Data model instructions:: You can teach Spotter core concepts, default behaviors, and specific data nuances by adding data model instructions directly to a data model. For more information, see xref:data-model-instructions.adoc[]. To enable this feature, navigate to *Admin > ThoughtSpot AI* and set Data Model instructions to *Enabled*.
