...
. Click the status slider to set the feature to image:icon-slider-toggle-enable-20px.png[enable toggle] *Enabled*.
. Click *Save*.
...
. Click the status slider to set the feature to image:icon-slider-toggle-disable-20px.png[disable toggle] *Disabled*.
. Click *Save*.
