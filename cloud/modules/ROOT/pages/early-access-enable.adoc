...
Configure enhanced KPI options, including size adjustments, granular controls for comparison dates and values, and more.

XLSX/CSV download of Liveboards::
For more information, see: xref:liveboard-download-pdf[XLSX/CSV download of Liveboards].

=== ThoughtSpot AI page

The following features can only be enabled by navigating to Admin > All orgs > ThoughtSpot AI.

Spotter Agent:: You can ask questions directly about your data, ask for suggestions on the next direction you should take in your analysis, and ask Spotter how it calculated fields like formulas. To enable this feature, navigate to *Admin > ThoughtSpot AI* and select Spotter Agent for *Spotter answer experience*.
