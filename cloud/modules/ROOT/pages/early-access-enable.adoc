...
Improved chart recommendations. See xref:charts.adoc#chart-recs[Chart recommendations].
...
Natural language instructions:: You can teach Spotter core concepts, default behaviors, and specific data nuances by adding natural language instructions directly to a data model. For more information, see xref:natural-language-instructions.adoc[]. To enable this feature, navigate to *Admin > ThoughtSpot AI* and set Natural Language instructions to *Enabled*.
