...
Data model instructions:: You can now teach Spotter core concepts, default behaviors, and specific data nuances by adding natural language instructions directly to a data model. For more information, see xref:data-model-instructions.adoc[]. To enable this feature, navigate to *Admin > ThoughtSpot AI* and set Data model instructions to *Enabled*.
