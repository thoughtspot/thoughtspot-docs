...
Spotter Agent:: You can now ask questions directly about your data, ask for suggestions on the next direction you should take in your analysis, and ask Spotter how it calculated fields like formulas. For more information, see xref:spotter-agent.adoc[]. To enable this feature, navigate to *Admin > ThoughtSpot AI* and edit the toggle for *Spotter answer experience*.
