...
* *Create a group* by selecting the *+ Create group* button
...
.Import and export users, groups, and roles using TML
****
...
. Make sure you are in the Primary Org.
. Navigate to *Admin settings* > *All orgs* > *Groups*.
. Click *Import group*.
