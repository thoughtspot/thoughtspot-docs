...
:page-last_updated: 11/20/2023
:linkattrs:
:experimental:

:page-aliases:
:connection: Google Cloud SQL for MySQL
:description: Passthrough functions allow you to send SQL expressions directly to Google Cloud SQL for MySQL without being interpreted by ThoughtSpot.
