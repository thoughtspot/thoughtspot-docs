...
:description: Learn about how insights can be generated for top metrics on each Liveboard, so that you can get quick insights on how your top metrics changed.
    :jira: SCAL-178264, SCAL-180913, SCAL-209562 GA, SCAL-271369

[.lead]
AI Highlights instantly extracts key metric changes from your Liveboard so you can focus on the data that matters most.
...
- You can customize and save attribute columns at the KPI level, so the creator of the Answer or an admin can apply the attributes for all users.
