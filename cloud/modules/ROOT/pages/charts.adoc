...
<source src="https://docs.thoughtspot.com/cloud/10.10.0.cl/_images/dyn-params.mp4" type="video/mp4">
</video>
+++
...
<div class="border">
<video autoplay loop muted controls width="100%" controlsList="nodownload">
<source src="https://docs.thoughtspot.com/cloud/10.11.0.cl/_images/dyn-params2.mp4" type="video/mp4">
</video>
</div>
+++
****
