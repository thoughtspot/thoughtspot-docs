...
For charts generated automatically in Spotter conversations from code execution, web data, and SQL queries, see xref:charts-agentic.adoc[Charts for agentic answers].
