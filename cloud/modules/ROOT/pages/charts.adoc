...
[#parameters]
== Parameters in axis, column names and titles, and descriptions of charts and tables

You can add a parameter name directly in chart components like axis labels, column names and the title of an Answer. When you select a different parameter value in the Answer, the data and contextual information (axis names, column names, and legends) change to reflect the parameter selected. Any place a parameter is used in Liveboards or Answers automatically displays the current information associated with the selected parameter value.
...
=== Adding parameters to an Answer title or description

To add a parameter to an Answer title or description, do the following:

. While viewing your Answer in either chart or table view, click the title or description field.
. Enter an ampersand (@) to display the list of parameters available to you in your Answer.
. Click the parameter you want to use.
