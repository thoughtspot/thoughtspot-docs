...
[#control-default]
== Control default and available chart types
...
. While viewing your Answer in chart view, select the axis icon image:chart-axis.png[chart configuration icon,25] in the right pane.
. Add your parameters by doing the following:
* In the right pane, select the X or Y-axis.
...
. While viewing your Answer in either chart or table view, select the column configuration icon image:chart-col.png[chart configuration icon,25] in the right pane.
