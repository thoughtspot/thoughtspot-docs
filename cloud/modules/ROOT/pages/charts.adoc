...
When you search, ThoughtSpot can automatically suggest a chart type based on your search query. This works in the following ways:

* *New queries*: When you submit a query for the first time, ThoughtSpot will analyze the data and automatically select the most appropriate chart.
