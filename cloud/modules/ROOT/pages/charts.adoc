...
[#chart-recs]
== Improved chart recommendations [.badge.badge-early-access]#Early Access#
...
****
Improved chart recommendations is an Early Access feature and is disabled by default. To enable it, contact your ThoughtSpot administrator. For more about Early Access features, see xref:release-lifecycle.adoc#early-access[ThoughtSpot Cloud release life cycle].
****
