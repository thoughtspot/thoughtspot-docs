...
[#parameters]
== Dynamic parameters in charts [.badge.badge-early-access]#Early Access#
...
+++
<div class="border">
<script src="https://fast.wistia.com/player.js" async></script><script src="https://fast.wistia.com/embed/p7r79z526e.js" async type="module"></script><style>wistia-player[media-id='p7r79z526e']:not(:defined) { background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/p7r79z526e/swatch'); display: block; filter: blur(5px); padding-top:75.94%; }</style> <wistia-player media-id="p7r79z526e" aspect="1.316872427983539"></wistia-player>
</video>
</div>
+++
...
==== Using a parameter of a chart in the title or description of the Answer containing the chart
