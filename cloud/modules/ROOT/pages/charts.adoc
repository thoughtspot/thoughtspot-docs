...
[#chart-recs]
== Improved chart recommendations [.badge.badge-beta]#Beta#
...
****
Improved chart recommendations is a Beta feature and is disabled by default. To enable it, contact {support-url}. For more about Beta features, see xref:release-lifecycle.adoc#beta[ThoughtSpot Cloud release life cycle].
****
