...
[#dr-limitations]
=== Limitations
* Cross-region disaster recovery is available for ThoughtSpot Cloud SaaS only.
* Analyst Studio does not currently have cross-region disaster recovery support.
