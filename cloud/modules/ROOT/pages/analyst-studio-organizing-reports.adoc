...
>
> * We highly recommend that you register for the free Getting Oriented to Analyst Studio course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/getting-oriented-to-analyst-studio/2122703[Organizing Content in Collections^] lesson.
