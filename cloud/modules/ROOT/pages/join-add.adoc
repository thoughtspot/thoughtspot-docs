...
==== Change join cardinality [.badge.badge-early-access]#Early Access#
...
NOTE: Currently, views and Answers built on top of a table will be in an error state if you change the cardinality of a join in the underlying table.
