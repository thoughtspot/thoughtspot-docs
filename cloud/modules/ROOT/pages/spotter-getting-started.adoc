...
If Spotter provides a correct answer, click the thumbs up icon next to "*Is this useful?*" at the bottom of the Answer. After that, you can review and save the underlying business terms and search query tokens so Spotter remembers your choices in the future for similar questions.

If Spotter provides an incorrect answer, click the thumbs down icon. If you are using Spotter Agent, you can give further details on what the Answer got wrong. At that point, you can edit the underlying question, save, and then review the business terms and search query tokens of the Answer.
