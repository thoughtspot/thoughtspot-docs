...
.tooltip:hover .info2 {visibility:visible;}
.tooltip:hover .info3 {visibility:visible;}
.tooltip:hover .info4 {visibility:visible;}
...
<div id="container-tour">
  ...
  <div class="tooltip" id="eleventh">
    ...
    <div class="info2">
      ...
      <div class="tooltip" id="thirteenth">
    <div class="info">
      ...
      <div class="arrow"></div>
        ...
        <div class="tooltip" id="fourteenth">
    <div class="info3">
      ...
      <div class="arrow"></div>
          ...
          <div class="tooltip" id="fifteenth">
    <div class="info4">
      ...
      <div class="arrow"></div>
            ...
            <div class="tooltip" id="sixteenth">
    <div class="info4">
      ...
      <div class="arrow"></div>
              ...
              <div class="tooltip" id="seventeenth">
    <div class="info3">
