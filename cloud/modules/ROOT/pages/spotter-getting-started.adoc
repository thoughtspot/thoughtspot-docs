...
[#learnability]
=== Coach Spotter within a conversation [.badge.badge-beta]#Beta#
...
Admin users can decide which LLM to use to enable all ThoughtSpot AI features. By default, ThoughtSpot uses Azure OpenAI.
