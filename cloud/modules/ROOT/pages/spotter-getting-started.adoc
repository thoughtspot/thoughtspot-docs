...
== Using Spotter to do a search

To search with Spotter, do the following:

. (Optional) If searching from the ThoughtSpot home page, you can select a different available data source before you ask your question. ThoughtSpot generates sample questions for each data source. If you want to use any of them, simply click one.
+
[.bordered]
...
When Spotter answers your questions, it surfaces the search query information in the form of the Answer title and the search tokens used to construct the answer. When you ask a follow-up question, Spotter highlights the changes it made in search tokens to answer your question. You can also hover over formulas to see how they’re calculated, and edit them within Spotter.
...
To edit an AI-generated Answer in Spotter, click the *Edit* button above the Spotter search box. The _Edit Answer_ window opens.
...
|4
.^|Save
.^|Save your conversation so that you can review it and continue it later.
