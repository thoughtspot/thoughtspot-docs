...
|8
.<|Correct
.<|Notify your team that Spotter's answer is useful. Your feedback is recorded in the Spotter Conversations Liveboard. For more information, see xref:learnability[].

|9
.<|Incorrect
.<|Notify your team that Spotter's answer in not useful. Your feedback is recorded in the Spotter Conversations Liveboard. For more information, see xref:learnability[].
...
|19
.<|Add to Coaching
.<|Add reference questions and business terms directly from your chat, so Spotter remembers them next time.
...
You can give feedback on a Spotter answer without interrupting your conversation.
...
To save a term, you must *Approve* or *Reject* it. After you approve or reject at least one business term, you can click *Submit* to save and share your feedback with Spotter. Your feedback is also viewable in the Spotter Conversations Liveboard, which is visible to your ThoughtSpot administrator.
