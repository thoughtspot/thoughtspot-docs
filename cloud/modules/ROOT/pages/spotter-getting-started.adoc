...
If Spotter provides a correct answer, click the checkmark icon image:spotter-approve-mapping-grey.png[] next to "*Did Spotter interpret your question correctly?*" at the bottom of the Answer. After that, you can review and save the underlying business terms and search query tokens so Spotter remembers your choices in the future for similar questions.

If Spotter provides an incorrect answer, click the *X* icon image:spotter-reject-mapping-grey.png[]. At that point, you can edit the underlying question, save, and then review the business terms and search query tokens of the Answer.

To save a term, you must *Approve* or *Reject* it. After you approve or reject at least one business term, you can click *Submit* to save and share your feedback with Spotter. Your feedback is also provided in the Spotter Conversations Liveboard, which is visible to your ThoughtSpot administrator.
