...
In this article you'll learn the basics of how to use Spotter, including where you can use Spotter, and the basics of searching with Spotter. You'll also gain an understanding of how Spotter formulates an answer.

== Where you can use Spotter

You can access the Spotter conversational search experience in the following areas of ThoughtSpot:

* Asking a question in the Spotter question box at the top of the ThoughtSpot home page.
+
[.bordered]
image::spotter-insights-bar.png[]
* Clicking the *Spotter* button when hovering on any visualization pinned to a Liveboard.
+
[.bordered]
...
To ask a question of Spotter, do the following:
...
+
You can do the following things with Spotter's answer:
...
+
Spotter treats successive questions in a conversation as a follow-up.
+
...
For complete details on the features of the Spotter experience, see xref:spotter-user-interface[].
...
To edit an AI-generated Answer in Spotter, click the *Edit* button above the Spotter question box. The _Edit Answer_ window opens.
...
When you finish editing, click *Done editing* or *Discard changes*.
...
|1
.<|Data source
.<a|Shows the dataset used for your conversation. You can change the data source from here if you want to start conversations on a different data source.
...
|16
.<|Spotter's interpretation of the question
...
|17
.<|Changes based on the latest question
...
|19
.<|Interactive chart
.<|You can interact with the chart, similar charts in other parts ThoughtSpot product.

Only the last answer in the conversation supports interactive charts.
|===
