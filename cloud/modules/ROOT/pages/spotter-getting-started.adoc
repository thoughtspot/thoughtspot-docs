...
|18
.<|Interactive chart
.<|You can interact with the chart, similar charts in other parts of ThoughtSpot.
...
To save a term, you must select *Accept* or *Reject* it. After you approve or reject at least one business term, you can click *Submit* to save and share your feedback with Spotter. Your feedback is also provided in the Spotter Conversations Liveboard, which is visible to your ThoughtSpot administrator.
