...
NOTE: Mode connector is in Early Access and off by default. To enable it, contact {support-url}.
...
+
Note that you will use the API token as the username and the secret as the password.
[.bordered]
...
> * xref:connections-mode-deactivate.adoc[]
