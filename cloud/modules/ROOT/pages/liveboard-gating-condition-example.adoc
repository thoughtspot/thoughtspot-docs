...
:jira: SCAL-241008, SCAL-282320, SCAL-340559
...
When you delete a column or are unable to access the entity (formula/column) which was part of an existing gating condition, this error is displayed:

* "Could not find the following objects of type LOGICAL_COLUMN".

Workaround:

. Pause the schedule.
. Delete the gating condition.
. Add the gating condition again.
