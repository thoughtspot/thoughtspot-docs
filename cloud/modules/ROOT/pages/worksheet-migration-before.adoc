...
TIP: If you want to opt out of the automatic conversion, you can convert individual Worksheets to Models. For more information, see xref:worksheet-migration-single.adoc[Converting a single Worksheet to a Model].
