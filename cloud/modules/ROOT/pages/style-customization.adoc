...
To enable style customization, you must add `?customBrandingEnabled=true` to your application URL, as shown in the following examples:
+
[source]
----
...
----
+
NOTE: You can make this permanent for all users of your cluster, without needing to add `customBrandingEnabled=true` to your application URL, by contacting {support-url}.
+
...
+
Your icon image should be a square, and the recommended size is 28px by 28px.
...
+
The recommended size is 250px by 50px.
The accepted file formats are jpg, jpeg, and png.
...
>
> * We highly recommend that you register for the free Customizing the ThoughtSpot UI course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com//customizing-the-thoughtspot-ui/2513657[App Style Customization^] lesson.
