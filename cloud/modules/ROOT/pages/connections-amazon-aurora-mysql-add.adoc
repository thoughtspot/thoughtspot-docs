...
:description: Learn how to add an Amazon Aurora MySQL connection.
...
+
[.bordered]
image::amazon-aurora-mysql-connectiondetails.png[Enter connection details]
+
Refer to the xref:connections-amazon-aurora-mysql-reference.adoc[{connection} connection reference] for more information on each of the specific attributes you must enter for your connection.
...
====
. Select tables and the columns from each table.
+
...
You can also xref:connections-amazon-aurora-mysql-delete.adoc[Delete an {connection} connection].
