...
:jira: SCAL-205044, SCAL-213222, SCAL-223848, SCAL-280829
...
* Username and password used to sign in to your Alation instance
* Instance URL
...
If the connection to Alation or the scheduled sync fails for any reason, a *View logs* field appears next to the *Last sync* status on the Alation tile in *Data catalog*. You can view and download the log file to better understand why the connection failed.
