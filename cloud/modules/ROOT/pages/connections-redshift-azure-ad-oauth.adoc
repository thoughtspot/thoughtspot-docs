...
:jira: SCAL-160062, SCAL-203353, SCAL-270983
...
. Sign in to Amazon Redshift with a superuser username and password using query editor v2 or any SQL client.
