...
:jira: SCAL-196890, SCAL-185652 (can manage version control privilege), SCAL-207739 (troubleshooting), SCAL-213208 (change to GA), SCAL-213195 (privilege update), SCAL-282872
...
* Administrator access to the cluster/Org or the *can set up version control* privilege
...
** Personal access token from Github (link:https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-personal-access-token-classic[Classic^] or link:https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-fine-grained-personal-access-token[fine-grained^])
...
... link:https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-personal-access-token-classic[Classic^]
... link:https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-fine-grained-personal-access-token[fine-grained^]
+
...
* Be in a group which is assigned the *Can toggle version control for objects* privilege.
...
This error occurs when a table or column is needed to display visualizations in the version of the Liveboard that is being previewed, but no longer exists in ThoughtSpot (the table / Model used for these visualizations have likely changed recently and removed the tables / columns needed).

[discrete]
==== Solution for column not found

. Navigate to the data tab and open the respective Model or table.
...
. Navigate to the data tab and open the connection where your table/Model belongs to.
...
>
> * We highly recommend that you register for the free Git Integration for Versioning course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/git-integration-for-versioning/2159236[Versioning with Git^] lesson.
