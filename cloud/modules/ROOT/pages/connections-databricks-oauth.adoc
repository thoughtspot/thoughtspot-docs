...
. After you register your application, make a note of the *Application (client) ID* in the Essentials section of the app’s overview page. Also, make a note of the OAuth 2.0 authorization and administrative information token endpoints. You must use them later in the workflow, when configuring the {connection} connection in ThoughtSpot.
+
...
The JDBC connection URL, which uses the access token from AAD, must have the following format:
[source]
----
