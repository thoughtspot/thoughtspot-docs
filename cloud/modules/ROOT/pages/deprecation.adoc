...
The 10.4.0.cl release of ThoughtSpot Cloud, targeted for November 2024 (GA), removes the following features from the *Data workspace*:
...
The 10.4.0.cl release of ThoughtSpot Cloud, targeted for November 2024 (GA), deprecates the following feature:

=== Create new worksheet in the Data workspace
