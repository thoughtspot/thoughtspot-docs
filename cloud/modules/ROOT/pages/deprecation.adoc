...
The 10.1.0.cl release of ThoughtSpot Cloud, targeted for July 2024 (GA), will deprecate the following feature. ThoughtSpot will drop support for this feature in a later release.

Classic experience for Liveboards, Answers, and SpotIQ::
Beginning in the 10.1.0.cl release, you will still be able to use the Classic experience for Liveboards, Answers, and SpotIQ, but ThoughtSpot will remove them in a subsequent release.
