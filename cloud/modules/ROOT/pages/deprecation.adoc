...
- When searching using the *Find existing Liveboards and Answers* search image:mag-glass-icon.png[object search button, width='30px'] at the upper-right in ThoughtSpot, the right-hand side panel in the search results page is now hidden. If you want this side panel to be visible, contact {support-url}.
