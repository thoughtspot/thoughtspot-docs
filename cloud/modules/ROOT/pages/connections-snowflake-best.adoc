...
You can choose to make a connection to access _all_ your Snowflake databases, or to one specific database. To connect to all Snowflake databases, leave the *Database* field empty. If you only want to access one {connection} database, you can specify the database in the *Database* text box in *Specify connection details* during setup.
