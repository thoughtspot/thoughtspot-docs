...
ThoughtSpot supports SpotIQ change analysis for column, bar, and line charts. To perform this analysis, follow these steps:

. On a column, bar, or line chart, hold down the command key (Mac OS) or control key (Linux or Windows).
