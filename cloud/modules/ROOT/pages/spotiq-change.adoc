...
. Right-click either of the columns or data points to see the dropdown menu, and select *SpotIQ analyze*.
+
...
. Right-click a value to see the dropdown menu, and select *Run change analysis*.
