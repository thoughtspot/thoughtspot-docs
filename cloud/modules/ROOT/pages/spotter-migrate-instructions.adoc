...
- **Memory** (Liveboard and conversation-generated): xref:spotter-migrate-memory.adoc[Migrate memory]. REST API v2, available since 26.8.0.cl. Personal memory is not included.
- **Legacy memory sources** (reference questions, business terms): xref:spotter-migrate-legacy.adoc[Migrate legacy memory sources]. TML export and import.
- **Instructions** (Spotter and data model): this page. REST API v2.
