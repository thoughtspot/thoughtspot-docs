...
+
When a user is deleted, all of their objects are transferred to the *tsadmin* user by default. There is a rest API endpoint that allows you to transfer all (or individual) objects if you want to move a user's content to another user before or after deleting them.
...
>
> * We highly recommend that you register for the free User & Group Management course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/user-group-management/2499229[Local User Management^] lesson.
