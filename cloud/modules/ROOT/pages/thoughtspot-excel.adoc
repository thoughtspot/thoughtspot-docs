...
[.bordered]
image::excel-plugin.png[A Microsoft excel sheet displaying the ThoughtSpot plugin in the top bar]
...
- Currently available for Windows devices and SaaS versions of Microsoft Excel.
