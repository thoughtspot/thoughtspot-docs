...
. To download the ThoughtSpot plugin, either download from link:https://appsource.microsoft.com/en-us/product/office/wa200009057[this site] or open Excel and select *Home* > *Add-ins* and search for ThoughtSpot, which will then show *ThoughtSpot for Excel* in the list.
+
[.bordered]
image::add-ins.png[Add-ins]
