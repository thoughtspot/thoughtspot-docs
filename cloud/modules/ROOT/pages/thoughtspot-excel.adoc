...
:page-last_updated: 12th June 2025
:linkattrs:
:experimental:
:author: rani
...
:jira: SCAL-224481, SCAL-258586, SCAL-264258, SCAL-277629, SCAL-278385, SCAL-292453
...
- Currently available for Windows devices and SaaS versions of MS Excel (Microsoft 365).
...
. To download the ThoughtSpot plugin, either download from link:https://appsource.microsoft.com/en-us/product/office/wa200009057[this site] or open Excel and select *Home* > *Add-ins* and search for ThoughtSpot, which will then show *ThoughtSpot Analytics* in the list.
+
[.bordered]
image::add-ins.png[Add-ins in Excel.]
. Click *Add* to download.
+
[.bordered]
image::thoughtspot-addin.png[Select the ThoughtSpot add-in.]
+
...
+
[.bordered]
image::select-thoughtspot-data.png[Sign in and connect to your instance.]
. Choose the ThoughtSpot Model you want to work with, from *Data* > *Sources* > *Choose sources*.
+
[.bordered]
image::select-thoughtspot-columns.png[Click on Choose sources for selecting the relevant Model]
+
...
+
[.bordered]
image::thoughtspot-county-filter.png[Add filter to the data]
+
...
+
[.bordered]
image::data-connected-excel.png[Click on Choose sources for selecting the relevant Model]
+
Your selected data is now in Excel.

At any point, you can select Update data to update the data pulled from ThoughtSpot to your Excel sheet.

[.bordered]
image::update-data-excel.png[Update data.]

//== Limitations

//Note that the Excel plug-in can only be accessed in the browser version, not in the desktop version.