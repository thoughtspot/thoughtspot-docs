...
:jira: SCAL-224481, SCAL-258586, SCAL-278385
...
. Open Excel. To download the plug-in, Select *Home* > *Add-ins*, which brings up the Office Add-ins window, and search for ThoughtSpot, which will then show *ThoughtSpot Analytics* in the list.
+
[.bordered]
image::add-ins.png[]
...
+
[.bordered]
image::thoughtspot-addin.png[Click Add to download]
+
...
+
[.bordered]
image::select-thoughtspot-columns.png[Click on Choose sources for selecting the relevant worksheet]
+
...
+
[.bordered]
image::data-connected-excel.png[Click on Choose sources for selecting the relevant worksheet]
+
