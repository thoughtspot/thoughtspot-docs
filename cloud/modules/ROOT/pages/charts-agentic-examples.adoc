...
* xref:charts-agentic-supported-sources.adoc[Code execution] as a data source
* Automatic detection of time-series data
* Confidence interval visualization
* xref:charts-agentic-progressive.adoc[Progressive charting] (base chart first, then styled)
...
* xref:charts-agentic-supported-sources.adoc[MCP] as a data source
...
* xref:charts-agentic-nl-editing.adoc[Natural-language chart editing]
