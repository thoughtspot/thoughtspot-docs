...
- The "Optimize for Spotter" guidance message appears when there are additional steps recommended for Spotter Optimization. In this case, refer to xref:worksheet-readiness.adoc[Worksheet readiness for Sage] for guidelines on how to prepare your Worksheet to improve accuracy.
+
[.bordered]
