...
If it is not possible to optimize the Worksheet or Model, or there are additional recommended steps before optimizing, one of the following messages appears:
