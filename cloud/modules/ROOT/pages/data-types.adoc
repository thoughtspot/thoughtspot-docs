...
After loading the data, ThoughtSpot sets the geoconfig data under autoselect. You can also designate it as a geographical data type when you xref:data-modeling-edit.adoc#[edit the system-wide data model].
