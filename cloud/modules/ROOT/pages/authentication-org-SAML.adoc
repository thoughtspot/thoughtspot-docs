= Managing per Org authentication with SAML
:page-last_updated: 8/7/2024
:linkattrs:
:experimental:
...
====
.Local authentication at the Org level
****
...
With SAML SSO, users can authenticate to the SAML identity provider (IDP) to access the ThoughtSpot application, or the embedded ThoughtSpot content in an external web application.
