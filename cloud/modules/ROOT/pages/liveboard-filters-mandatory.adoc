...
. In the top menu bar, select *Add* > *Add filter*.
...
. Select *Filter options* from the filters modal side menu.
+
image::select-mandatory.png[Select Mandatory filter]
. Select the checkbox under *Mandatory filter* . An *** will be populated next to the filter display name at the top of the modal.
. Select *Apply*.
...
>
> * We highly recommend that you register for the free Introduction to Liveboards course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/introduction-to-liveboards/1000071[Selecting Mandatory Filters on Liveboards^] lesson.
