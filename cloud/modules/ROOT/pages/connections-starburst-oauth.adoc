...
:jira: SCAL-160062, SCAL-199788, SCAL-270983
...
For OAuth, we recommend checking the {connection} link:https://docs.starburst.io/latest/security/authentication-types.html[documentation^] to confirm any IDP support and their details. This article documents only the most frequently set-up IDP.
