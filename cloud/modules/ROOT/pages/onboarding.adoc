...
>
> * We highly recommend that you register for the free User & Group Management course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/user-group-management/2499217[Understanding Users & Groups^] lesson.
