...
:jira: SCAL-157885, SCAL-157886, SCAL-157887, SCAL-157890, SCAL-157889, SCAL-182271, SCAL-182987, SCAL-186187, SCAL-208784
...
. The *Generated Tables and Worksheetss* page appears. ThoughtSpot generates several tables and Worksheets from your dbt models.
+
image::dbt-integration-worksheets.png[dbt integration step 4]
+
To inspect the table, Worksheet, details, select any of the table or Worksheet names. You can view the joins created between the related tables in the Worksheets from the *Joins* tab for the Worksheet.
+
