...
. If you receive the following error, you may need to switch to an older version of dbt. ThoughtSpot supports dbt for versions 1.4 and earlier. Navigate to dbt and go to *Deploy > Environments > Environment_Name > Settings*. Click the dbt Version menu and scroll down to select 1.4.
+
----
