...
|Can download visuals|Allows users to download visual downloads (PDFs of the Liveboard or PNG files).

|Can download detailed data|Allows users to download data exports (XLSX, CSV, or PDFs of table Answers).
