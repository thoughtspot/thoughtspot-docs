...
To view this Liveboard, navigate to *Admin settings* by going to your profile, and selecting *Admin settings*.
Select *Performance tracking* from the side navigation bar.
...
>
> * We highly recommend that you register for the free Monitoring Performance course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/admin-monitoring-performance/2499316[Performance Tracking^] lesson.
