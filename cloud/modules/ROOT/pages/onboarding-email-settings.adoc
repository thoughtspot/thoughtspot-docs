...
. Navigate to the Admin Console by selecting the *Admin settings* from your profile.
. Select *Onboarding*.
+
...
The default is link:https://docs.thoughtspot.com[https://docs.thoughtspot.com^], the documentation for ThoughtSpot's software product.
