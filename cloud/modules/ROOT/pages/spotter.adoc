...
:description:
:jira: SCAL-228500, SCAL-264258, SCAL-270868
...
NOTE: Spotter is not supported on Views.
...
. Navigate to the Admin page, by selecting *Admin settings* from your profile menu.
...
. Navigate to the Data workspace, by selecting the *Data workspace* tab.
