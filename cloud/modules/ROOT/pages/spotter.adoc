...
Introducing Spotter, our new AI-powered, unified conversational search experience. This feature replaces the previous Sage search experience. When enabled, you can enter the Spotter interface from the Spotter question box on the home page, or by clicking *Spotter* on a visualization pinned to a Liveboard.
...
To use Spotter, your ThoughtSpot administrator must first enable Spotter on your instance. For more information, see xref:spotter-deploying.adoc[].
