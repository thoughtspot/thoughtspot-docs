...
:object: connections
:jira: SCAL-148626, SCAL-202207, SCAL-132544, SCAL-202209, SCAL-210485, SCAL-271538
...
See xref:tml.adoc#limitations[Limitations of working with TML files] for more information about actions you can't perform using TML.
...
[#authentication_type]
authentication_type:: The type of authentication used to connect to the connection. Note that authentication type is usually SERVICE_ACCOUNT or OAUTH, although certain connections also support KEY_PAIR.
+
[NOTE]
When importing TML for connections that use OAUTH, it is essential to properly fill in the client secrets during the import process. If the client secrets are not provided or are incorrect, the connections will fail during authorization, as the necessary credentials for OAUTH authentication will be missing or invalid. This is a critical step to ensure successful connection and authorization after the TML import
