...
. In the *Unparameterize* window, review the fields that are currently parameterized. By default, all fields are selected. Only fields that are currently parameterized are shown.
+
