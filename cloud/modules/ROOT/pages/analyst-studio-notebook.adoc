...
:experimental:
:jira: SCAL-232953, SCAL-256714, SCAL-256777, SCAL-256717, SCAL-263342, SCAL-265055, SCAL-275619
...
The Python Cleanslate environment is a new execution option in Mode Analytics, available alongside Python 3 and Python Edge. It starts without any pre-installed third-party packages, giving users full control over their environment setup. This is ideal for analysts who want a minimal, dependency-free starting point for custom workflows.
