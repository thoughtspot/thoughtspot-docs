...
[.faq]
--
Can you visualize a Notebook-generated visualization with {product}'s native chart editor?::
...
How to pass parameters into the Notebook?::
...
Can I use dbt Metrics in Notebooks?::
...
When do queries in the Notebook start to execute after a report run?::
...
Do you have a tutorial where I can learn Python for business analysis using real-world data?::
