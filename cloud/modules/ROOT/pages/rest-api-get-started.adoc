...
* If trusted authentication is enabled on your instance, you must obtain administrative data (an authentication token) and include it in your subsequent login requests.
