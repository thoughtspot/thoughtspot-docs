...
* Your client application domain is added as a https://developers.thoughtspot.com/docs/?pageid=security-settings[Cross-Origin Resource Sharing (CORS) host,window=_blank] in the ThoughtSpot Developer portal.
+
...
To know if an API uses `multipart/form-data` content-type, see the https://developers.thoughtspot.com/docs/?pageid=rest-api-reference[corresponding API description page,window=_blank].
...
For more information about the REST API request URL, parameters, headers, and sample response, see https://developers.thoughtspot.com/docs/?pageid=rest-api-reference[REST API reference,window=_blank].
