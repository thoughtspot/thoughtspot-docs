...
:jira: SCAL-293536, SCAL-303390, SCAL-320863, SCAL-331175
...
* Control which data models or tools the agent reaches for in cross data model search.
...
* *xref:spotter-cross-model.adoc[Cross data model search] is reaching for the wrong data model or tool.* Use instructions to declare which models or tools to prefer in which contexts.
...
Tool and data model preferences in cross data model search:: Which sources should the agent reach for first?
...
7. Tool and data model preferences in cross data model search
