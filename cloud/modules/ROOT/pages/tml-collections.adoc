...
Note that before the Collection TML file, you could only remap Collections by downloading the `collection.yaml` file, editing it, and re-uploading it. Currently, you can remap columns and change data types from the table TML file, or edit the Collection TML file directly to change its properties, such as account name and password.
...
To export a Collection TML file, you can navigate to the *Collection* tab, and check the box next to the Collection(s) you want to export. Click *Export* to download the  `collection.tml` file. Note that you can export Collection TML files individually, or in bulk.
