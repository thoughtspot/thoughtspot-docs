...
****
The query_groups function is a parameter used in group_aggregate, first_value, and last_value functions. This returns a list of columns/attributes that have been included in the search. This allows for flexible inclusion and exclusion of grouping columns using the following syntax:
