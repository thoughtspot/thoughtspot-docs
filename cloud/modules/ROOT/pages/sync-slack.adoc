...
. Select the desired Answer from the *Answers* page or from the ThoughtSpot home page. You must have *Can manage sync* permissions and *view* access to an Answer to create a sync.
...
****
ThoughtSpot allows you to export a Liveboard as a PDF or a PNG image when creating a new sync pipeline. PDFs include the complete Liveboard. PNG images are of the first page of the Liveboard. Select *PDF* or *Image* to export a PDF or PNG image.
...
. Select the desired Liveboard from the *Liveboards* page or from the ThoughtSpot homepage. You must have *Can manage sync* permissions and *view* access to a Liveboard to create a sync.
...
. Navigate to your SQL view by selecting the *Data workspace* tab and searching from the Data workspace home page. Select the SQL view name.
