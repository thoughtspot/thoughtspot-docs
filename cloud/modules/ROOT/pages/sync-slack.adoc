...
. Select the desired Answer from the *Answers* tab or from the ThoughtSpot home page. You must have *Can manage sync* permissions and *view* access to an Answer to create a sync.
