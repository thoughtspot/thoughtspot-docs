...
:description: Passthrough functions allow you to send SQL expressions directly to Google Cloud SQL for PostgreSQL without being interpreted by ThoughtSpot.
:jira: SCAL-164805
