...
By default, this feature is only available for Answers and for visualizations within Liveboards. You can use HTML 5 in Liveboard titles and descriptions and Liveboard tab names.
...
* This feature is only available for Liveboard titles, descriptions, and tab names.
