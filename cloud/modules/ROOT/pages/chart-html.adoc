...
You can use HTML 5 in titles and descriptions for Liveboards, answers, and visualizations within Liveboards. For example, you can add a clickable link to a word or phrase in a description, or italicize part of an answer title. If you are using the xref:liveboard-experience-new.adoc[new Liveboard experience], you can also use HTML 5 in Liveboard titles and descriptions.
