= Custom charts
:page-last_updated: 27th Nov 2025
:linkattrs:
:experimental:
:author: Mark
...
- Use Muze Studio to create your own charts in ThoughtSpot. For more information, see xref:chart-create.adoc[Creating charts with Muze Studio].
...
. Navigate to *Admin settings* > *Chart customisation* under *Application settings*.
...
. In the *Update custom chart* window, make any changes necessary, then click *Update chart*.
...
+
. In the *Delete custom chart* warning message which appears, click *Delete*.
