...
>
> * We highly recommend that you register for the free Spotter Administration course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/spotter-administration/2381994[Configuring Spotter Settings^] lesson.
