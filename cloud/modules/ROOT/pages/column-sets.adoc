= Column sets
:page-last_updated: 11/5/25
:author: Mary
:linkattrs:
:page-aliases: /admin/custom-sets.adoc
:experimental:
:jira: SCAL-150356
...
. Navigate to the *Insights* > *Answers* for an existing answer, and *Create Answer* for a new search.
...
>
> * We highly recommend that you register for the free Introduction to Sets course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/introduction-to-sets/2009559[Creating Column Sets^] lesson.
