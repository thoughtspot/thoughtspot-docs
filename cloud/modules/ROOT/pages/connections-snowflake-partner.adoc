= ThoughtSpot in {connection} Marketplace
:page-last_updated: 06/29/26
:linkattrs:
:experimental:
:page-aliases: /admin/data-integrate/embrace/embrace-snowflake-partner.adoc
:description: With Snowflake Marketplace you get a free trial of ThoughtSpot that allows you to try out ThoughtSpot Connections to connect to Snowflake.
:connection: Snowflake
:jira: SCAL-185089, SCAL-185892, SCAL-184808, SCAL-321370



NOTE: Snowflake Partner Connect is being migrated to Snowflake Marketplace. For details, see link:https://docs.snowflake.com/en/collaboration/consumer-saas-trials[Trial SaaS applications from listings].

////
ThoughtSpot in {connection} Marketplace benefits:
...
* An ACCOUNTADMIN role, or a custom role iwth the privileges required to create objects such as database, warehouse, user, and role.

* A verified email address in Snowflake.
...
== Sign up for the ThoughtSpot free trial in {connection} Marketplace

To sign up for the free trial, reference the following: link:https://docs.snowflake.com/en/collaboration/consumer-saas-trials#start-a-saas-trial[Start a SaaS trial].
