...
You can avoid this extra work with the Model column property sync feature. With Model column property sync, you can select which columns in your Model automatically sync with the source table in your cloud data warehouse. To enable this feature, contact your administrator.
