...
+
Next, you are redirected to a ThoughtSpot free trial cluster which has an address beginning with *my1*, *my2*, or *my3*, and the Welcome to ThoughtSpot page appears if you're a new user.
+
