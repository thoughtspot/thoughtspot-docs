...
+
image::gbq-role-permissions-2.png[Permissions 11 and 12]
. Select *ADD*.
. Select *CREATE*.
...
To make your dataset available for your {connection} connection in ThoughtSpot, you must share it with your service account in {connection} in an owner role.
