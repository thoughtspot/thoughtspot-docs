...
Notice that you can explore any visualization, follow any KPI, or perform a number of other actions using the *more options menu* at the upper right corner of a visualization image:icon-more-10px.png[].
...
To present a Liveboard, click the More icon image:icon-more-10px.png[] at the upper right corner of the Liveboard, and select *Present*.
...
To download a Liveboard, click the More icon image:icon-more-10px.png[] at the upper right corner of the Liveboard, and select *Download as PDF*.
You can download the whole Liveboard, or just certain visualizations.

To export a scriptable file, click the More icon image:icon-more-10px.png[] at the upper right corner of the Liveboard, and select *Export TML*.
