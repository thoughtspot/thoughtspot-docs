...
:experimental:
:page-aliases: /analyst-studio/getting-started-with-mode.adoc, /analyst-studio/getting-started.adoc
:path: /articles/getting-started-with-mode
:product: Analyst Studio
:jira: SCAL-240435, SCAL-283812
...
Analyst Studio hosting location:
...
In certain cases, the {product} authentication token can expire independently of the primary ThoughtSpot session, resulting in a partial logout state. You can restore normal access by logging out of the ThoughtSpot instance and signing in again.
...
>
> * We highly recommend that you register for the free Getting Oriented to Analyst Studio course in ThoughtSpot University that covers the information in this article, and watch the following lessons:
> ** https://training.thoughtspot.com/getting-oriented-to-analyst-studio/2175710[Welcome to Analyst Studio^]
> ** https://training.thoughtspot.com/getting-oriented-to-analyst-studio/2283977[Transitioning from Mode to Analyst Studio (former Mode customers only)^]
