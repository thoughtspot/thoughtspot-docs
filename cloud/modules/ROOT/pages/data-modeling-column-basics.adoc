...
For example, the *DESCRIPTION* appears as a "tip" when you click the knowledge card button image:knowledge-card-button.png[width="30px"] (new Answer data panel), or hover over a column (classic Answer data panel). This helps you to understand where the data you are searching comes from.
...
. Select *Edit Model* in the upper-right corner of the screen.
+
[.bordered]
image::worksheet-edit.png[Edit Model]
