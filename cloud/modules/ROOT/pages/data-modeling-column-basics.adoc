...
For example, the *DESCRIPTION* appears as a "tip" when you click the knowledge card button image:knowledge-card-button.png[width="30px"]. This helps you to understand where the data you are searching comes from.
