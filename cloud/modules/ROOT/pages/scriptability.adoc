...
:description: Export and import Worksheets, views, tables, Liveboards, and Answers in a human-readable format.



Use ThoughtSpot Modeling Language (TML) to export and import Worksheets, views, tables, Liveboards, and Answers in a human-readable format.
