...
Use ThoughtSpot Modeling Language (TML) to export and import Worksheets, views, tables, Liveboards, Monitor alerts ([.badge.badge-beta]#Beta# and off by default in 9.0.0.cl), and Answers in a human-readable format.
