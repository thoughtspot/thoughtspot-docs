...
. Go to *Utilities*, and click the *Open TML utility* button.
+
[.bordered]
...
. Click the *Export selected TML* button.
+
[.bordered]
...
> * xref:model-inclusion.adoc[Create join rule or RLS for a Worksheet]
