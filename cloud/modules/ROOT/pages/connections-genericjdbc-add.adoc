...
Before you create a {connection} connection, you must provide a public URL for the JDBC Driver JAR and raise a support ticket by contacting {support-url}. This JAR must be compatible with java 11. For security reasons, you cannot directly upload the JARs to ThoughtSpot. ThoughtSpot security reviews the driver, after which the driver is available for use.
...
> * xref:connections-genericjdbc-deactivate.adoc[]
