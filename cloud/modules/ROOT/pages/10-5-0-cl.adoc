...
Compact Liveboard header [.badge.badge-ga-relnotes]#GA#::
...
[#spotter]
Spotter [.badge.badge-ga-relnotes]#GA#:: We made the following enhancements to Spotter:
...
Enhanced Google Sheets add-on [.badge.badge-ga-relnotes]#GA#::
...
Anomaly-based alerts [.badge.badge-ga-relnotes]#GA#::
...
Bring your own key (BYOK) for Google Cloud [.badge.badge-ga-relnotes]#GA#::
...
Utilities schema viewer [.badge.badge-ga-relnotes]#GA#::
