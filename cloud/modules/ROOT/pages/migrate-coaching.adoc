...
Within the same instance or environment:: Users often migrate training from one Model to another within the same cluster.
+
Use Cases:
+
--
...
* Select *Export Model* and *Export associated Spotter feedback* to download the Model TML file and coaching TML file. Click *Save*.
