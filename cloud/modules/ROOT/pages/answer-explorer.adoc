...
>
> * We highly recommend that you register for the free Introduction to Liveboards course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/introduction-to-liveboards/1000072[Using the Answer Explorer^] lesson.
