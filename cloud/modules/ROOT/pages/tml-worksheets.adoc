...
[#lesson_id]
lesson_id::
The numeric ID of the lesson created for the Worksheet. The first lesson shown to users has an ID of 0, the second lesson has an ID of 1, and so on.

[#lesson_plan_string]
lesson_plan_string::
The content of the lesson created for the Worksheet. For example, `"What were [Lo Tax] by [Lo Shipmode] in [Lo Commitdate].'2019' ?"`.

[#lesson_plans]
lesson_plans::
Contains a list of lessons created for the Worksheet.
