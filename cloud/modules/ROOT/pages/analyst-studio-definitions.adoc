...
:experimental:
:page-aliases: /analyst-studio/definitions.adoc
...
>
> * We highly recommend that you register for the free Querying Data in Analyst Studio course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/querying-data-in-analyst-studio/2091242[Creating SQL Snippets Using Definitions^] lesson.
