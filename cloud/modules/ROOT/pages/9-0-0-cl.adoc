...
[#export-fqns]
Export FQNs when exporting TML files [.badge.badge-ga-relnotes]#GA#::
...
[#rename-liveboards]
Rename Liveboards and visualizations without entering edit mode [.badge.badge-ga-relnotes]#GA#::
...
PostgreSQL connection [.badge.badge-ga-relnotes]#GA#:: You can now create connections from ThoughtSpot to PostgreSQL. For details, see xref:connections-postgresql.adoc[PostgreSQL].
[#redshift-partner]
Redshift Partner Connect [.badge.badge-ga-relnotes]#GA#:: Redshift Partner Connect allows you to try out ThoughtSpot connected to Redshift for free. For details, see xref:connections-redshift-partner.adoc[ThoughtSpot in Redshift Partner Connect].

[#dbt-metadata]
dbt metadata tags for table and Worksheet column properties and table joins [.badge.badge-ga-relnotes]#GA#::
