...
>
> * We highly recommend that you register for the free Datasets with Analyst Studio course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/dataset-extracts-with-analyst-studio/2455402[Import Tabular Files as Datasets^] lesson.
