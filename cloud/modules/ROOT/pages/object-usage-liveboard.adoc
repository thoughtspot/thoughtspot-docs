...
>
> * We highly recommend that you register for the free Monitoring System Activities course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/admin-monitoring-system-health/2499332[Object Usage^] lesson.
