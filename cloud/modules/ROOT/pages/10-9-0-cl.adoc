...
=== Deprecated and removed features in 10.9.0.cl
...
[#knowledge-cards]
Knowledge cards in Spotter [.badge.badge-ga-relnotes]#GA#:: You can now hover over query tokens in Spotter to see background information on measures, attributes, formulas, and filters.

// Naomi. jira: SCAL-243564. docs jira: SCAL-251986
[#spotter-worksheet]
Spotter Worksheet and Model optimization [.badge.badge-ga-relnotes]#GA#:: When you edit a Worksheet or Model that has Spotter enabled, you now see a Spotter optimization tab where you can click tiles to enable indexing, ensure date values are stored in the correct format, and optimize column types. You must have edit access to a Worksheet or Model to enable Spotter optimization. For more information, see xref:spotter-model.adoc[].


// Naomi. Jira: SCAL-220576. Docs jira: SCAL-256740
[#spotter-quick]
Spotter quick edits [.badge.badge-ga-relnotes]#GA#:: You can now click tokens in a Spotter answer to edit them for clarity, such as specifying whether a measure should be classified as count or unique count, or changing the column being used as an attribute. For more information, see
xref:spotter-getting-started.adoc#quick-edits[Getting started with Spotter].


// Rani. docs jira: SCAL-245106
[#thoughtspot-for]
ThoughtSpot for Microsoft PowerPoint add-in [.badge.badge-ga-relnotes]#GA#:: *ThoughtSpot for PowerPoint* is an add-in that allows you to insert charts and data visualizations into your PowerPoint presentation. Just connect to your ThoughtSpot instance, find a chart or visualization, and add it to your PowerPoint presentation. For more information, see xref:thoughtspot-powerpoint.adoc[ThoughtSpot add-in for Microsoft PowerPoint].
...
[#ai-highlights]
AI Highlights [.badge.badge-ga-relnotes]#GA#:: AI Highlights are now available to all users. With AI Highlights, you get quick insights on how top metrics have changed in your Liveboard, dramatically reducing the time to derive insights from your KPIs. To enable this feature, contact your administrator. For more information, see
...
[#exclude-header]
Exclude header from XLS files [.badge.badge-ga-relnotes]#GA#::
...
[#monitor-alerts]
Monitor alerts time zone support [.badge.badge-ga-relnotes]#GA#::
...
[#pivot-table]
Pivot table summary calculation changes [.badge.badge-ga-relnotes]#GA#::
...
[#export-spotter]
Export Spotter coaching from Coach Spotter [.badge.badge-ga-relnotes]#GA#:: Filter, select and export specific reference questions or business terms across various data models directly from Coach Spotter.
+
For more information, see xref:spotter-migrate-legacy.adoc[Migrate Spotter feedback using TML].
...
// Naomi. Jira: SCAL-221141. Docs jira: SCAL-251099
[#google-bigquery]
Google BigQuery connection fields [.badge.badge-ga-relnotes]#GA#:: We have made the following changes to connection fields for Google BigQuery:
+
--
...
[#import-and]
Import and export column properties for bulk edit [.badge.badge-ga-relnotes]#GA#::
...
Allow export of high resolution Liveboard PNG file [.badge.badge-ga-relnotes]#GA#::
...
[#home-page]
Home page watchlist enhancements [.badge.badge-ga-relnotes]#GA#::
