...
> ** Datasets with Analyst Studio course: Watch the https://training.thoughtspot.com/dataset-extracts-with-analyst-studio/2074635[What are Datasets?^] lesson.
> ** Datasets with Analyst Studio course: Watch the https://training.thoughtspot.com/dataset-extracts-with-analyst-studio/2074637[How to Create a Dataset in Analyst Studio with SpotCache^] lesson.
> ** Datasets with Analyst Studio course: Watch the https://training.thoughtspot.com/dataset-extracts-with-analyst-studio/2291916[Accessing Published Datasets in the Data Workspace^] lesson.
> ** Analyst Studio Administration course: Watch the https://training.thoughtspot.com/analyst-studio-administration/2488157[SpotCache Introduction^] lesson.
