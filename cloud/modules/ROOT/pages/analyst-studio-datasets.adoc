...
:jira: SCAL-234704, SCAL-256777, SCAL-273184, SCAL-284018
...
Datasets are encrypted tables stored in ThoughtSpot and refreshed at a user-defined interval. The easiest way to create a reusable Dataset is to make one directly from a query in a Report. You can also create one from scratch.
