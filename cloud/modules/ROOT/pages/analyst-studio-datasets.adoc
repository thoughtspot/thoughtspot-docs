...
[cols="20%,40%,40%"]
|===
| |*Update to published dataset in the Data workspace* |*Resulting behavior to dataset in Analyst Studio*

.4+.^|*Dataset Lifecycle changes*
|Dataset name is changed. |The name changes in Analyst Studio.
