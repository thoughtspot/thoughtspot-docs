...
The following are resulting behaviors in the Data workspace which occur when updating a published dataset in Analyst Studio.
[cols="20%,40%,40%"]
|===
...
CAUTION: If a dataset is deleted directly from the Data workspace, then you must republish the dataset from Analyst Studio for it to appear again.
