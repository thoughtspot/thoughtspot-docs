...
>
> * We highly recommend that you register for the free ThoughtSpot University course that covers the information in this article, https://training.thoughtspot.com/getting-started-with-thoughtspot-cloud[Getting Started with ThoughtSpot Analytics Cloud^].
