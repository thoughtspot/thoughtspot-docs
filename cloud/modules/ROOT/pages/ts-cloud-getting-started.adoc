...
>
> * We highly recommend that you register for the free Welcome to ThoughtSpot Analytics Cloud course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/welcome-to-thoughtspot-cloud/1054237[Introduction to ThoughtSpot Cloud^] lesson.
