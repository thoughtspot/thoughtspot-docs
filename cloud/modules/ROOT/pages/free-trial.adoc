...
* When creating a Free Trial account, you no longer need to upload data to try out the product. You can experience all of ThoughtSpot's capabilities using sample data.
* When onboarding to Free Trial, you can immediately use xref:spotter.adoc[Spotter] to try searching sample data.
* We've simplified the process of uploading your data to Free Trial, and you can choose between uploading a CSV file, connecting to Google Sheets, or connecting to your Cloud data warehouse.
...
* We fixed toast notifications on the home page to display multiple changes to the same component.
...
image:free-trial-login-email-address.png[Login requires email address]
