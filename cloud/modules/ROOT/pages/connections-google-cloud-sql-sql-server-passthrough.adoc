...
:page-last_updated: 11/8/2023
:linkattrs:
:experimental:

:page-aliases:
:connection: Google Cloud SQL for SQL Server
:description: Passthrough functions allow you to send SQL expressions directly to Google Cloud SQL for SQL Server without being interpreted by ThoughtSpot.
:jira: SCAL-164805
