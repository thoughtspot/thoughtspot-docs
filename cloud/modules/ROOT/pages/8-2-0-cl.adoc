...
This feature is in beta and off by default. To enable it,  contact {support-url}.
[#pivot-table]
Pivot table scroll bar [.badge.badge-ga-relnotes]#GA#::
...
[#html]
HTML in Answer titles and descriptions [.badge.badge-ga-relnotes]#GA#::
...
[#kpi]
Key Performance Indicator (KPI) chart type [.badge.badge-ga-relnotes]#GA#::
...
New connection creation flow with data tab redesign [.badge.badge-ga-relnotes]#GA#::
