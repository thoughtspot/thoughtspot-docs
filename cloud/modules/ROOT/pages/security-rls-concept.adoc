...
An RLS rule evaluates against these system variables:
...
****
ThoughtSpot now includes RLS rule logic to support using AND/OR operators with bracket notation. You can now define more precise and complex access control policies that accurately reflect your organization's security requirements without resorting to data modeling solutions with access control list tables.
****
