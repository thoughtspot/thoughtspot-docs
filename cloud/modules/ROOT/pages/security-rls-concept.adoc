...
:jira: SCAL-176169 - (correction on RLS on worksheets), SCAL-230531
...
NOTE: When Bypass RLS is checked on a Worksheet, it applies to queries involving tables, but NOT to queries on Views based upon those tables.
