...
This reference lists supported countries and their subdivisions for Models with the geographical data manually classified.
...
When manually selecting the type of geographical data in a Model, you may have to make changes to your data to support geo maps.
...
You can download a CSV file that contains all supported values for geo map countries, codes, and subdivisions in Models with geographical data manually classified. Use this file to confirm that your own geographical values are in the correct format, and that ThoughtSpot supports them. Download the link:{attachmentsdir}/geomaps-supported-countries-codes-subdivisions-cloud.csv[CSV file].
...
In Models with geographical data manually classified, ThoughtSpot supports the following countries and their associated subdivisions:
