...
:jira: SCAL-160549, SCAL-199383, SCAL-202496, SCAL-239700
...
== Allow administrators to act as you [.badge.badge-early-access-relnotes]#Early Access#
...
This setting is *off by default*. You control whether any administrator can act as you. Administrators cannot change this setting on your behalf.

When this setting is on:

* An authorized administrator can start a session as you at any time, without additional notification.
...
. Select the user icon in the top-right corner of the navigation bar.
. Select *Profile*.
. Locate the *Act as setting*.
+
[.bordered]
image::impersonation-3.png[Enable Act as setting ]
. Click *Edit* and select a time window from the dropdown for the setting to be active.
+
[.bordered]
