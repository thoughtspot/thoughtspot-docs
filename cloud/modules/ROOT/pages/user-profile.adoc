...
////
[#new-answer-data-panel-experience]
== Manage your Spotter answer experience

To enable or disable the Spotter answer experience, follow these steps:

. Next to *Experience*, select *Edit*.

. Next to *Spotter answer experience*, select *Spotter agent* or *Classic experience*.
