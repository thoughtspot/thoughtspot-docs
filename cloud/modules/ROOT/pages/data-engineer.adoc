...
* xref:connections-amazon-athena-deactivate.adoc[Deactivate connection]
...
* xref:connections-amazon-aurora-mysql-deactivate.adoc[Deactivate connection]
...
* xref:connections-amazon-aurora-postgresql-deactivate.adoc[Deactivate connection]
...
* xref:connections-amazon-rds-mysql-deactivate.adoc[Deactivate connection]
...
* xref:connections-amazon-rds-postgresql-deactivate.adoc[Deactivate connection]
...
* xref:connections-redshift-deactivate.adoc[Deactivate connection]
...
* xref:connections-synapse-deactivate.adoc[Deactivate connection]
...
== image:clickhouse-icon.png[ClickHouse icon]ClickHouse

* xref:connections-clickhouse.adoc[Overview]
* xref:connections-clickhouse-add.adoc[Add connection]
* xref:connections-clickhouse-edit.adoc[Edit connection]
* xref:connections-clickhouse-remap.adoc[Remap connection]
* xref:connections-clickhouse-delete-table.adoc[Delete a table]
* xref:connections-clickhouse-delete-table-dependencies.adoc[Delete a table with object dependencies]
* xref:connections-clickhouse-private-link.adoc[Enable a PrivateLink]
* xref:connections-clickhouse-delete.adoc[Delete  connection]
* xref:connections-clickhouse-deactivate.adoc[Deactivate connection]
* xref:connections-clickhouse-reference.adoc[Connection reference]
...
* xref:connections-databricks-deactivate.adoc[Deactivate connection]
...
* xref:connections-denodo-deactivate.adoc[Deactivate connection]
...
* xref:connections-dremio-deactivate.adoc[Deactivate connection]
...
////
== image:TS-logo-black-no-bg.png[ThoughtSpot icon]Falcon

* xref:connections-falcon.adoc[Overview]
...
* xref:connections-falcon-delete-table.adoc[Delete a table]
* xref:connections-falcon-delete-table-dependencies.adoc[Delete a table with object dependencies]
* xref:connections-falcon-delete.adoc[Delete connection]
* xref:connections-falcon-passthrough.adoc[Passthrough functions]
...
* xref:connections-genericjdbc-deactivate.adoc[Deactivate connection]
...
* xref:connections-google-alloydb-postgresql-deactivate.adoc[Deactivate connection]
...
* xref:connections-gbq-deactivate.adoc[Deactivate connection]
...
* xref:connections-google-cloud-sql-mysql-deactivate.adoc[Deactivate connection]
...
* xref:connections-google-cloud-sql-postgresql-deactivate.adoc[Deactivate connection]
...
* xref:connections-google-cloud-sql-sql-server-deactivate.adoc[Deactivate connection]
* xref:connections-google-cloud-sql-sql-server-reference.adoc[Connection reference]

////
== image:google-sheets-icon.png[Google Sheets icon] Google Sheets

* xref:connections-google-sheets.adoc[Overview]
...
* xref:connections-google-sheets-delete-table.adoc[Delete a table]
* xref:connections-google-sheets-delete-table-dependencies.adoc[Delete a table with object dependencies]
...
== image:iomete.png[Iomete icon]Iomete

* xref:connections-iomete.adoc[Overview]
* xref:connections-iomete-add.adoc[Add connection]
* xref:connections-iomete-edit.adoc[Edit connection]
* xref:connections-iomete-remap.adoc[Remap connection]
* xref:connections-iomete-delete-table.adoc[Delete a table]
* xref:connections-iomete-delete-table-dependencies.adoc[Delete a table with dependent objects]
* xref:connections-iomete-delete.adoc[Delete connection]
* xref:connections-iomete-deactivate.adoc[Deactivate connection]
* xref:connections-iomete-reference.adoc[Connection reference]

== image:looker.svg[Looker icon, 130]

* xref:connections-looker.adoc[Overview]
...
* xref:connections-looker-deactivate.adoc[Deactivate connection]
...
* xref:connections-mysql-deactivate.adoc[Deactivate connection]
...
* xref:connections-adw-deactivate.adoc[Deactivate connection]
...
* xref:connections-postgresql-deactivate.adoc[Deactivate connection]
...
* xref:connections-presto-deactivate.adoc[Deactivate connection]
...
* xref:connections-hana-deactivate.adoc[Deactivate connection]
...
* xref:connections-singlestore-deactivate.adoc[Deactivate connection]
...
* xref:connections-snowflake-deactivate.adoc[Deactivate connection]
...
* xref:connections-sql-server-deactivate.adoc[Deactivate connection]
...
* xref:connections-starburst-deactivate.adoc[Deactivate connection]
...
* xref:connections-teradata-deactivate.adoc[Deactivate connection]
...
* xref:connections-trino-deactivate.adoc[Deactivate connection]
