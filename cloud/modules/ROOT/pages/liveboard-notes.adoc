...
:page-last_updated: 6/6/2025
:linkattrs:
:experimental:
:author: Teresa Killmond, Mark Plummer
...
. If the content you need to embed comes from an external site like *youtube.com* or *loom.com*, you must whitelist the site. For details, see xref:whitelisting-embed[Whitelisting sites for embedding in an iFrame].
. Navigate to the Liveboard with the note tile you would like to edit.
. Select the *Edit* button at the upper right of the Liveboard. If this button is grayed out, you do not have edit privileges for the Liveboard. To resolve this, contact your administrator or the creator of the Liveboard.
. Select the note. The formatting bar at the top of the note tile appears.
...
[#whitelisting-embed]
==== Whitelisting sites for embedding in an iFrame

To embed content from external sites like *youtube.com* and *loom.com*, you must whitelist them by doing the following:

. Go to the *Develop* tab, and select *All Orgs* (if there are multiple Orgs).
. Select *Security settings*.
. Click *Edit*.
. In the _Permitted iFrame domains_ field, enter the base URL of the site.
+
Example: `https://www.youtube.com`. You can enter multiple URLs separated by commas.
. Click *Save Changes*.
