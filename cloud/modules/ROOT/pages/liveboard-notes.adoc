...
. When you are finished editing the note tile, select *Save* in the top menu bar of the Liveboard.
+
NOTE: In order to render information in an iFrame, you need to add the information's source to your allowlist. For more information, see link:https://developers.thoughtspot.com/docs/security-settings[Security settings].
