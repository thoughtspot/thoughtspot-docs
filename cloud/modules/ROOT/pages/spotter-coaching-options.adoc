...
xref:spotter-coach-conversation.adoc[Reference questions]:: After setting your global rules, use these to teach Spotter "If a user asks X, you should answer with Y". This is enhanced with natural language context, which lets you explain why the answer is correct.
...
For details on how to create reference questions, see xref:spotter-coach-conversation.adoc[].
