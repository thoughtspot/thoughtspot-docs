...
:description:
:jira: SCAL-228500, SCAL-244132, SCAL-253102
...
+
NOTE: Please note that the visualization settings provided in query feedback may not extend to these questions. Visualization settings don't apply if the question is different from the reference question.
...
Business terms give you an option to create a mapping between your data and the business term/vocabulary used in day-to-day operations. For example, the “active clusters” example we saw in xref:spotter-coaching.adoc#active[Coaching Spotter] is an example of business terms.
...
Filters definition:: Business terms can be used to define filters that should be applied for specific cases. For example, the xref:spotter-coaching.adoc#active[active clusters] example demonstrated how you can use the business term to define specific filters to be applied while calculating things.
