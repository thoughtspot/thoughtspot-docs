...
* Data model instructions and business terms are managed on the data model.
* Reference questions can be added from within a Spotter conversation or managed and edited from the Data workspace.
