...
:jira: SCAL-245428, SCAL-249279, SCAL-246983, SCAL-270356, SCAL-175156, SCAL-306609
...
We also provide these instructions in link:{attachmentsdir}/ThoughtSpot-Support-Handbook.pdf[PDF format].
...
NOTE: If you are using Free Trial or Team Edition, you see a chat widget in the bottom right corner of your screen. Please use this widget to start a chat with our team for assistance.
...
In the ThoughtSpot Support Portal, you can use <<_using_spotline,SpotLine>> to ask a question, alert us to an outage, create a support case, or view a support case.

To access the support portal, go to:

http://thoughtspot.com/support-request[http://thoughtspot.com/support-request^]

To access the support portal, you must have a https://community.thoughtspot.com/customers/s/[ThoughtSpot Community^] user account.
If you're not signed up yet, please click https://community.thoughtspot.com/customers/s/login/SelfRegister["Sign Up"^] on the login page and follow the instructions to register and get access.
[.bordered]
image::support-portal-v2-login.png[Community login page]
...
[.bordered]
image::support-portal-v2.png[Select Support from the top navigation bar of the ThoughtSpot Community]

==== Using SpotLine

* To ask a question, click *Chat with us* and do the following:
** Enter your question in the Message box, and click the Send button  image:support-portal-v2-send-btn.png[Send button].

* To alert us to an outage, click *Experiencing an outage? Alert our team now* and follow the on-screen instructions to report your outage.

* To create a support case, click *Chat with us* and do the following:
** Enter "I want to create a support case" in the Message box, and click the Send button  image:support-portal-v2-send-btn.png[Send button]. SpotLine will ask you some questions to clarify what your problem is before providing you a link to a form to create a support case. For details on how to fill out a support case form, see <<submit-case,Submitting a support case online>>.
+
To report issues, especially critical ones, ThoughtSpot recommends that you create a support case online in the Support Portal. However, you can create a support case by phone. For details, see <<support-phone,Creating a support case by phone>>.
+
TIP: You can also click the *View Classic Experience* button to go directly to the form to create your case.
* To view a support case, click *View Support Cases*.
+
TIP: You can also click the *View Cases* button.

[#submit-case]
==== Submitting a support case online
Provide all required information in the form, and click *Submit*.

To the right of the form, under *Need Answers Fast?*, we suggest Knowledge Base articles you can read that match the keywords in the *Subject* and *Description* you provide.

[.bordered]
image::support-portal-v2-form.png[Submit case form]
...
You can also find these support phone numbers on the https://www.thoughtspot.com/contact-us[Contact Us^] section of the ThoughtSpot website.
