...
IMPORTANT: You must have a https://community.thoughtspot.com/customers/s/[ThoughtSpot Community^] user account.
If you're not signed up yet, click https://community.thoughtspot.com/customers/s/login/SelfRegister["Sign Up"^] on the login page and follow the instructions to register and get access.
[.bordered]
...
+
TIP: You can also click the *View Classic Experience* button to go directly to the form to submit your case.
