...
[NOTE]
====
Funnel charts are available as part of the new charts library Early Access rollout. Contact {support-url} to enable this chart type on your instance.
====
...
. In the chart selector panel, select *Funnel*.
