...
[NOTE]
====
Funnel charts are available as part of the Muze Set 2 Charts Early Access rollout. Contact {support-url} to enable this chart type on your instance.
====
...
The Muze-powered Funnel chart introduces the following capabilities not available in the classic version:
...
When migrating from the classic Funnel chart to the Muze-powered version, note the following changes:
