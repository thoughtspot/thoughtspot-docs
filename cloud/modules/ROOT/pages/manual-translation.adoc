...
>
> * We highly recommend that you register for the free Localization & Language Settings course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/localization-language-settings/2534535[Manual Translation for Liveboards and Answers^] lesson.
