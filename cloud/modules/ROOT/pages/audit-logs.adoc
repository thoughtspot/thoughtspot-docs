...
+
NOTE: The create, update, and delete events for Models are also used for Worksheets.
...
* <<delete-join,DELETE_RELATIONSHIP>>
...
[#create-join]
CREATE_RELATIONSHIP:: A user attempts to create a join, including join properties of type and cardinality.
[#create-pinboard]
...
[#delete-join]
DELETE_RELATIONSHIP:: A user attempts to delete a join.
[#delete-model]
...
[#update-join]
UPDATE_RELATIONSHIP:: A users attempts to update a join, including join properties of type and cardinality.
[#update-model]
