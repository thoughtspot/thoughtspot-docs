= ThoughtSpot Cloud release lifecycle
:page-last_updated: 12/22/2022
:author: Mark Plummer
:linkattrs:
:experimental:
:description: The lifecycle of ThoughtSpot Cloud releases.
...
****
Beta features are marked with [.badge.badge-beta-relnotes]#Beta# and are disabled by default.
...
****
Early Access features are marked with [.badge.badge-early-access-relnotes]#Early Access# and are disabled by default.
...
General Availability features have new or enhanced functionality that are enabled by default for all customers.

****
General Availability features are marked in the release notes with [.badge.badge-ga-relnotes]#GA#. GA feature articles, however, are not labeled.
****
