...
:jira: SCAL-159819, SCAL-201314, SCAL-239972

You can now ask questions to Spotter right within Slack. Install the ThoughtSpot Slack app, add it to a Slack channel, and you will be able to ask questions on your data sources in natural language. ThoughtSpot answers in chart format. Note that Slackbot is currently not available for TSE, GCP clusters, and in the EU region.
...
For example, typing `@Spotter show me the top 10 products for this quarter` will prompt the bot to process the query and return results in a visual format (provided the appropriate dataset is selected). This feature enables users to access data insights directly from Slack, streamlining workflows without switching applications.
...
* `/spotter-show-model` to see the top Worksheets in your ThoughtSpot account.
