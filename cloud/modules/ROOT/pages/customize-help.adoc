...
If your organization uses xref:orgs-overview.adoc[], ensure that you are in the Primary Org, in the *All orgs* section of the Admin Console. You customize the help menu for the whole cluster. You cannot customize it separately for each Org.
