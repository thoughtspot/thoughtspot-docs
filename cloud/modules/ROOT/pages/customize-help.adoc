...
To customize the Help menu, navigate to the *Admin settings* page, and select *Help customization* from the left navigation bar.
...
>
> * We highly recommend that you register for the free Customizing the ThoughtSpot UI course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/customizing-the-thoughtspot-ui/2513654[Help Menu Customization^] lesson.
