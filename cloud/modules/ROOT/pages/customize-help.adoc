...
NOTE: If your organization uses xref:orgs-overview.adoc[], you must be a instance administrator to customize the help menu, not an Org administrator. You customize the help menu for the whole instance. You cannot customize it separately for each Org.
...
To customize the Help menu, navigate to the *Admin* page, and select *All Orgs* > *Help customization* from the left navigation bar.

If your organization uses xref:orgs-overview.adoc[multi-tenancy with Orgs], ensure that you are in the Primary Org, in the *All orgs* section of the Admin Console. You customize the help menu for the whole instance. You cannot customize it separately for each Org.
