...
>
> * We highly recommend that you register for the free Introduction to Formulas course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/introduction-to-formulas/1111295[Using Formulas in Models^] lesson.
