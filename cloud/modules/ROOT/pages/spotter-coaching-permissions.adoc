...
| Spotter coaching access: User does not have edit permissions to a Model but has been assigned coaching access to the Model. a| User can view all coaching on the Model. | User can create global level coaching and write instructions on the Model, but cannot use the AI Context feature.
