...
To access this Liveboard, go to the *Insights* tab, select *Liveboards* and search for *Indexing Queries*. Note that this Liveboard is only visible to admin users.
...
>
> * We highly recommend that you register for the free Indexing course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/admin-indexing/2499305[Monitoring Indexing^] lesson.
