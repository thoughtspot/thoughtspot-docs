...
You can always view upcoming scheduled maintenance from the Admin settings.
...
. To view maintenance alerts from the ThoughtSpot application, navigate to the Admin settings by selecting the *Admin settings* from your profile.
