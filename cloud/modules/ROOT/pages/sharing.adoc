...
>
> * We highly recommend that you register for the free Sharing Objects course in ThoughtSpot University that covers the information in this article, and watch the following lessons:
> ** https://training.thoughtspot.com/sharing-objects/1019663[Sharing Objects^]
> ** https://training.thoughtspot.com/sharing-objects/1053795[Scheduling Shared Objects^]
