...
You can share with groups and with individual people. You do not have to be an administrator or the owner of an object to share saved Answers or Liveboards.
