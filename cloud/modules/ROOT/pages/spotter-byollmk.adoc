...
== Best practices for using LLMs with Spotter
For the best experience, access to the latest models, and the lowest maintenance overhead, we strongly recommend ThoughtSpot Enabled Auto Select. This ensures you always have access to the latest models that are fully managed and optimized by ThoughtSpot.
