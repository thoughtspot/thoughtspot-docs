...
* Spotter 3 requires you to provide both Claude and GPT LLMs in your BYOLLM configuration.
====
...
.Important notes about Spotter 3 LLM support
[IMPORTANT]
====
* LLM configurations in Spotter 3 require multiple models and have a dependency on GPT 4.1 using Microsoft Azure for code execution.
