...
:page-last_updated: Aug 20, 2026
:author: Naomi, Rani
:linkattrs:
:experimental:
:jira: SCAL-276577, SCAL-321304, SCAL-331123, SCAL-308243
...
We currently support connections to Azure OpenAI, Google Vertex AI, Amazon Bedrock, Snowflake Cortex, and custom LLM gateways.
