...
* Spotter 3 requires you to provide both Claude and GPT LLMs in your BYOLLM configuration and has a dependency on GPT 5.1 using Microsoft Azure for code execution. Contact {support-url} for more information.
...
| Spotter 3 | Claude Opus 4.5 + GPT-5.1 with code execution
