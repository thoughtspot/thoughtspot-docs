...
We provide you a *three-week* period to update your models according to the new recommendations. This update is essential to ensuring optimal performance and continued access to our latest features. If you fail to comply with this update within the specified time period, you may experience diminished performance or unavailability of certain features. ThoughtSpot support is committed to communicating and collaborating with you to guarantee the best possible experience.
