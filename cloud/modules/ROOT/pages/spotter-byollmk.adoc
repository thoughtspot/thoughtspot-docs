...
* Spotter 3 requires you to provide both Claude and GPT LLMs in your BYOLLM configuration and has a dependency on GPT 4.1 using Microsoft Azure for code execution. Contact {support-url} for more information.
