...
Connections:: Your connections appear under the xref:connections.adoc[**Connections**] tab. You can add, edit, remap, or delete connections to external data warehouses from the *Connections* page.
