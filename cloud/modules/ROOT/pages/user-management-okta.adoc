...
[NOTE]
====
This article contains instructions for managing users if your company uses Identity and Access Management V2 (IAMv2). IAMv2 is in *Beta* and off by default in 8.7.0.cl. If the *Users* section of the Admin Console contains an *Account Activation* column, your company is using IAMv2.
