...
Depending on your configuration, you will need to complete the following after migrating to IAM V2. For an overview of IAM V2, see xref:okta-iam.adoc[Identity and Access Management V2].
...
* xref:iamv2-pre-migration.adoc[Before migrating to IAM V2]
