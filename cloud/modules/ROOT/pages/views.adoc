= Understanding views
:page-last_updated: 7/13/2021
:linkattrs:
:experimental:
:page-aliases: /complex-search/about-query-on-query.adoc
:description: A saved SQL query or search-based dataset that acts as a virtual table that sits on top of your existing data and can be used as a source for further analysis.
:jira: SCAL-199289, SCAL-264258

== Introduction to views

A view is a saved SQL query or search-based dataset that acts as a virtual table in ThoughtSpot — it sits on top of your existing data and can be used as a source for further analysis, just like a physical table.
...
. We recommend that you xref:models.adoc#[create a new Model] that includes all these data sources.
+
Creating a Model makes it easier for people to search using your view and any related tables.

== Best practices for using views

* When creating views, keep in mind the sizing recommendations for Models, for the final Model that you plan to use in modeling you data.
