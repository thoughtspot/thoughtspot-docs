...
You can now create your own charts inside ThoughtSpot using Muze Studio. With Muze studio, you can use the Muze library to create a chart in any Answer. Muze is ThoughtSpot's in-product charting library which supports a lot of different chart types and customizations. For information about Muze, see https://cyoc-documentation-site.vercel.app/muze/Guides%20and%20Tutorials/muze[Introduction to Muze^].
