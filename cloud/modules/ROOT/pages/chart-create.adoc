...
[NOTE]
====
To run Muze Studio as a custom chart in ThoughtSpot, customers must whitelist Vercel.

* xref:https://docs.thoughtspot.com/cloud/latest/tsa-and-tse[ThoughtSpot Embedded (TSE)] users can whitelist the domain by following the steps listed below.
* xref:https://docs.thoughtspot.com/cloud/latest/tsa-and-tse[ThoughtSpot Analytics (TSA)] users should contact support for assistance with the whitelisting of the domain.
====
...
> **Related information**
>
> * https://developers.thoughtspot.com/charts/muze/26.2.0/intro[Introduction to Muze Studio^]
> * https://developers.thoughtspot.com/charts/muze/26.2.0/use-muze[Use Muze in ThoughtSpot^]
