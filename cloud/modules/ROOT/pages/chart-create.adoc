...
. When you have finished making your changes, click the *Save* button to save your chart. If your answer is already pinned to a Liveboard, you can click the *Pin* button, to publish your changes to the Liveboard.
