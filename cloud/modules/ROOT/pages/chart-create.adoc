...
You can now create your own charts inside ThoughtSpot using Muze Studio. If you're a developer, you can use the *code editor* to create new chart types by writing the code for them. Using the chart library API, you can create complex charts with very few lines of code.
...
== CSS editor
By default, charts will take on the system color palette of your ThoughtSpot cluster, but you can change that if you want.
. . .
