...
The semantic model is not built by AI guessing your business logic. It is **defined and verified by humans**, capturing tacit knowledge — the kind that lives in spreadsheets, email threads, and the heads of your most senior analysts — and encoding it formally.
...
> * xref:context-layer.adoc[The context layer] — The context layer consumes the semantic layer and adds business logic, use case knowledge, reporting preferences, and per-user context to power Spotter agents.
