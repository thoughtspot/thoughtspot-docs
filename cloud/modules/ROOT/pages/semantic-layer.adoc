...
> * xref:context-layer.adoc[The context layer] — The context layer consumes the semantic layer and adds business logic, use case knowledge, reporting preferences, and per-user context to power AI agents.
