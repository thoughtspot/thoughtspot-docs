...
:page-layout: default-cloud-no-index
:page-aliases: /analyst-studio/google-sheets-integration.adoc
...
Yes. You can reference Google Sheet Datasets that you’ve added to your Report as dataframes in the Notebook xref:analyst-studio-notebook.adoc#accessing-query-results[by name, position, or token].
