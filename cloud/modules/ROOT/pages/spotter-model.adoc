...
- The "Optimize for Spotter" guidance message appears when there are additional steps recommended for Spotter Optimization. In this case, refer to xref:worksheet-readiness.adoc[Model readiness for Sage] for guidelines on how to prepare your Model to improve accuracy.
+
[.bordered]
