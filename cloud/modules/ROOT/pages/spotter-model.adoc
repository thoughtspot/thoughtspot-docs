...
Set yourself up for success by taking the time to optimize your data model configuration. By taking the time to prepare your data for use with our AI systems, you gain more accurate responses to your questions.
...
This article details each step of setting up a Model.
