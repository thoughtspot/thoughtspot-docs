...
. Go to the *Insights* tab and select *Answers*.

. Select the desired Answer. You must have *Can manage sync* permissions and *view* access to an Answer to create a sync.
