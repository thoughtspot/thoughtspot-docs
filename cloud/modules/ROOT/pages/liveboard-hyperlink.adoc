...
. In the *Data* side menu, scroll to *Formulas* and select the *+* icon.
+
image::formula-add-v2.png[Create a new formula in an Answer]
...
To learn more about runtime filters, see xref:developer-user.adoc[About runtime filters].
