...
:jira: SCAL-244744, SCAL-292452, SCAL-205488
...
Note that you cannot connect the Microsoft Teams plugin to a custom domain; for security, you may only connect through a ThoughtSpot domain.
...
NOTE: ThoughtSpot for MS Teams is in Early Access and off by default. To enable this feature, contact your administrator.
