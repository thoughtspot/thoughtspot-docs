...
You can now ask questions to Spotter right within MS Teams. Begin a direct message with Spotter, and you will be able to ask questions on your data sources in natural language. ThoughtSpot answers in chart format.
