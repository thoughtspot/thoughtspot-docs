...
:linkattrs:
:description: You can now ask ThoughtSpot questions using MS Teams.
:jira: SCAL-244744

You can now ask questions to Spotter right within MS Teams. Add Spotter to an MS Teams channel, and you will be able to ask questions on your data sources in natural language. ThoughtSpot answers in chart format.

IMPORTANT: Note that Spotter in MS Teams is currently not available for TSE, GCP clusters, and in the EU region.
...
This feature enables users to access data insights directly from MS Teams, streamlining workflows without switching applications.


== Set up Spotter for MS Teams

To set up ThoughtSpot for MS Teams, follow these steps:
...
+
image:connect-to-ms-teams.png[Connect to MS Teams]


. Sign in to your MS Teams account. Once signed in, click *Accept*.
+
[.bordered]
image::ms-teams-accept.png[Microsoft permissions requested]

You can now get answers to your data questions without leaving MS Teams. Simply add Spotter to a channel and ask your question in natural language. The answer appears as a visualization.

== Add Spotter to a channel

After connecting to Spotter for MS Teams:

. Add Spotter to a channel to start asking.
. Spotter prompts you to first choose a Model or Worksheet to search on.
+
NOTE: If you click *View prompts* above the chat entry bar, you can see a list of all Spotter commands in MS Teams: Help, Show Models, Show Columns, and Reset.
...
Please note that MS Teams may occasionally get disconnected automatically due to various reasons, such as token expiration or network issues. In such cases, users will need to reconnect to restore functionality.

== Disconnect from MS Teams

You can disconnect from MS Teams at any time by going to your user profile in ThoughtSpot and clicking *Disconnect from MS Teams*.