...
. In the upper-right corner of the visualization, click the ellipses icon image:icon-ellipses.png[more options menu icon] and select *Copy and edit*, or *Make a copy*, depending on your xref:liveboard-experience-new.adoc[Liveboard experience].
+
