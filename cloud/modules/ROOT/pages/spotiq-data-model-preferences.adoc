...
If you have access to tables, Models, and views for data modeling purposes, you can specify columns to exclude from SpotIQ analyses.
...
. Select *Data* in the top navigation bar, and choose *Tables*,  *Models*, or *xref:views.adoc[Views]*.
...
. Select *Data* in the top menu, and choose *Tables*, *Models*, or *xref:views.adoc[Views]*.
. Select the name of your data source.
