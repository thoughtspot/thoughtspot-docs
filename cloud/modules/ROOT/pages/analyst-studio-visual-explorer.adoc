...
> ** Analyst Studio's Visualization Environments course: Watch the https://training.thoughtspot.com/analyst-studios-visualization-environments/2088364[Visual Explorer Highlights^] lesson.
> ** Visual Explorer Basics course: Watch the https://training.thoughtspot.com/visual-explorer-basics-ts/2067517[Understanding Data Fields in Visual Explorer^] lesson.
> ** Visual Explorer Basics course: Watch the https://training.thoughtspot.com/visual-explorer-basics-ts/2067527[Columns & Rows in Visual Explorer^] lesson.
> ** Visual Explorer Basics course: Watch the https://training.thoughtspot.com/visual-explorer-basics-ts/2067529[Layers in VE: Mark Type^] lesson.
> ** Visual Explorer Basics course: Watch the https://training.thoughtspot.com/visual-explorer-basics-ts/2067533[Formatting in Visual Explorer^] lesson.
> ** Visual Explorer Basics course: Watch the https://training.thoughtspot.com/visual-explorer-basics-ts/2145562[Exercise: Visual Explorer Basics^] lesson.
> ** Using Visual Explorer to Create Dynamic Visualizations course: Watch the https://training.thoughtspot.com/using-visual-explorer-to-create-dynamic-visualizations-ts/2074900[Compare to a Baseline in Visual Explorer^] lesson.
> ** Using Visual Explorer to Create Dynamic Visualizations course: Watch the https://training.thoughtspot.com/using-visual-explorer-to-create-dynamic-visualizations-ts/2074901[Flexible Data Labels in Visual Explorer^] lesson.
...
> ** Using Visual Explorer to Create Dynamic Visualizations course: Watch the https://training.thoughtspot.com/using-visual-explorer-to-create-dynamic-visualizations-ts/2074851[Waterfall Charts in Visual Explorer^] lesson.
> ** Using Visual Explorer to Create Dynamic Visualizations course: Watch the https://training.thoughtspot.com/using-visual-explorer-to-create-dynamic-visualizations-ts/2074922[Dot Plots in Visual Explorer^] lesson.
