...
Row-level security (RLS) allows you to restrict access to table row data at group or user level.
You do this by creating a _rule_ that associates a filter with a group or user.
