...
>
> * We highly recommend that you register for the free Security course in ThoughtSpot University that covers the information in this article, and watch the https://training.thoughtspot.com/admin-security/2499290[Row-Level Security^] lesson.
