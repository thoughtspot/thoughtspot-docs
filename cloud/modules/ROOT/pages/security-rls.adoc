...
////
NOTE: It is possible users can use passthrough functions to bypass row-level security and access data that would otherwise be hidden. To mitigate this risk, a setting is available in the ThoughtSpot Admin tab to disable these functions.
////
