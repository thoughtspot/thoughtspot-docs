...
:experimental:
:jira: SCAL-268323, SCAL-270704, SCAL-275835
...
. Click *Add reference question*.
+
This leads you directly into the coaching flow, where you can begin refining responses and improving Spotter's accuracy.
+
[.bordered]
...
Note that the sample questions suggested when you open Spotter on the home page are generated based on recent reference questions and are not group-aware.

== Reference question coaching level
...
Pivot table chart type is not stored as an option in reference questions.
