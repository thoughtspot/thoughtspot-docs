...
:description: To delete a table with dependencies from a Google AlloyDB for PostgreSQL connection, first delete the dependent objects.
:jira: SCAL-166161
...
See xref:connections-google-alloydb-postgresql-delete-table.adoc[Delete a table from a {connection} connection].
