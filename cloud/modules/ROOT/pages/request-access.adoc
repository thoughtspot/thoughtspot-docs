...
You can allow people in your organization to request access to ThoughtSpot by selecting a button on the sign-in page.
...
When a person selects the sign-up button, they go to a sign-up page that you've already set up outside of ThoughtSpot.
