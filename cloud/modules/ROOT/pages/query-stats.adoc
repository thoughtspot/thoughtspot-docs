...
To view this Liveboard, select *Liveboards* from the *Insights* tab. Search for *Query Stats* in the Search bar, or search for the *System* tag.
...
* Specifies the total query count by connection and by username
...
The Billable Query Stats Liveboard gives admin users visibility into their credit consumption, and which users are using the most query-based credits. We recommend administrators set a xref:monitor-alert-threshold.adoc[threshold-based alert] on the Total Query Count KPI chart to receive notifications when the total credit consumption approaches the total number of credit purchased in their subscription. Remember that one query is one credit.
...
> ** Monitoring Performance course: Watch the https://training.thoughtspot.com/admin-monitoring-performance/2499317[Usage Statistics^] lesson.
> ** Monitoring System Activities course: Watch the https://training.thoughtspot.com/admin-monitoring-system-health/2499331[Billable Credit Usage^] lesson.
