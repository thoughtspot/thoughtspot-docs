...
[discrete]
==== Expand fields in the new pivot table
In the new pivot table charts the option to expand or collapse a field is not enabled by default.
This is available only when the *Show subtotals* option is checked.


[.bordered]
image::expand-column.png[The expand icon with the subtotal option checked]
...
* The *Show subtotals* option is disabled if your search query includes unsupported aggregates, such as group aggregates, moving functions, pass through functions. As a result, the option to expand or collapse a field will be unavailable.
...
. Select the *edit chart configuration* button image:icon-gear-10px.png[edit chart configuration icon image] near the upper right of the Answer.
...
. In chart view, select the *edit chart configuration* button image:icon-gear-10px.png[edit chart configuration icon image] near the upper right of the Answer.
. Drag one or more measures to the _Values_ section.
. Drag the *Values* chip to either the _Rows_ or _Columns_ section.
. To view your changes, click the *Apply* button.
+
Your pivot table reloads with your blended axes.
+
[.bordered]
image::values-in-pivot-table.png[Values in pivot table]
+
