...
:jira: SCAL-202496, SCAL-229665, SCAL-248223, SCAL-261502, SCAL-266916, SCAL-268357
...
By default, pivot table summaries are calculated as separate SQL queries. This supports the ability to define different aggregation rules. For example: Average, Min, Max. You can customize your pivot table summary calculations settings to calculate in the front end. These results are limited to a SUM of the numbers displayed in the pivot table and allow only a maximum of 100,000 rows of data. For more information about customizing your pivot table summary calculations, see xref:search-flags.adoc[Query generation and auto complete flags].
