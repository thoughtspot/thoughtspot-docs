...
Pivot tables in ThoughtSpot have two independent limits: one for the amount of data processed, and one for the number of cells displayed at one time.
...
For instance, a pivot table with 3 measures — Sales, Profit, and Units Sold — broken down by Region and Product Category previously processed up to 33,000 rows.
With the updated limits, the same pivot table processes up to 100,000 rows — three times the data, with no changes to your analysis.
