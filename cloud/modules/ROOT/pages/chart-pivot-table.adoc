...
| Value-based only: you can only format a column based on its *own* values.
| You can format a column based on *any other visualized column's* values — more flexibility.

| Non-visualized columns in conditional formatting
| Not supported
| Not supported (known limitation). New pivot tables offer expanded conditional formatting
capabilities for visualized columns.
|===
