...
ThoughtSpot supports a wide range of date and timestamp formats. See xref:date-formats.adoc[Date Formats]. It interprets blank values in user-uploaded CSV files as NULL values. These include these case-insensitive values:
