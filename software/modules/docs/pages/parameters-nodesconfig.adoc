...
. Add network information for your nodes in the `nodes.config` file output, as demonstrated in link:{{ site.baseurl }}/appliance/hardware/nodesconfig-example.adoc[the nodes.config file] example.
