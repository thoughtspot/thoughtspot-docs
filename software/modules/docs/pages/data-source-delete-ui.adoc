...
There are two separate ways to delete a data source, through the browser or link:data-source-delete-tql.adoc[through TQL] describes the dependency checking that occurs when deleting or changing a table using TQL.
