...
Now, you're ready to either xref:embed-viz.adoc[embed a visualization] or xref:use-data-api-read.adoc[use the REST API to get data] from ThoughtSpot and display it within your Web page or application.
