...
. xref:enable-JS-API.adoc[Enable the JavaScript API (JS API)] on the receiving page of the target application.
. xref:about-JS-API.adoc[Authenticate to ThoughtSpot] on the receiving page of the target application.
. xref:about-full-embed.adoc[Embed the ThoughtSpot application] in your own web page or application.
