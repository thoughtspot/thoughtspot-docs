...
Do not edit any part of the installer file except the sections specified in xref:parameters-cluster-create.html[Parameters of the tscli cluster create command].
