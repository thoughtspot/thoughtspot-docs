...
+++
<div class="border">
<script src="https://fast.wistia.com/player.js" async></script><script src="https://fast.wistia.com/embed/308hcu1w79.js" async type="module"></script><style>wistia-player[media-id='308hcu1w79']:not(:defined) { background: center / contain no-repeat url('https://fast.wistia.com/embed/medias/308hcu1w79/swatch'); display: block; filter: blur(5px); padding-top:65.83%; }</style> <wistia-player media-id="308hcu1w79" aspect="1.518987341772152"></wistia-player>
</div>
+++
