...
<source src="https://docs.thoughtspot.com/cloud/10.12.0.cl/_images/hide-filter.mp4" type="video/mp4">
</video>
</div>
+++
...
<div class="border">
<video autoplay loop muted controls width="100%" controlsList="nodownload">
<source src="https://docs.thoughtspot.com/cloud/10.12.0.cl/_images/parameter-shuffle.mp4" type="video/mp4">
</video>
</div>
+++
...
<div class="border">
<video autoplay loop muted controls width="100%" controlsList="nodownload">
<source src="https://docs.thoughtspot.com/cloud/10.12.0.cl/_images/visual-refresh.mp4" type="video/mp4">
</video>
</div>
+++
endif::pendo-links[]
