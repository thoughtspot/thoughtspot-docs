...
In this release, you can try our redesigned and customizable home page, where you can view your watchlist, favorites, library of Answers and Liveboards, and more. With the new left-hand navigation, you can go directly to your Liveboards, Answers, SpotIQ Analysis, and Monitor Subscriptions.
...
ifndef::pendo-links[]
xref:query-sets.adoc[Query sets] and xref:column-sets.adoc[Column sets].
endif::[]
ifdef::pendo-links[]
xref:query-sets.adoc[Query sets,window=_blank] and xref:column-sets.adoc[Column sets,window=_blank].
endif::[]
