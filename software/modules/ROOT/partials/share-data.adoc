...
+
NOTE: The option to share specific columns is only available for tables, not for Worksheets or Views.
...
. Click the *More* menu icon image:icon-more-10px.png[more options menu icon], and then click *Share*.
+
