...
ThoughtSpot is excited to announce that our brand-new navigation and homepage experience is now now generally available (GA). This change does not apply to users of ThoughtSpot in an embedded environment.
