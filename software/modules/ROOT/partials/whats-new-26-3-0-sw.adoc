...
ifdef::pendo-links[]
xref:charts.adoc#parameters[Dynamic parameters in charts and Answers,window=_blank].
endif::[]
...
For more information, see
ifndef::pendo-links[]
xref:liveboard-grouping-styling.adoc[Liveboard grouping and styling].
endif::[]
ifdef::pendo-links[]
xref:liveboard-grouping-styling.adoc[Liveboard grouping and styling,window=_blank].
endif::[]
...
For more information, see
ifndef::pendo-links[]
xref:liveboard-filters.adoc#apply-filters[Apply filters to specific visualizations or tabs].
endif::[]
ifdef::pendo-links[]
xref:liveboard-filters.adoc#apply-filters[Apply filters to specific visualizations or tabs,window=_blank].
endif::[]
...
For more information, see
ifndef::pendo-links[]
xref:parameters-use.adoc#reorder-parameters[Reordering parameters in Liveboards and Answers].
endif::[]
ifdef::pendo-links[]
xref:parameters-use.adoc#reorder-parameters[Reordering parameters in Liveboards and Answers,window=_blank].
endif::[]
...
For more information, see
ifndef::pendo-links[]
xref:tml-models.adoc#date-bucket[Default date bucket].
endif::[]
ifdef::pendo-links[]
xref:tml-models.adoc#date-bucket[Default date bucket,window=_blank].
endif::[]
...
For more information, see
ifndef::pendo-links[]
xref:connections-gbq-csv-upload.adoc[Upload a CSV file in your Google BigQuery connection].
endif::[]
ifdef::pendo-links[]
xref:connections-gbq-csv-upload.adoc[Upload a CSV file in your Google BigQuery connection,window=_blank].
endif::[]
...
For more information, see
ifndef::pendo-links[]
xref:connections-databricks-csv-upload.adoc[Upload a CSV file in your Databricks connection].
endif::[]
ifdef::pendo-links[]
xref:connections-databricks-csv-upload.adoc[Upload a CSV file in your Databricks connection,window=_blank].
endif::[]
...
ifndef::pendo-links[]
xref:connections-snowflake-add.adoc#pat[Personal Access Token authentication].
endif::[]
ifdef::pendo-links[]
xref:connections-snowflake-add.adoc#pat[Personal Access Token authentication,window=_blank].
endif::[]
...
ifndef::pendo-links[]
xref:connections-snowflake-add.adoc#client-credentials[OAuth Client Credentials] and xref:connections-snowflake-oauth-client.adoc[Configure OAuth with Client Credentials for a Snowflake connection].
endif::[]
ifdef::pendo-links[]
xref:connections-snowflake-add.adoc#client-credentials[OAuth Client Credentials,window=_blank] and xref:connections-snowflake-oauth-client.adoc[Configure OAuth with Client Credentials for a Snowflake connection,window=_blank].
endif::[]
...
[discrete]
=== Publishing workflow
ThoughtSpot introduces publishing across Orgs. Publishing allows you to create an object in the Primary Org and publish it directly to target Orgs without generating duplicate copies. To enable this feature, contact {support-url}. You can also unpublish objects across Orgs.
...
For more information, see
ifndef::pendo-links[]
xref:publishing.adoc#parameters[Parameters and variables].
endif::[]
ifdef::pendo-links[]
xref:publishing.adoc#parameters[Parameters and variables,window=_blank].
endif::[]
