...
Whenever you are selecting objects from a list, you can filter by tag to find what you’re looking for. Anyone can use tags to filter lists of Pinboards or data sources. You can also filter by a tag when selecting data sources.
