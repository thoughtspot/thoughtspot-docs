...
[#ts-service-name]
=== Unique service name
The unique key used by your Identity Provider to identify the client. For example, _urn:thoughtspot:callosum:saml_, or _https://ssoappname.sso-provider.com/ab12c3de4_. This is also called the *Entity ID*.
