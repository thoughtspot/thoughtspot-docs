...
| 123
| Mandatory, unless using the https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/set-time.html[Amazon Time Sync Service^]. Note that you can only use the Amazon Time Sync Service in ThoughtSpot version 7.1.1.CU1 and later.
| UDP
| NTP service
| bidirectional
| ThoughtSpot Support
| All nodes
| Port used by NTP service. If your company cannot use this port, and you are on ThoughtSpot version 7.1.1.CU1 or later, you can use the https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/set-time.html[Amazon Time Sync Service^] and customize the port it uses.
