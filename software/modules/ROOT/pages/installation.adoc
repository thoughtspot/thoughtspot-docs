...
{support-url} then helps you to install, and subsequently update the software.
...
The {support-url} team contacts all clients to schedule updates as we release new versions of ThoughtSpot.
