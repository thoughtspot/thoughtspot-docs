...
ThoughtSpot's ODBC connection relies on the link:https://www.simba.com/products/SEN/doc/Client-Server_user_guide/content/clientserver/configuringsimbaclientodbc/simbaclientodbcunix.htm[SimbaEngine X SDK,window="_target"] to connect through ODBC or JDBC to ThoughtSpot's remote data stores.
