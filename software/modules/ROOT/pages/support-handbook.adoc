...
The {support-url} team is committed to making you successful when deploying and using ThoughtSpot, regardless of your location. We provide 24x7 worldwide support to all our valued customers.
...
We also provide these instructions in a downloadable format: link:{attachmentsdir}/support-handbook.pdf[Support handbook] [.badge.badge-pdf]#PDF#.
