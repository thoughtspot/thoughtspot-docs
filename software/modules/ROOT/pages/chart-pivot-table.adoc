...
Note that a legacy instance-level setting does exist where the pivot total is a sum of the row numbers. As this is an instance flag, this will affect the behavior of all pivot tables.
//For more information, see xref:search-flags.adoc[Query generation and auto complete flags].
