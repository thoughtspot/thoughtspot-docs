...
:description: You can enable Active Directory (AD) access on each ThoughtSpot cluster.

Learn how to enable Active Directory (AD) access on each ThoughtSpot cluster.
