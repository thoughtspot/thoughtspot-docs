...
:linkattrs:
:experimental:
:description: If your ThoughtSpot system is configured for Security Assertion Markup Language (SAML) you can enable Single Sign On (SSO) for your embed application.
...
. Work with {support-url} to enable CORS between your client application domain and the ThoughtSpot domain.
+
