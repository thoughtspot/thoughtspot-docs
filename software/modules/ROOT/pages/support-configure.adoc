...
You can set up a reverse tunnel to allow {support-url} to get access to your ThoughtSpot instance, to perform support-related activities.
...
The remote tunnel enables SSH and HTTP access to your ThoughtSpot instance by {support-url}.
...
. Contact {support-url} and open a support ticket for making the appropriate reverse tunnel settings on our end.
...
. contact {support-url} and test your setup.
...
You can get these from {support-url}.
...
If the person can't answer your system and software-related questions, that person should submit  the questions to {support-url}.
