...
. Under *Materialization*, select *Dematerialize*.
+
image::view-materialize-11.png[Dematerialize view]

. In the confirmation window titled *Remove materialized view*, select *Remove* to confirm.
+
...
Select *Update status* to refresh.
