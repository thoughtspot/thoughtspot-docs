...
* Either you are the connection owner or the connection needs to be shared with Edit access.
* To edit a SQL-based view, you must either be the connection owner or the connection owner must give you Edit access when they share the connection with you.
...
To edit the SQL query that the view is based on, select *Edit View*. You must have *can edit* privileges on a SQL view to edit it.
