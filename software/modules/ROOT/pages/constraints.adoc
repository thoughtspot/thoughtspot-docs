...
* If a row with the same primary key doesn't exist already, the new row is inserted into the table.
...
Note that ThoughtSpot doesn't check for primary key violations across different shards of the table.
