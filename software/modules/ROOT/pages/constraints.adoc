...
For example, a date or product dimension could join an inventory fact table to a sales fact table. This is best done in your ETL process, before bringing the data into ThoughtSpot.
