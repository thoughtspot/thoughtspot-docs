...
* The 'wick' that extends upwards from the rectangle indicates the difference between the highest of _Open_ or _Close_, and highest traded value (_High_). Similarly, for the extension downwards from the rectangle indicates the difference between the lowest of _Open_ or _Close_, and the lowest traded value (_Low_).
