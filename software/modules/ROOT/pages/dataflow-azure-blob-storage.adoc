...
:experimental:
:linkattrs:
:page-aliases: /data-integrate/dataflow/dataflow-azure-blob-storage.adoc
:description: DataFlow enables you to connect to the Azure Blob Storage file system, to use your data in ThoughtSpot.
