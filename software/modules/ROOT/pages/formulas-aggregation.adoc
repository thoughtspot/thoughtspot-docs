...
image::formula-asst-aggregate.png[Image of list of aggregate formulas in the formula assistant]
...
image::formula_gross_margin_no_sum.png[Gross margin by department data, with a gross margin without sum() column where the values are not between 0 and 1]
...
image::formula_gross_margin_sum.png[Gross margin by department data, with a gross margin with sum() column where the values are between 0 and 1]
