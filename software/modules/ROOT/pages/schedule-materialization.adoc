...
:experimental:
:linkattrs:
:description: Learn how to create or change the schedule for data refresh in a materialized view.
 ...
 ** To update an existing schedule, select _Daily_, _Weekly_, or _Monthly_.
 ** To create a schedule, select _None_.
