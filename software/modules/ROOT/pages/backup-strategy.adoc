...
:description: Depending on your situation and your goals, you can choose to use either a snapshot or a backup to back up your ThoughtSpot cluster.
...
CAUTION: Contact {support-url} for help restoring from a snapshot or backup.
...
If you need to move data between clusters or restore to a cluster that was updated to a new release, contact {support-url}.
