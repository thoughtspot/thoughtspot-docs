...
When you select dislike, you can provide more details on why you disliked the insight by answering the questions based on the type of insight, decisions made by SpotIQ during analysis, aggregation, and so on.
...
. To remove feedback, select the same icon, either like image:thumb_up.png[more options menu icon] or dislike image:thumb_down.png[more options menu icon], that you clicked on before. To change feedback, select the icon you would like to change your feedback to.
