...
:linkattrs:
:experimental:
:description: System security refers to audit logs and security policies.
...
The ThoughtSpot Engineering and {support-url} teams are notified of Common Vulnerabilities and Exposures (CVEs), so they can patch OS packages proactively as well.
