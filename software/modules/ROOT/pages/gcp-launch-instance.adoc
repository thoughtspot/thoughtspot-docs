...
Refer to xref:gcp-configuration-options.adoc#vms-with-persistent-disk-and-google-cloud-storage-connections[ThoughtSpot GCP instance types] to determine the size in GB when you have GCS.
