...
:description: You can refresh a materialized view manually, so that its data matches the data in the underlying tables.
...
. Next to the _Stale_ status, select *Refresh Data*.
+
