...
| &#10063; | xref:install-rhel[3. Install RHEL version 7.8, 7.9, 8.1, 8.2, 8.3, 8.4, 8.5, 8.6, 8.7, or 8.8 or OEL version 7.9 on all hosts]
...
ThoughtSpot is certified with RHEL versions 7.8, 7.9, 8.1, 8.2, 8.3, 8.4, 8.5, 8.6, 8.7 and 8.8;
we *do not* support other versions of RHEL, including 7.7 and 8.
ThoughtSpot is certified with OEL version 7.9. Install RHEL version 7.8, 7.9, 8.1, 8.2, 8.3, 8.4, 8.5, 8.6, 8.7, or 8.8, or OEL version 7.9.
...
Remove the selinux policy for rsync on each node. This is *only* necessary if you are using RHEL 8.1 - 8.8. You do not need to do this step if you are using RHEL 7.9 or 7.9, or OEL 7.9.
