...
In addition, the size picker at the bottom of a visualization's More menu lets you toggle between predetermined sizes for each visualization.
...
Resize a visualization by choosing a predetermined size under the More icon image:icon-ellipses.png[more options menu icon] for the visualization.
+
...
. Click the More icon image:icon-ellipses.png[more options menu icon] for the chart or table.
+
...
. In the upper-right corner of the visualization, click the More icon image:icon-ellipses.png[more options menu icon] and select *Delete*.
+
