...
:experimental:
:linkattrs:
:page-aliases: /data-integrate/dataflow/dataflow-mysql.adoc
:description: DataFlow enables you to connect to a MySQL database, to use your data in ThoughtSpot.
