...
This guide explains how to deploy ThoughtSpot on Microsoft Azure on Red Hat Enterprise Linux (RHEL), allowing you to run ThoughtSpot on an RHEL 8.1, 8.2, 8.3, 8.4, 8.5, 8.6, 8.7, or 8.8 image that your organization manages internally.
...
If you are deploying ThoughtSpot on RHEL, OEL, or AL2, your result should display the partitioning specified in xref:customer-os-prerequisites.adoc#partition-hosts[Prerequisites for deploying ThoughtSpot on your own OS: Partition the hosts].
