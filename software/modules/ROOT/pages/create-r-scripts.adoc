...
> **Related information**
>
> * link:https://www.thoughtspot.com/codex/using-r-analysis-thoughtspot-time-series-forecasting[Using R Analysis in ThoughtSpot for Time Series Forecasting] (blog post by Antony Chen of ThoughtSpot)
> * link:https://www.r-project.org/[R Project for Statistical Computing]
