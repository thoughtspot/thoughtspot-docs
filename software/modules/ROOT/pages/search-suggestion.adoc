...
:description: ThoughtSpot learns over time what columns are most important to you and to your company, then uses this knowledge to rank the search terms it offers.
