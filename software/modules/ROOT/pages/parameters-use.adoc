...
[#reorder-parameters]
=== Reordering parameters in Liveboards and Answers
...
Liveboard creators can link parameters of the same data type across multiple different Models. This allows you to control multiple parameters from a single parameter chip and reduces the repetitive effort required for Liveboard users to individually set identical parameters for each Model.
//For more information, see xref:liveboard-parameters-link.adoc[].
