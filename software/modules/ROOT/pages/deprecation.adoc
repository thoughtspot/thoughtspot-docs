...
This Liveboard contained search replays created in the system. The Replay Search feature is also removed in 7.1. Customers currently use *Replay search* and the *Learn how to use ThoughtSpot Liveboard* to learn how to use ThoughtSpot's search on data.

Replay search::
This feature allowed you to replay the search used to create an answer.
