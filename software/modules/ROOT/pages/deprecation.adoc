...
:jira: SCAL-224007, SCAL-229854, SCAL-267375, SCAL-267374, SCAL-253256
...
[#removed-10-10-0-sw]
== Removed in 10.10.0.sw

The 10.10.0.sw release of ThoughtSpot Software will *remove* support for:

* Red Hat Enterprise Linux 7
* Oracle Linux 7
* Amazon Linux 2
+
Customers must migrate to Red Hat Enterprise Linux 8 or Oracle Linux 8.

The 10.10.0.sw release will also *remove* the following feature:

Search Assist:: ThoughtSpot will remove the Search Assist feature from the Data Workspace page.

[#removed-10-1-0-sw]
== Removed in 10.1.0.sw

The 10.1.0.sw release of ThoughtSpot Software, targeted for December 2024, will *remove* the following features:

* Simba server functionality.
+
You must use a different approach to load data into Falcon, like tsload or DataFlow.

* As part of the Admin Portal optimization initiative, the System Information tab which previously hosted the _TS Stats: System Information and Usage_ (Generic Liveboard) has been removed. This decision was driven by the redundancy of data presented in this tab, much of which has already been integrated into existing dedicated tabs and visualizations in the Admin Portal.
