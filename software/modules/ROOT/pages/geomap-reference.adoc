...
+
--
include::latest@software:ROOT:partial$geos/us-state.adoc[]
--
County::
+
--
include::latest@software:ROOT:partial$geos/us-county.adoc[]
--
Zip Code::
+
--
include::latest@software:ROOT:partial$geos/us-zip-code.adoc[]
--
====
