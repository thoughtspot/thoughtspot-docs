...
NOTE: At this time, ThoughtSpot does not support AWS Auto Scaling or deployment of ThoughtSpot In-memory cluster across AWS availability zones or regions. ThoughtSpot Embrace cluster is supported across AWS availability zones within the same region.
