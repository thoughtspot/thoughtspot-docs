...
* xref:admin-portal-performance-tracking.adoc[View Performance Tracking Pinboard]:  View and explore visualizations about your ThoughtSpot cluster's performance on the Performance Tracking Pinboard.
