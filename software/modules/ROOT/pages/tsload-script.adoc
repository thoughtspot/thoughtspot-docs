...
:description: If you need to load data from multiple CSV files, create a script to automate the process.
...
Usually, you can use a xref:nas-mount.adoc[NAS mounted file system].
