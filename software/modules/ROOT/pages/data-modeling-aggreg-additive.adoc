...
image::model_additive_model_false_options.png[Image of a numeric headline with two aggregation options: unique count of or total count of.]
...
image::model_additive_model_true_options.png[Image of a numeric headline with 8 aggregation options: unique count of, total of, avg of, std deviation of, variance of, total count of, min of, max of.]
