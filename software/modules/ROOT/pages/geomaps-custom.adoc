...
----
+
Replace `<base-url>` with your remote URL's base URL. For example, if the remote URL for your custom map is link:https://raw.githubusercontent.com/bmesuere/belgium-topojson/master/belgium.json[https://raw.githubusercontent.com/bmesuere/belgium-topojson/master/belgium.json^], your base URL is link:https://raw.githubusercontent.com[https://raw.githubusercontent.com^].
+
[source,bash]
----
