...
NOTE: Add the ThoughtSpot Support alert email, `prod-alerts@thoughtspot.com`, to allow {support-url} to receive alerts. ThoughtSpot Support monitors these alerts to ensure your cluster's health.
