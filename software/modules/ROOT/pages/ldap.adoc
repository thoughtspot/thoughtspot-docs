...
:experimental:
:linkattrs:
:description: Some companies use LDAP (Lightweight Directory Access Protocol) to manage user authentication.
...
If you have been using ThoughtSpot with users you created manually, and you now want to transition to LDAP, please contact {support-url}.
...
To enable user authentication through OpenLDAP, contact {support-url}.
