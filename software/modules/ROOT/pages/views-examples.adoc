...
:description: Four common examples of when you should use a view in your search (filtered subset, cohort analysis, combined aggregated sources, data transformation).
