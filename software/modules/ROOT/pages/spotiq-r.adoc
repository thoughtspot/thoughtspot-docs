...
:linkattrs:
:experimental:
:description: Learn about R customizations.
:page-aliases: /spotiq/adv-customize-withr.adoc

NOTE: This feature is deprecated in the xref:answer-experience-new.adoc[new answer experience], starting in version 8.4.0.sw. To use it, return to the classic answer experience. For more information, refer to xref:deprecation.adoc[Deprecation announcements].
