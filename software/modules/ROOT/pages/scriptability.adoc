...
Use ThoughtSpot Modeling Language (TML) files to export and import Worksheets, Views, Tables, Pinboards, SpotIQ results, and Answers in a human-readable format.
