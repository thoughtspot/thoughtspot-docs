...
. Fill in the areas specified in the xref:parameters-nodesconfig.adoc[Parameters of the nodes.config file] with your specific network information, as shown in the xref:node-autodiscovery[Autodiscovery of one node example].
+
