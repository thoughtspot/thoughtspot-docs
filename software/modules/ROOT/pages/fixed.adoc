...
|SCAL-154972
|Greater than (>) worksheet date filter is changed to Less than (<).

|SCAL-164169
|Inaccurate timestamps and missing activity in User Adoption Liveboards.

|SCAL-185834
|Object Usage Worksheet provides inaccurate results.

|SCAL-160295
|Embedded: Visual Embed SDK returns `NO_COOKIE_ACCESS` in Microsoft Edge and Apple Safari browsers.
