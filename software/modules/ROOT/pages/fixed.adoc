...
[#releases-9-5-x]
== 9.5.0.sw.cu1 release fixed issues
...
|SCAL-175240
|ThoughtSpot Everywhere: PDF downloads do not work after applying `9.3.0.cl-261-349-default-PR908.2023-09-14T103600` patch.
...
|SCAL-137873
|ThoughtSpot Everywhere: Locale parameter does not work in SearchEmbed.

|SCAL-137487
|Pivot charts cannot be downloaded.

|SCAL-129104
|ThoughtSpot Everywhere:  Powered by Thoughtspot footer is not disabled in Liveboard V2.
