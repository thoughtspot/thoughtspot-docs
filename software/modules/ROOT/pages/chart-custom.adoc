...
:jira: SCAL-179003, SCAL-202002, SCAL-214870 (gauge chart), SCAL-221883 (remove line about gauge chart), SCAL-236450
...
Developers create custom charts in Javascript using charting libraries such as https://www.highcharts.com/[Highcharts^] and https://www.vitaracharts.com/[Vitara Charts^]. For more information, refer to https://github.com/thoughtspot/ts-chart-sdk/blob/main/README.md/[ThoughtSpot Charts SDK documentation^].
