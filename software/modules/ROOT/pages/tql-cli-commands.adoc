...
:linkattrs:
:experimental:
:description: TQL is the ThoughtSpot language for entering SQL commands. This reference lists TQL commands you can use to create a schema, verify a data load, and more.
