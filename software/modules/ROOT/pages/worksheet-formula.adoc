...
. xref:worksheet-create.adoc[], or xref:worksheet-edit.adoc[editing or renaming worksheets].
...
. You can see a list of formula operators with examples by selecting *Formula Assistant.*
+
...
. Name the formula by selecting its title and typing the new name.
Click *Save*.
