...
:experimental:
:page-partial:
:description: This article teaches you to use a gating condition to determine whether to email the pinboard, sending an alert to specified users
...
After you create your view and pinboard, follow the directions in xref:pinboard-schedule.adoc[] to create the pinboard schedule.
