...
:description: Use this procedure to synchronize your ThoughtSpot system with an LDAP server through Active Directory.
...
+
If you need details on the Python APIs, contact {support-url}.
+
