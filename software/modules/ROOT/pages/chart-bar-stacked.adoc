...
:linkattrs:
:page-partial:
:description: The stacked bar chart is similar to the xref:chart-bar.adoc[bar chart], but include a legend, which divides each bar into additional sections by color.
