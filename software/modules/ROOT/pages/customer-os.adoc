...
:jira: SCAL-186047, SCAL-192433, SCAL-166193
...
ThoughtSpot supports RHEL 8.1, 8.2, 8.3, 8.4, 8.5, 8.6, 8.7, and 8.8.
...
IMPORTANT: You must manually install the yum package "nfs-utils" for all non-ThoughtSpot OS deployments.
