...
. Execute the command to launch the interactive SAML configuration. Starting in release 7.1.1, if you want to configure multiple IDPs, add `--multi` to the end of the command. To change your default IDP, add `--change_default_idp` to the end of the command.  Note that ThoughtSpot supports configuration of a maximum of 5 IDPs.
+
[source]
----
