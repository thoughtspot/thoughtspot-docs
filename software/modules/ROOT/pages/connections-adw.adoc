...
NOTE: The *{connection} Autonomous Data Warehouse* (ADW) connection type has changed to *{connection}*. With this change you can now select one of two types of {connection} data warehouses: Cloud or On Premise. Existing {connection} ADW connections are considered Cloud.
