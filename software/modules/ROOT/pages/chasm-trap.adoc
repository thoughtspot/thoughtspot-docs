...
image::chasm_trap_complex.png[Diagram of a complex chasm trap. The Sales, Returns, Promotions, and Inventory fact tables all point to both the Date and Products dimension tables.]
