...
:description: Use the user icont to view your profile, adjust language options, specify preferences, manage your Answer experience, or sign out of ThoughtSpot.
