...
If you want to prevent shares from also revealing the columns regardless of where it appears (Worksheets, Answers, and Pinboards), you can ask {support-url} to enable a stricter behavior.
