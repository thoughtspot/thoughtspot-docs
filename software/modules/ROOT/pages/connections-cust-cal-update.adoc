...
:description: Learn how to update a custom calendar.
...
+
IMPORTANT: You must save the updated file with a new name, or you won't be able to update the calendar.
...
. For Separator, select the separator used in the updated calendar you're going to upload.
+
