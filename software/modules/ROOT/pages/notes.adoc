...
+
For more information, see xref:charts-library-new.adoc[New charts library].
...
+
For more information, see xref:search.adoc#rerun[Rerun your search query].
...
+
For more information, see xref:liveboard-grouping-styling.adoc[Liveboard grouping and styling].
...
+
For more information, see xref:liveboard-filters.adoc#apply-filters[Apply filters to specific visualizations or tabs].
...
+
For more information, see xref:parameters-use.adoc#reorder-parameters[Reordering parameters in Liveboards and Answers].
...
To enable this feature, contact your administrator.
+
For more information, see xref:liveboard-download-pdf.adoc[Download a Liveboard] and xref:liveboard-schedule.adoc[Schedule a Liveboard job].
...
+
For more information, see xref:publishing.adoc#parameters[Parameters and variables].
...
If you are running one of the following versions, you can upgrade to the 26.3.0.sw release:

* 10.10.0.sw to 26.3.0.sw
* 10.1.0.sw (or earlier) to 10.10.0.sw, then 10.10.0.sw to 26.3.0.sw
