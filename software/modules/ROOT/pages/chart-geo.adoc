...
[#enhancement]
ThoughtSpot supports maps for all countries. See the complete list in link:https://wiki.openstreetmap.org/wiki/List_of_territory_based_projects[Openstreetmap supported countries^]. If you would like to use a custom map to visualize your data, see xref:geomaps-custom.adoc[].
