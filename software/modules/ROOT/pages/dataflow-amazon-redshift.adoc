...
:linkattrs:
:experimental:
:page-aliases: /data-integrate/dataflow/dataflow-amazon-redshift.adoc
:description: DataFlow enables you to connect to the Amazon Redshift database, to use your data in ThoughtSpot.
