...
NOTE: Custom groups are in beta and off by default. The beta version of custom groups is focused on query generation and reusability. To enable this feature, contact {support}.
