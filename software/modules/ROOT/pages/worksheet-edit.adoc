...
:description: If you created a Worksheet, or have edit permissions, you can add sources and columns, add or edit formulas, change relationships, and change column names.

Anyone with the proper permissions can edit a worksheet. If you created a worksheet, or you have edit permissions to it, you can make changes such as adding sources and columns, adding or editing formulas, changing relationships, and changing column names.
