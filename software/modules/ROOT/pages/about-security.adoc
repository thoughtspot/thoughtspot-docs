...
To see a list of network ports that must remain open to outside traffic, and for inter-cluster communication, review the information in xref:firewall-ports.adoc[Network ports].
