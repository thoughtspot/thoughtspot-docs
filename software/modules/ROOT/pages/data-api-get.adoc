...
. Find the ID number of the object you want to get the data from. Click the *More* menu icon image:icon-more-10px.png[more options menu icon] for the object and select *Copy embed link*.
