...
To change the chart type, click the *Change visualization* icon image:icon-chart-type-10px.png[Change visualization icon image] to see the following catalog of charts.
