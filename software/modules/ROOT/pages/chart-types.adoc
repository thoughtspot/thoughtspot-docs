...
To switch between tables and charts, toggle between the table view or chart view: image:changeview-chartortable.png[Toggle for chart and table view].

To change the chart type, select the *Change visualization* icon image:icon-chart-type-10px.png[Change visualization icon image] to see the following catalog of charts.
