...
If you are using the xref:answer-experience-new.adoc[new Answer experience], your administrator set a standard footer for all Answer and Liveboard downloads.
//If you have admin privileges, you can edit that footer for the whole cluster from the xref:search-spotiq-settings.adoc#visualization-footer[Admin Console].
If you do not have admin privileges, you cannot edit the standard footer for downloads.
