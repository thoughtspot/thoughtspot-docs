...
:linkattrs:
:description: ThoughtSpot REST APIs let you programmatically manage users, user sessions, group privileges, and metadata objects.
...
For an up-to-date list of API categories and associated resource endpoints, see link:https://developers.thoughtspot.com/docs/?pageid=rest-api-reference[REST API reference,window=_blank].
...
link:https://developers.thoughtspot.com/docs/metadata-api[Metadata]::
