...
For an up-to-date list of API categories and associated resource endpoints, see link:https://developers.thoughtspot.com/docs/?pageid=rest-api-reference[REST API reference].
