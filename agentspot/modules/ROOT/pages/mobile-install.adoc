= Install and set up ThoughtSpot Mobile
:last_updated: 6/6/2024
:linkattrs:
:experimental:
:page-layout: default-agentspot-no-index
:description: Learn how to install and set up ThoughtSpot's ThoughtSpot Mobile.



Before you install ThoughtSpot Mobile, ask your ThoughtSpot administrator where you should get it, and which method of VPN (if any) you should use to access your ThoughtSpot cluster.
