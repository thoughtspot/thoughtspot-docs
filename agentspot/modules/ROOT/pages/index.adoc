...
++++
<p class="home-page-title">ThoughtSpot</p>
++++

image:agentspot-logo.svg[width=500]

++++
<p class="home-page-title">Documentation</p>
++++
...
*Deep data integration*: Query ThoughtSpot models, embed Liveboards, process Google Drive files, and automate Gmail and Slack — all from a single chat interface.

*Highly configurable*: Build custom agents with specific instructions, tools, and skills. Share them with your team or keep them private.
