...
:author: Naomi
:page-last_updated: 3/4/25
:page-layout: default-cloud-no-index
:description: Follow these steps to create an alert by attributes on your KPI.
:linkattrs:
:experimental:
:jira: SCAL-243597, SCAL-254854, SCAL-255514, SCAL-258659, SCAL-260152, SCAL-272806
...
For all alert types, when the frequency is set to hourly, then it means we send alerts at 30- or 60-minute mark.
...
. Select the KPI you want to monitor, either by accessing a Liveboard, or by searching within the **Answers**. +
...
+
You can also add groups as **Subscribers** to the alert. Users subscribed through a group must be removed from the group to be removed from the alert schedule.
